 ...
 */
class ByteMethodReference5<A, B, C, D, E> implements ByteFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction5<A, B, C, D, E> _cachedFunction = null;

  ByteMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof ByteMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference5) func)._methodReference;
    } else {
  ...
  private ByteFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference6<Object, A, B, C, D, E> unbound = new ByteMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference5) obj)._methodReference);
  }
