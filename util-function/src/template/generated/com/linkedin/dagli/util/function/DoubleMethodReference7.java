 ...
 */
class DoubleMethodReference7<A, B, C, D, E, F, G> implements DoubleFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  DoubleMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof DoubleMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference7) func)._methodReference;
    } else {
  ...
  private DoubleFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference8<Object, A, B, C, D, E, F, G> unbound =
          new DoubleMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference7) obj)._methodReference);
  }
