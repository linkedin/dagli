...
/**
 * A tuple of arity ArrayTuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> that is backed by an array.
 ...
 */
final class ArrayTuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> extends AbstractTuple implements
   ...
   */
  public ArrayTuple13(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(13);
    System.arraycopy(_array, 0, result, 0, 13);
    return result;
  }
}
