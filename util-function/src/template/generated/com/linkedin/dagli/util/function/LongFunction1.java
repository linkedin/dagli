...
@FunctionalInterface
public interface LongFunction1<A> extends FunctionBase, ToLongFunction<A> {
  long apply(A value1);
   ...
   */
  default LongFunction1<A> returnZeroOnNullArgument() {
    return new LongDefaultOnNullArgument1<>(this);
  }

  @Override
  default long applyAsLong(A value1) {
    return apply(value1);
  }

  static <A> LongFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement LongFunction1.Serializable should override this method
   ...
   */
  static <A> LongFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends LongFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new LongMethodReference1<A>(this);
