 ...
 */
class IntMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
    IntFunction10.Serializable<A, B, C, D, E, F, G, H, I, J>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  IntMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof IntMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference10) func)._methodReference;
    } else {
  ...
  private IntFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new IntMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference10) obj)._methodReference);
  }
