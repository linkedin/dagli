...
/**
 * A function class implementing {@link DoubleFunction1.Serializable} that composes
 * {@link DoubleFunction1} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class DoubleComposedFunction1<A, Q> implements DoubleFunction1.Serializable<A>, Named {
   ...
   *                as input
   */
  DoubleComposedFunction1(Function1<A, Q> first, DoubleFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public DoubleComposedFunction1<A, Q> safelySerializable() {
    return new DoubleComposedFunction1<>(((Function1.Serializable<A, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(DoubleComposedFunction1.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof DoubleComposedFunction1) {
      return this._first.equals(((DoubleComposedFunction1) obj)._first)
          && this._andThen.equals(((DoubleComposedFunction1) obj)._andThen);
    }
    return false;
  }
