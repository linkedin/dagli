 ...
 */
class MethodReference5<A, B, C, D, E, R> implements Function5.Serializable<A, B, C, D, E, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function5<A, B, C, D, E, R> _cachedFunction = null;

  MethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference5(Serializable<A, B, C, D, E, R> func) {
    if (func instanceof MethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference5) func)._methodReference;
    } else {
  ...
  private Function5<A, B, C, D, E, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference6<Object, A, B, C, D, E, R> unbound = new MethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function5<A, B, C, D, E, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference5)) {
      return false;
    }

    return _methodReference.equals(((MethodReference5) obj)._methodReference);
  }
