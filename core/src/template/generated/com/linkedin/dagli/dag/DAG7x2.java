 ...
 *
 * DAG7x2 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG7x2 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG7x2<A, B, C, D, E, F, G, RA, RB>
    extends
    AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>, DAG7x2<A, B, C, D, E, F, G, RA, RB>>
    implements
    PreparableDAGTransformer<Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>, DAG7x2<A, B, C, D, E, F, G, RA, RB>> {
   ...
   */
  DAG7x2(DAGStructure<Tuple2<RA, RB>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG7x2<A, B, C, D, E, F, G, RA, RB> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>, DAG7x2<A, B, C, D, E, F, G, RA, RB>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>, DAG7x2<A, B, C, D, E, F, G, RA, RB>> {
    @Override
    ...
    @Override
    public DAG7x2<A, B, C, D, E, F, G, RA, RB> getInstance() {
      return DAG7x2.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG7x2<A, B, C, D, E, F, G, RA, RB>>> getGraphReducers() {
   ...
   */
  public DAG7x2<A, B, C, D, E, F, G, RA, RB> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG7x2<A, B, C, D, E, F, G, RA, RB> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6, Producer<? extends G> input7) {
   ...
   */
  public DAG6x2<B, C, D, E, F, G, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG7x2<A, B, C, D, E, F, G, RA, RB> dag =
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
            nestedPlaceholder6, nestedPlaceholder7).withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag))
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, C, D, E, F, G, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, B, D, E, F, G, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, B, C, E, F, G, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, B, C, D, F, G, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, B, C, D, E, G, RA, RB> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder7).withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag))
        .withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG6x2<A, B, C, D, E, F, RA, RB> withGeneratorAsInput7(Generator<G> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6).withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag))
        .withExecutor(_executor)
   ...
   * @param <RB> the type of the second result
   */
  private static class Preparer<A, B, C, D, E, F, G, RA, RB> extends
      AbstractBatchPreparer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> {
    // the DAG being prepared
    private final DAG7x2<A, B, C, D, E, F, G, RA, RB> _dag;
     ...
     */
    Preparer(DAG7x2<A, B, C, D, E, F, G, RA, RB> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer7<A, B, C, D, E, F, G, Tuple2<RA, RB>>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> finish(
  ...
  @Override
  protected Preparer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, G, RA, RB> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>) res.getPreparerResult()
   ...
   */
  public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6, Iterable<? extends G> values7) {
    return (DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RB> the type of the second result
   */
  public static final class Result<A, B, C, D, E, F, G, RA, RB> extends AbstractDAGResult2<RA, RB> {
    // the prepared DAG
    private final DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RB> the type of the second result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, G, RA, RB> extends
      AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>>
      implements PreparedDAGTransformer<Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> {
    ...
    * @param input7 the {@link Producer} providing the seventh input to the transformer
     ...
     */
    @Override
    public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>> {
      @Override
      public DAGStructure<Tuple2<RA, RB>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> getInstance() {
        return DAG7x2.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<B, C, D, E, F, G, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      Placeholder<G> nestedPlaceholder7 = new Placeholder<>("Original Input 7");
      DAG7x2.Prepared<A, B, C, D, E, F, G, RA, RB> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6, nestedPlaceholder7);
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, C, D, E, F, G, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, B, D, E, F, G, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, B, C, E, F, G, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, B, C, D, F, G, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, B, C, D, E, G, RA, RB> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> withGeneratorAsInput7(Generator<G> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple2<RA, RB> apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) {
      try (
