 ...
 */
class ByteMethodReference8<A, B, C, D, E, F, G, H> implements ByteFunction8.Serializable<A, B, C, D, E, F, G, H>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  ByteMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof ByteMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference8) func)._methodReference;
    } else {
  ...
  private ByteFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new ByteMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference8) obj)._methodReference);
  }
