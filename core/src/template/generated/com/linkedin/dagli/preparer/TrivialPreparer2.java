...
/**
 * Trivial "preparer" that simply returns a provided, prepared transformer of arity 2.
 ...
 */
public class TrivialPreparer2<A, B, R, N extends PreparedTransformer2<A, B, R>> extends
    AbstractStreamPreparer2<A, B, R, N> {
   ...
   */
  public TrivialPreparer2(N prepared) {
  ...
  /**
     ...
     */
  public TrivialPreparer2(PreparedTransformer2<? super A, ? super B, ? extends R> preparedForPreparationData,
