...
/**
 * A function class implementing {@link BooleanFunction1.Serializable} that composes
 * {@link BooleanFunction1} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class BooleanComposedFunction1<A, Q> implements BooleanFunction1.Serializable<A>, Named {
   ...
   *                as input
   */
  BooleanComposedFunction1(Function1<A, Q> first, BooleanFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public BooleanComposedFunction1<A, Q> safelySerializable() {
    return new BooleanComposedFunction1<>(((Function1.Serializable<A, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(BooleanComposedFunction1.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof BooleanComposedFunction1) {
      return this._first.equals(((BooleanComposedFunction1) obj)._first)
          && this._andThen.equals(((BooleanComposedFunction1) obj)._andThen);
    }
    return false;
  }
