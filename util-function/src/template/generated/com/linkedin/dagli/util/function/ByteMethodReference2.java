 ...
 */
class ByteMethodReference2<A, B> implements ByteFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction2<A, B> _cachedFunction = null;

  ByteMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference2(Serializable<A, B> func) {
    if (func instanceof ByteMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference2) func)._methodReference;
    } else {
  ...
  private ByteFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference3<Object, A, B> unbound = new ByteMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction2.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference2) obj)._methodReference);
  }
