...
public class FunctionResult7<A, B, C, D, E, F, G, R> extends
  ...
  private Function7.Serializable<A, B, C, D, E, F, G, R> _originalFunction = null;
   ...
   */
  private void setFunction(Function7.Serializable<A, B, C, D, E, F, G, R> func) {
  ...
  public <Q> FunctionResult7<A, B, C, D, E, F, G, Q> andThen(Function1.Serializable<? super R, ? extends Q> mapper) {
    return (FunctionResult7<A, B, C, D, E, F, G, Q>) clone(c -> ((FunctionResult7<A, B, C, D, E, F, G, Q>) c)
