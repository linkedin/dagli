...
/**
 * A function class implementing {@link VoidFunction11.Serializable} that composes
 * {@link VoidFunction11} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class VoidComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> implements
   ...
   *                as input
   */
  VoidComposedFunction11(Function11<A, B, C, D, E, F, G, H, I, J, K, Q> first, VoidFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public VoidComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> safelySerializable() {
    return new VoidComposedFunction11<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(VoidComposedFunction11.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof VoidComposedFunction11) {
      return this._first.equals(((VoidComposedFunction11) obj)._first)
          && this._andThen.equals(((VoidComposedFunction11) obj)._andThen);
    }
    return false;
  }
