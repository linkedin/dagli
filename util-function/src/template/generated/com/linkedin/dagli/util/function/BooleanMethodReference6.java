 ...
 */
class BooleanMethodReference6<A, B, C, D, E, F> implements BooleanFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = BooleanMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction6<A, B, C, D, E, F> _cachedFunction = null;

  BooleanMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof BooleanMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference6) func)._methodReference;
    } else {
  ...
  private BooleanFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference7<Object, A, B, C, D, E, F> unbound =
          new BooleanMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference6) obj)._methodReference);
  }
