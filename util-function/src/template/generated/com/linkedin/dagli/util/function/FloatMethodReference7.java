...
class FloatMethodReference7<A, B, C, D, E, F, G> implements FloatFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  FloatMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof FloatMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference7) func)._methodReference;
    } else {
  ...
  private FloatFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference8<Object, A, B, C, D, E, F, G> unbound =
          new FloatMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference7) obj)._methodReference);
  }
