 ...
 */
class ShortMethodReference8<A, B, C, D, E, F, G, H> implements ShortFunction8.Serializable<A, B, C, D, E, F, G, H> {
  ...
  private static final int CLASS_HASH = ShortMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  ShortMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof ShortMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference8) func)._methodReference;
    } else {
  ...
  private ShortFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new ShortMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference8) obj)._methodReference);
  }
