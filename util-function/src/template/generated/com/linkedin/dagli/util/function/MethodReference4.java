 ...
 */
class MethodReference4<A, B, C, D, R> implements Function4.Serializable<A, B, C, D, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function4<A, B, C, D, R> _cachedFunction = null;

  MethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference4(Serializable<A, B, C, D, R> func) {
    if (func instanceof MethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference4) func)._methodReference;
    } else {
  ...
  private Function4<A, B, C, D, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference5<Object, A, B, C, D, R> unbound = new MethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function4<A, B, C, D, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function4.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference4)) {
      return false;
    }

    return _methodReference.equals(((MethodReference4) obj)._methodReference);
  }
