...
/**
 * A function class implementing {@link IntFunction9.Serializable} that composes
 * {@link IntFunction9} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class IntComposedFunction9<A, B, C, D, E, F, G, H, I, Q> implements
   ...
   *                as input
   */
  IntComposedFunction9(Function9<A, B, C, D, E, F, G, H, I, Q> first, IntFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public IntComposedFunction9<A, B, C, D, E, F, G, H, I, Q> safelySerializable() {
    return new IntComposedFunction9<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(IntComposedFunction9.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof IntComposedFunction9) {
      return this._first.equals(((IntComposedFunction9) obj)._first)
          && this._andThen.equals(((IntComposedFunction9) obj)._andThen);
    }
    return false;
  }
