 ...
 */
class IntMethodReference5<A, B, C, D, E> implements IntFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  IntMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof IntMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference5) func)._methodReference;
    } else {
  ...
  private IntFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference6<Object, A, B, C, D, E> unbound = new IntMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((IntMethodReference5) obj)._methodReference);
  }
