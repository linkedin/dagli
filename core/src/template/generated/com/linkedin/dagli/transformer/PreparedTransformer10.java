...
public interface PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R> extends
    Transformer10<A, B, C, D, E, F, G, H, I, J, R>, PreparedTransformer<R> {
   ...
   * @param value10 the tenth input value
   ...
   * @param values10 the list of values for the tenth input
  ...
  default ObjectReader<R> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
    ...
    ObjectReader
        .concatenate(Object[]::new, ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3),
            ...
            ObjectReader.wrap(values7), ObjectReader.wrap(values8), ObjectReader.wrap(values9),
            ObjectReader.wrap(values10)).lazyMap(Arrays::asList).forEachBatch(minibatchSize, batch -> {
  ...
  @Override
  PreparedTransformer10InternalAPI<A, B, C, D, E, F, G, H, I, J, R, ? extends PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>> internalAPI();
  ...
  static <A, B, C, D, E, F, G, H, I, J, R> PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R> cast(
      PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R> prepared) {
    // safe due to semantics of prepared transformers:
    return (PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>) prepared;
  }
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J, R> DAG10x1.Prepared<A, B, C, D, E, F, G, H, I, J, R> toDAG(
      PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R> transformer) {
    if (transformer instanceof DAG10x1.Prepared) {
      return (DAG10x1.Prepared<A, B, C, D, E, F, G, H, I, J, R>) transformer;
    }
