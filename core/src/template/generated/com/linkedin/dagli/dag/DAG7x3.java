 ...
 *
 * DAG7x3 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG7x3 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>
    extends
    AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>, DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>>
    implements
    PreparableDAGTransformer<Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>, DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>> {
   ...
   */
  DAG7x3(DAGStructure<Tuple3<RA, RB, RC>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>, DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>, DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>> {
    @Override
    ...
    @Override
    public DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> getInstance() {
      return DAG7x3.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG7x3<A, B, C, D, E, F, G, RA, RB, RC>>> getGraphReducers() {
   ...
   */
  public DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6, Producer<? extends G> input7) {
   ...
   */
  public DAG6x3<B, C, D, E, F, G, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, C, D, E, F, G, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, B, D, E, F, G, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, B, C, E, F, G, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, B, C, D, F, G, RA, RB, RC> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, B, C, D, E, G, RA, RB, RC> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG6x3<A, B, C, D, E, F, RA, RB, RC> withGeneratorAsInput7(Generator<G> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RC> the type of the third result
   */
  private static class Preparer<A, B, C, D, E, F, G, RA, RB, RC> extends
      AbstractBatchPreparer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> {
    // the DAG being prepared
    private final DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> _dag;
     ...
     */
    Preparer(DAG7x3<A, B, C, D, E, F, G, RA, RB, RC> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> finish(
  ...
  @Override
  protected Preparer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, G, RA, RB, RC> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>) res.getPreparerResult()
   ...
   */
  public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6, Iterable<? extends G> values7) {
    return (DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RC> the type of the third result
   */
  public static final class Result<A, B, C, D, E, F, G, RA, RB, RC> extends AbstractDAGResult3<RA, RB, RC> {
    // the prepared DAG
    private final DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RC> the type of the third result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, G, RA, RB, RC>
      extends
      AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>>
      implements PreparedDAGTransformer<Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> {
    ...
    * @param input7 the {@link Producer} providing the seventh input to the transformer
     ...
     */
    @Override
    public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>> {
      @Override
      public DAGStructure<Tuple3<RA, RB, RC>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> getInstance() {
        return DAG7x3.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<B, C, D, E, F, G, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      Placeholder<G> nestedPlaceholder7 = new Placeholder<>("Original Input 7");
      DAG7x3.Prepared<A, B, C, D, E, F, G, RA, RB, RC> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6, nestedPlaceholder7);
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, C, D, E, F, G, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, B, D, E, F, G, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, B, C, E, F, G, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, B, C, D, F, G, RA, RB, RC> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, B, C, D, E, G, RA, RB, RC> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> withGeneratorAsInput7(Generator<G> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple3<RA, RB, RC> apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) {
      try (
