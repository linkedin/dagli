...
import com.linkedin.dagli.preparer.TrivialPreparer3;
 ...
 */
@ValueEquality
public final class ConstantResultTransformation3<A, B, C, R>
    extends
    AbstractPreparableTransformer3<A, B, C, R, ConstantResultTransformation3.Prepared<A, B, C, R>, ConstantResultTransformation3<A, B, C, R>>
    implements ConstantResultTransformation<R, ConstantResultTransformation3<A, B, C, R>> {
   ...
   */
  public ConstantResultTransformation3() {
  }
   ...
   */
  public ConstantResultTransformation3<A, B, C, R> withResult(R result) {
    return clone(c -> {
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation3<A, B, C, R> withResultForPreparationData(R result) {
    return clone(c -> {
      c._resultForPreparationData = result;
    });
  }
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation3<A, B, C, R> withResultForNewData(R result) {
    return clone(c -> {
      c._resultForNewData = result;
    });
  }
  ...
  @Override
  protected Preparer3<A, B, C, R, ConstantResultTransformation3.Prepared<A, B, C, R>> getPreparer(
      PreparerContext context) {
    ConstantResultTransformation3.Prepared<A, B, C, R> resultForPrepData =
        new ConstantResultTransformation3.Prepared<A, B, C, R>(_resultForPreparationData);
    return _resultForPreparationData == _resultForNewData ? new TrivialPreparer3<>(resultForPrepData)
        : new TrivialPreparer3<>(resultForPrepData, new ConstantResultTransformation3.Prepared<A, B, C, R>(
            _resultForNewData));
  }

  @Override
  public ConstantResultTransformation3<A, B, C, R> withInput1(Producer<? extends A> inputA) {
    return super.withInput1(inputA);
  }

  @Override
  public ConstantResultTransformation3<A, B, C, R> withInput2(Producer<? extends B> inputB) {
    return super.withInput2(inputB);
  }

  @Override
  public ConstantResultTransformation3<A, B, C, R> withInput3(Producer<? extends C> inputC) {
    return super.withInput3(inputC);
  }

  @Override
  public String getName() {
    return "ConstantResultTransformation3("
  ...
  * @param <C> the type of the third input
   ...
   */
  @ValueEquality
  public static final class Prepared<A, B, C, R> extends
      AbstractPreparedTransformer3<A, B, C, R, ConstantResultTransformation3.Prepared<A, B, C, R>> implements
      ConstantResultTransformation.Prepared<R, ConstantResultTransformation3.Prepared<A, B, C, R>> {
    private static final long serialVersionUID = 1;
     ...
     * @return a copy of this transformer that will always have the specified constant result
     */
    public ConstantResultTransformation3.Prepared<A, B, C, R> withResult(R result) {
    ...
    @Override
    public ConstantResultTransformation3.Prepared<A, B, C, R> withInput1(Producer<? extends A> inputA) {
      return super.withInput1(inputA);
    }

    @Override
    public ConstantResultTransformation3.Prepared<A, B, C, R> withInput2(Producer<? extends B> inputB) {
      return super.withInput2(inputB);
    }

    @Override
    public ConstantResultTransformation3.Prepared<A, B, C, R> withInput3(Producer<? extends C> inputC) {
      return super.withInput3(inputC);
    }

    @Override
    public String getName() {
      return "ConstantResultTransformation3.Prepared(" + _result + ")";
    }
  }
}
