 ...
 *
 * DAG5x2 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x2 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x2<A, B, C, D, E, RA, RB>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>, DAG5x2<A, B, C, D, E, RA, RB>>
    implements
    PreparableDAGTransformer<Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>, DAG5x2<A, B, C, D, E, RA, RB>> {
   ...
   */
  DAG5x2(DAGStructure<Tuple2<RA, RB>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG5x2<A, B, C, D, E, RA, RB> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>, DAG5x2<A, B, C, D, E, RA, RB>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>, DAG5x2<A, B, C, D, E, RA, RB>> {
    @Override
    ...
    @Override
    public DAG5x2<A, B, C, D, E, RA, RB> getInstance() {
      return DAG5x2.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x2<A, B, C, D, E, RA, RB>>> getGraphReducers() {
   ...
   */
  public DAG5x2<A, B, C, D, E, RA, RB> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x2<A, B, C, D, E, RA, RB> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5) {
   ...
   */
  public DAG4x2<B, C, D, E, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x2<A, C, D, E, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x2<A, B, D, E, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x2<A, B, C, E, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x2<A, B, C, D, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RB> the type of the second result
   */
  private static class Preparer<A, B, C, D, E, RA, RB> extends
      AbstractBatchPreparer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> {
    // the DAG being prepared
    private final DAG5x2<A, B, C, D, E, RA, RB> _dag;
     ...
     */
    Preparer(DAG5x2<A, B, C, D, E, RA, RB> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, Tuple2<RA, RB>>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA, RB> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5) {
    DAGExecutionResult<Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG5x2.Prepared<A, B, C, D, E, RA, RB>) res.getPreparerResult()
   ...
   */
  public DAG5x2.Prepared<A, B, C, D, E, RA, RB> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5) {
    return (DAG5x2.Prepared<A, B, C, D, E, RA, RB>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RB> the type of the second result
   */
  public static final class Result<A, B, C, D, E, RA, RB> extends AbstractDAGResult2<RA, RB> {
    // the prepared DAG
    private final DAG5x2.Prepared<A, B, C, D, E, RA, RB> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x2.Prepared<A, B, C, D, E, RA, RB> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x2.Prepared<A, B, C, D, E, RA, RB> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RB> the type of the second result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA, RB> extends
      AbstractPreparedTransformer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> implements
      PreparedDAGTransformer<Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x2.Prepared<A, B, C, D, E, RA, RB> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer5<A, B, C, D, E, Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG5x2.Prepared<A, B, C, D, E, RA, RB>> {
      @Override
      public DAGStructure<Tuple2<RA, RB>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x2.Prepared<A, B, C, D, E, RA, RB> getInstance() {
        return DAG5x2.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x2.Prepared<A, B, C, D, E, RA, RB>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x2.Prepared<A, B, C, D, E, RA, RB> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x2.Prepared<A, B, C, D, E, RA, RB> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG4x2.Prepared<B, C, D, E, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x2.Prepared<A, B, C, D, E, RA, RB> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x2.Prepared<A, C, D, E, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x2.Prepared<A, B, D, E, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x2.Prepared<A, B, C, E, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x2.Prepared<A, B, C, D, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple2<RA, RB> apply(A value1, B value2, C value3, D value4, E value5) {
      try (
