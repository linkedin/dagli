...
/**
 * A function class implementing {@link ShortFunction9.Serializable} that composes
 * {@link ShortFunction9} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
...
class ShortComposedFunction9<A, B, C, D, E, F, G, H, I, Q> implements
   ...
   *                as input
   */
  ShortComposedFunction9(Function9<A, B, C, D, E, F, G, H, I, Q> first, ShortFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ShortComposedFunction9<A, B, C, D, E, F, G, H, I, Q> safelySerializable() {
    return new ShortComposedFunction9<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ShortComposedFunction9.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ShortComposedFunction9) {
      return this._first.equals(((ShortComposedFunction9) obj)._first)
