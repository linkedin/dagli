...
@FunctionalInterface
public interface CharacterFunction5<A, B, C, D, E> extends FunctionBase {
  char apply(A value1, B value2, C value3, D value4, E value5);
   ...
   */
  default CharacterFunction5<A, B, C, D, E> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument5<>(this);
  }

  static <A, B, C, D, E> CharacterFunction5<A, B, C, D, E> unchecked(Checked<A, B, C, D, E, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3, D value4, E value5) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction5.Serializable should override this method
   ...
   */
  static <A, B, C, D, E> CharacterFunction5.Serializable<A, B, C, D, E> safelySerializable(
      Serializable<A, B, C, D, E> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E> extends CharacterFunction5<A, B, C, D, E>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E> safelySerializable() {
      try {
        return new CharacterMethodReference5<A, B, C, D, E>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E> returnZeroOnNullArgument() {
      return new CharacterDefaultOnNullArgument5<>(this);
    }
