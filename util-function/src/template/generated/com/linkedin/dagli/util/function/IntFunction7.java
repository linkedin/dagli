...
@FunctionalInterface
public interface IntFunction7<A, B, C, D, E, F, G> extends FunctionBase {
  int apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7);
   ...
   */
  default IntFunction7<A, B, C, D, E, F, G> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument7<>(this);
  }

  static <A, B, C, D, E, F, G> IntFunction7<A, B, C, D, E, F, G> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction7.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G> IntFunction7.Serializable<A, B, C, D, E, F, G> safelySerializable(
      Serializable<A, B, C, D, E, F, G> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G> extends IntFunction7<A, B, C, D, E, F, G>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G> safelySerializable() {
      try {
        return new IntMethodReference7<A, B, C, D, E, F, G>(this);
