 ...
 */
class BooleanMethodReference2<A, B> implements BooleanFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = BooleanMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction2<A, B> _cachedFunction = null;

  BooleanMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference2(Serializable<A, B> func) {
    if (func instanceof BooleanMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference2) func)._methodReference;
    } else {
  ...
  private BooleanFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference3<Object, A, B> unbound = new BooleanMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction2.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference2) obj)._methodReference);
  }
