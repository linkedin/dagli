...
/**
 * A function class implementing {@link FloatFunction11.Serializable} that composes
 * {@link FloatFunction11} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class FloatComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> implements
   ...
   *                as input
   */
  FloatComposedFunction11(Function11<A, B, C, D, E, F, G, H, I, J, K, Q> first, FloatFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public FloatComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> safelySerializable() {
    return new FloatComposedFunction11<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(FloatComposedFunction11.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof FloatComposedFunction11) {
      return this._first.equals(((FloatComposedFunction11) obj)._first)
          && this._andThen.equals(((FloatComposedFunction11) obj)._andThen);
    }
    return false;
  }
}
