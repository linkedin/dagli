 ...
 */
class VoidMethodReference0 implements VoidFunction0.Serializable, Named {
  ...
  private static final int CLASS_HASH = VoidMethodReference0.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction0 _cachedFunction = null;

  VoidMethodReference0(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference0(Serializable func) {
    if (func instanceof VoidMethodReference0) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference0) func)._methodReference;
    } else {
  ...
  private VoidFunction0 fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference1<Object> unbound = new VoidMethodReference1<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction0) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction0.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference0)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference0) obj)._methodReference);
  }
