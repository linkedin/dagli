 ...
 *
 * DAG5x10 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x10 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
    implements
    PreparableDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
   ...
   */
  DAG5x10(DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    @Override
    ...
    @Override
    public DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
      return DAG5x10.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
   ...
   */
  public DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
      Producer<? extends E> input5) {
   ...
   */
  public DAG4x10<B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG4x10<A, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x10<A, B, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x10<A, B, C, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x10<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RJ> the type of the tenth result
   */
  private static class Preparer<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractBatchPreparer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    // the DAG being prepared
    private final DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _dag;
     ...
     */
    Preparer(DAG5x10<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    DAGExecutionResult<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) res
   ...
   */
  public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    return (DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RJ> the type of the tenth result
   */
  public static final class Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> extends
      AbstractDAGResult10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> {
    // the prepared DAG
    private final DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> preparedDAG,
  ...
  * @param <RJ> the type of the tenth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractPreparedTransformer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
      implements
      PreparedDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer5<A, B, C, D, E, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
      @Override
      public DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
        return DAG5x10.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInputs(
     ...
     *         the produced by the provided generator
     */
    public DAG4x10.Prepared<B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput1(
        Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x10.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x10.Prepared<A, C, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput2(
     ...
     *         the produced by the provided generator
     */
    public DAG4x10.Prepared<A, B, D, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput3(
     ...
     *         the produced by the provided generator
     */
    public DAG4x10.Prepared<A, B, C, E, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput4(
     ...
     *         the produced by the provided generator
     */
    public DAG4x10.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput5(
