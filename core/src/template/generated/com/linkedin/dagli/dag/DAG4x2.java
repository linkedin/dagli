 ...
 *
 * DAG4x2 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x2 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x2<A, B, C, D, RA, RB>
    extends
    AbstractPreparableTransformer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>, DAG4x2<A, B, C, D, RA, RB>>
    implements
    PreparableDAGTransformer<Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>, DAG4x2<A, B, C, D, RA, RB>> {
   ...
   */
  DAG4x2(DAGStructure<Tuple2<RA, RB>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG4x2<A, B, C, D, RA, RB> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>, DAG4x2<A, B, C, D, RA, RB>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>, DAG4x2<A, B, C, D, RA, RB>> {
    @Override
    ...
    @Override
    public DAG4x2<A, B, C, D, RA, RB> getInstance() {
      return DAG4x2.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG4x2<A, B, C, D, RA, RB>>> getGraphReducers() {
   ...
   */
  public DAG4x2<A, B, C, D, RA, RB> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x2<A, B, C, D, RA, RB> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4) {
   ...
   */
  public DAG3x2<B, C, D, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG3x2<A, C, D, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG3x2<A, B, D, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x2<A, B, C, D, RA, RB> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG3x2<A, B, C, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x2<A, B, C, D, RA, RB> dag =
   ...
   * @param <RB> the type of the second result
   */
  private static class Preparer<A, B, C, D, RA, RB> extends
      AbstractBatchPreparer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> {
    // the DAG being prepared
    private final DAG4x2<A, B, C, D, RA, RB> _dag;
     ...
     */
    Preparer(DAG4x2<A, B, C, D, RA, RB> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, Tuple2<RA, RB>>, DAG4x2.Prepared<A, B, C, D, RA, RB>> finish(
  ...
  @Override
  protected Preparer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA, RB> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x2.Prepared<A, B, C, D, RA, RB>) res.getPreparerResult()
   ...
   */
  public DAG4x2.Prepared<A, B, C, D, RA, RB> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x2.Prepared<A, B, C, D, RA, RB>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RB> the type of the second result
   */
  public static final class Result<A, B, C, D, RA, RB> extends AbstractDAGResult2<RA, RB> {
    // the prepared DAG
    private final DAG4x2.Prepared<A, B, C, D, RA, RB> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x2.Prepared<A, B, C, D, RA, RB> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x2.Prepared<A, B, C, D, RA, RB> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RB> the type of the second result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA, RB> extends
      AbstractPreparedTransformer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> implements
      PreparedDAGTransformer<Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x2.Prepared<A, B, C, D, RA, RB> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer4<A, B, C, D, Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG4x2.Prepared<A, B, C, D, RA, RB>> {
      @Override
      public DAGStructure<Tuple2<RA, RB>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x2.Prepared<A, B, C, D, RA, RB> getInstance() {
        return DAG4x2.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x2.Prepared<A, B, C, D, RA, RB>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x2.Prepared<A, B, C, D, RA, RB> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x2.Prepared<A, B, C, D, RA, RB> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
        Producer<? extends C> input3, Producer<? extends D> input4) {
      return super.withAllInputs(input1, input2, input3, input4);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x2.Prepared<B, C, D, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x2.Prepared<A, B, C, D, RA, RB> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);
     ...
     *         the produced by the provided generator
     */
    public DAG3x2.Prepared<A, C, D, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x2.Prepared<A, B, C, D, RA, RB> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x2.Prepared<A, B, D, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x2.Prepared<A, B, C, D, RA, RB> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x2.Prepared<A, B, C, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG4x2.Prepared<A, B, C, D, RA, RB> dag =
    ...
    @Override
    public Tuple2<RA, RB> apply(A value1, B value2, C value3, D value4) {
      try (
