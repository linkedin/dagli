 ...
 *
 * DAG4x5 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x5 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>
    extends
    AbstractPreparableTransformer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>, DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>>
    implements
    PreparableDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>, DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>> {
   ...
   */
  DAG4x5(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>, DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>, DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>> {
    @Override
    ...
    @Override
    public DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> getInstance() {
      return DAG4x5.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG4x5<A, B, C, D, RA, RB, RC, RD, RE>>> getGraphReducers() {
   ...
   */
  public DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4) {
   ...
   */
  public DAG3x5<B, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag)).withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG3x5<A, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG3x5<A, B, D, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG3x5<A, B, C, RA, RB, RC, RD, RE> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> dag =
   ...
   * @param <RE> the type of the fifth result
   */
  private static class Preparer<A, B, C, D, RA, RB, RC, RD, RE> extends
      AbstractBatchPreparer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> {
    // the DAG being prepared
    private final DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> _dag;
     ...
     */
    Preparer(DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> finish(
  ...
  @Override
  protected Preparer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA, RB, RC, RD, RE> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>) res.getPreparerResult()
   ...
   */
  public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RE> the type of the fifth result
   */
  public static final class Result<A, B, C, D, RA, RB, RC, RD, RE> extends AbstractDAGResult5<RA, RB, RC, RD, RE> {
    // the prepared DAG
    private final DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RE> the type of the fifth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA, RB, RC, RD, RE>
      extends
      AbstractPreparedTransformer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>>
      implements PreparedDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer4<A, B, C, D, Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>> {
      @Override
      public DAGStructure<Tuple5<RA, RB, RC, RD, RE>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> getInstance() {
        return DAG4x5.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG3x5.Prepared<B, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);
     ...
     *         the produced by the provided generator
     */
    public DAG3x5.Prepared<A, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x5.Prepared<A, B, D, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> dag =
    ...
    @Override
    public Tuple5<RA, RB, RC, RD, RE> apply(A value1, B value2, C value3, D value4) {
      try (
