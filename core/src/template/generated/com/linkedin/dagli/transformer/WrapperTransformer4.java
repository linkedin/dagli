 ...
 */
@ValueEquality
public class WrapperTransformer4<A, B, C, D, R, S extends WrapperTransformer4<A, B, C, D, R, S>> extends
    AbstractPreparableTransformer4<A, B, C, D, R, PreparedTransformer4<A, B, C, D, R>, S> {

  private static final long serialVersionUID = 1;

  protected PreparableTransformer4<A, B, C, D, R, ?> _wrappedTransformer = null;
   ...
   */
  public WrapperTransformer4(
      PreparableTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R, ?> wrappedTransformer) {
   ...
   * class' constructor using {@link #setWrappedTransformer(PreparableTransformer4)}
   */
  public WrapperTransformer4() {
  }
   ...
   */
  protected WrapperTransformer4<A, B, C, D, R, S> withWrappedTransformer(
      PreparableTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R, ?> wrapped) {
  ...
  protected void setWrappedTransformer(
      PreparableTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R, ?> wrapped) {
    _wrappedTransformer = PreparableTransformer4.castWithGenericPrepared(wrapped);
  ...
  @Override
  protected Preparer4<A, B, C, D, R, PreparedTransformer4<A, B, C, D, R>> getPreparer(PreparerContext context) {
    return Preparer4.cast(_wrappedTransformer.internalAPI().getPreparer(context));
  }
  ...
  * @param <R> the type of result produced by the transformer
   ...
   */
  @ValueEquality
  public static abstract class Prepared<A, B, C, D, R, S extends WrapperTransformer4.Prepared<A, B, C, D, R, S>>
      extends AbstractPreparedStatefulTransformer4<A, B, C, D, R, Object, S> {

    private static final long serialVersionUID = 1;

    protected PreparedTransformer4<A, B, C, D, R> _wrappedTransformer = null;
     ...
     * @param wrappedTransformer the transformer to wrap
     */
    public Prepared(PreparedTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R> wrappedTransformer) {
      setWrappedTransformer(wrappedTransformer);
    }

    /**
     * Constructs a new instance that will initially lack a wrapped transformer (this should be set during the derived
     * class' constructor using {@link #setWrappedTransformer(PreparedTransformer4)}
     */
    public Prepared() {
    }
     ...
     * @param wrapped the transformer to wrap
     */
    protected WrapperTransformer4.Prepared<A, B, C, D, R, S> withWrappedTransformer(
        PreparedTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R> wrapped) {
      return clone(c -> c.setWrappedTransformer(wrapped));
    }
    ...
    protected void setWrappedTransformer(
        PreparedTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R> wrapped) {
      _wrappedTransformer = PreparedTransformer4.cast(wrapped);
      _input1 = _wrappedTransformer.internalAPI().getInput1();
      _input2 = _wrappedTransformer.internalAPI().getInput2();
      _input3 = _wrappedTransformer.internalAPI().getInput3();
      _input4 = _wrappedTransformer.internalAPI().getInput4();
    ...
    public R apply(A value1, B value2, C value3, D value4) {
      return _wrappedTransformer.apply(value1, value2, value3, value4);
    }
    ...
    public ObjectReader<R> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
      ...
      return _wrappedTransformer.applyAll(values1, values2, values3, values4);
    }

    @Override
    protected R apply(Object executionCache, A value1, B value2, C value3, D value4) {
      return _wrappedTransformer.internalAPI().apply(executionCache, value1, value2, value3, value4);
    }

    @Override
    protected void applyAll(Object executionCache, List<? extends A> values1, List<? extends B> values2,
        List<? extends C> values3, List<? extends D> values4, List<? super R> results) {
      _wrappedTransformer.internalAPI().applyAllUnsafe(executionCache, values1.size(),
          Arrays.asList(values1, values2, values3, values4), results);
    }
