...
@FunctionalInterface
public interface ShortFunction0 extends FunctionBase {
  short apply();

  static ShortFunction0 unchecked(Checked<?> checkedFunction) {
    return () -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement ShortFunction0.Serializable should override this method
   ...
   */
  static ShortFunction0.Serializable safelySerializable(Serializable function) {
    return function.safelySerializable();
  }

  interface Serializable extends ShortFunction0, java.io.Serializable {
    /**
    ...
    default Serializable safelySerializable() {
      try {
        return new ShortMethodReference0(this);
