...
@FunctionalInterface
public interface CharacterFunction3<A, B, C> extends FunctionBase {
  char apply(A value1, B value2, C value3);
   ...
   */
  default CharacterFunction3<A, B, C> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> CharacterFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> CharacterFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends CharacterFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new CharacterMethodReference3<A, B, C>(this);
    ...
    @Override
    default Serializable<A, B, C> returnZeroOnNullArgument() {
      return new CharacterDefaultOnNullArgument3<>(this);
    }
