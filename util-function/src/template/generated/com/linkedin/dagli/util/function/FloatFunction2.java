...
@FunctionalInterface
public interface FloatFunction2<A, B> extends FunctionBase {
  float apply(A value1, B value2);
   ...
   */
  default FloatFunction2<A, B> returnZeroOnNullArgument() {
    return new FloatDefaultOnNullArgument2<>(this);
  }

  static <A, B> FloatFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    float apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement FloatFunction2.Serializable should override this method
   ...
   */
  static <A, B> FloatFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends FloatFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new FloatMethodReference2<A, B>(this);
