...
@FunctionalInterface
public interface ByteFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default ByteFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> ByteFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement ByteFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> ByteFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends ByteFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new ByteMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
