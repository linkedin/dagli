 ...
 *
 * DAG5x1 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x1 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x1<A, B, C, D, E, RA> extends
    AbstractPreparableTransformer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>, DAG5x1<A, B, C, D, E, RA>>
    implements PreparableDAGTransformer<RA, DAG5x1.Prepared<A, B, C, D, E, RA>, DAG5x1<A, B, C, D, E, RA>> {
   ...
   */
  DAG5x1(DAGStructure<RA> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG5x1<A, B, C, D, E, RA> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>, DAG5x1<A, B, C, D, E, RA>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<RA, DAG5x1.Prepared<A, B, C, D, E, RA>, DAG5x1<A, B, C, D, E, RA>> {
    @Override
    ...
    @Override
    public DAG5x1<A, B, C, D, E, RA> getInstance() {
      return DAG5x1.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x1<A, B, C, D, E, RA>>> getGraphReducers() {
   ...
   */
  public DAG5x1<A, B, C, D, E, RA> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x1<A, B, C, D, E, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5) {
   ...
   */
  public DAG4x1<B, C, D, E, RA> withGeneratorAsInput1(Generator<A> generator) {
    ...
    return DAG.withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5)
        .withOutput(dag).withExecutor(_executor).withInputs(getInput2(), getInput3(), getInput4(), getInput5());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG4x1<A, C, D, E, RA> withGeneratorAsInput2(Generator<B> generator) {
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5)
        .withOutput(dag).withExecutor(_executor).withInputs(getInput1(), getInput3(), getInput4(), getInput5());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG4x1<A, B, D, E, RA> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4, nestedPlaceholder5)
        .withOutput(dag).withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput4(), getInput5());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG4x1<A, B, C, E, RA> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder5)
        .withOutput(dag).withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3(), getInput5());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG4x1<A, B, C, D, RA> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4)
        .withOutput(dag).withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3(), getInput4());
  }
   ...
   * @param <RA> the type of the first result
   */
  private static class Preparer<A, B, C, D, E, RA> extends
      AbstractBatchPreparer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>> {
    // the DAG being prepared
    private final DAG5x1<A, B, C, D, E, RA> _dag;
     ...
     */
    Preparer(DAG5x1<A, B, C, D, E, RA> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, RA>, DAG5x1.Prepared<A, B, C, D, E, RA>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>> getPreparer(PreparerContext context) {
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5) {
    DAGExecutionResult<RA, DAG5x1.Prepared<A, B, C, D, E, RA>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>(
        (DAG5x1.Prepared<A, B, C, D, E, RA>) res.getPreparerResult().getPreparedTransformerForNewData(),
        res.getOutputs());
  }
   ...
   */
  public DAG5x1.Prepared<A, B, C, D, E, RA> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5) {
    return (DAG5x1.Prepared<A, B, C, D, E, RA>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RA> the type of the first result
   */
  public static final class Result<A, B, C, D, E, RA> extends AbstractDAGResult1<RA> {
    // the prepared DAG
    private final DAG5x1.Prepared<A, B, C, D, E, RA> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x1.Prepared<A, B, C, D, E, RA> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x1.Prepared<A, B, C, D, E, RA> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RA> the type of the first result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA> extends
      AbstractPreparedTransformer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>> implements
      PreparedDAGTransformer<RA, DAG5x1.Prepared<A, B, C, D, E, RA>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x1.Prepared<A, B, C, D, E, RA> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer5<A, B, C, D, E, RA, DAG5x1.Prepared<A, B, C, D, E, RA>>.InternalAPI implements
        PreparedDAGTransformer.InternalAPI<RA, DAG5x1.Prepared<A, B, C, D, E, RA>> {
      @Override
      public DAGStructure<RA> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x1.Prepared<A, B, C, D, E, RA> getInstance() {
        return DAG5x1.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x1.Prepared<A, B, C, D, E, RA>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x1.Prepared<A, B, C, D, E, RA> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x1.Prepared<A, B, C, D, E, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
        Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5) {
      return super.withAllInputs(input1, input2, input3, input4, input5);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG4x1.Prepared<B, C, D, E, RA> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x1.Prepared<A, B, C, D, E, RA> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x1.Prepared<A, C, D, E, RA> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x1.Prepared<A, B, D, E, RA> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x1.Prepared<A, B, C, E, RA> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x1.Prepared<A, B, C, D, RA> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public RA apply(A value1, B value2, C value3, D value4, E value5) {
      try (
