 ...
 */
class CharacterMethodReference2<A, B> implements CharacterFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction2<A, B> _cachedFunction = null;

  CharacterMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference2(Serializable<A, B> func) {
    if (func instanceof CharacterMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference2) func)._methodReference;
    } else {
  ...
  private CharacterFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference3<Object, A, B> unbound = new CharacterMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction2.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference2) obj)._methodReference);
  }
