...
/**
 * A function class implementing {@link ShortFunction5.Serializable} that composes
 * {@link ShortFunction5} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ShortComposedFunction5<A, B, C, D, E, Q> implements ShortFunction5.Serializable<A, B, C, D, E>, Named {
   ...
   *                as input
   */
  ShortComposedFunction5(Function5<A, B, C, D, E, Q> first, ShortFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ShortComposedFunction5<A, B, C, D, E, Q> safelySerializable() {
    return new ShortComposedFunction5<>(((Function5.Serializable<A, B, C, D, E, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ShortComposedFunction5.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ShortComposedFunction5) {
      return this._first.equals(((ShortComposedFunction5) obj)._first)
          && this._andThen.equals(((ShortComposedFunction5) obj)._andThen);
    }
    return false;
  }
