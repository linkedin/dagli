 ...
 *
 * DAG2x8 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG2x8 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>
    extends
    AbstractPreparableTransformer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>
    implements
    PreparableDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> {
   ...
   */
  DAG2x8(DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> {
    @Override
    ...
    @Override
    public DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
      return DAG2x8.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
   ...
   */
  public DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2) {
   ...
   */
  public DAG1x8<B, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput1(Generator<A> generator) {
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> dag = this.withInputs(generator, nestedPlaceholder2);
   ...
   *         the produced by the provided generator
   */
  public DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> dag = this.withInputs(nestedPlaceholder1, generator);
   ...
   * @param <RH> the type of the eighth result
   */
  private static class Preparer<A, B, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractBatchPreparer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> {
    // the DAG being prepared
    private final DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> _dag;
     ...
     */
    Preparer(DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> finish(
  ...
  @Override
  protected Preparer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, RA, RB, RC, RD, RE, RF, RG, RH> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    DAGExecutionResult<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) });
    return new Result<>((DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>) res.getPreparerResult()
   ...
   */
  public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    return (DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>) _executor.internalAPI()
  ...
  * @param <RH> the type of the eighth result
   */
  public static final class Result<A, B, RA, RB, RC, RD, RE, RF, RG, RH> extends
      AbstractDAGResult8<RA, RB, RC, RD, RE, RF, RG, RH> {
    // the prepared DAG
    private final DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RH> the type of the eighth result
   */
  @ValueEquality
  public static class Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractPreparedTransformer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>
      implements
      PreparedDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> {
    ...
    * @param input2 the {@link Producer} providing the second input to the transformer
     ...
     */
    @Override
    public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer2<A, B, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>> {
      @Override
      public DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
        return DAG2x8.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2) {
      return super.withAllInputs(input1, input2);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG1x8.Prepared<B, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> dag = this.withInputs(generator, nestedPlaceholder2);
     ...
     *         the produced by the provided generator
     */
    public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> dag = this.withInputs(nestedPlaceholder1, generator);
     ...
     */
    public Result<RA, RB, RC, RD, RE, RF, RG, RH> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2) {
      return new Result<RA, RB, RC, RD, RE, RF, RG, RH>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) }));
    }

    @Override
    public Tuple8<RA, RB, RC, RD, RE, RF, RG, RH> apply(A value1, B value2) {
      try (
