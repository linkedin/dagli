 ...
 *
 * DAG2x4 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG2x4 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG2x4<A, B, RA, RB, RC, RD>
    extends
    AbstractPreparableTransformer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>, DAG2x4<A, B, RA, RB, RC, RD>>
    implements
    PreparableDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>, DAG2x4<A, B, RA, RB, RC, RD>> {
   ...
   */
  DAG2x4(DAGStructure<Tuple4<RA, RB, RC, RD>> dag, Producer<? extends A> input1, Producer<? extends B> input2) {
    super(input1, input2);
    _dag = dag;
   ...
   */
  @Override
  public DAG2x4<A, B, RA, RB, RC, RD> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>, DAG2x4<A, B, RA, RB, RC, RD>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>, DAG2x4<A, B, RA, RB, RC, RD>> {
    @Override
    ...
    @Override
    public DAG2x4<A, B, RA, RB, RC, RD> getInstance() {
      return DAG2x4.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG2x4<A, B, RA, RB, RC, RD>>> getGraphReducers() {
   ...
   */
  public DAG2x4<A, B, RA, RB, RC, RD> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG2x4<A, B, RA, RB, RC, RD> withInputs(Producer<? extends A> input1, Producer<? extends B> input2) {
   ...
   */
  public DAG1x4<B, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG2x4<A, B, RA, RB, RC, RD> dag = this.withInputs(generator, nestedPlaceholder2);

    return DAG
        .withPlaceholder(nestedPlaceholder2)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInput(getInput2());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG1x4<A, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    DAG2x4<A, B, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, generator);

    return DAG
        .withPlaceholder(nestedPlaceholder1)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInput(getInput1());
  }
   ...
   * @param <RD> the type of the fourth result
   */
  private static class Preparer<A, B, RA, RB, RC, RD> extends
      AbstractBatchPreparer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> {
    // the DAG being prepared
    private final DAG2x4<A, B, RA, RB, RC, RD> _dag;
     ...
     */
    Preparer(DAG2x4<A, B, RA, RB, RC, RD> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer2<A, B, Tuple4<RA, RB, RC, RD>>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> finish(
  ...
  @Override
  protected Preparer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, RA, RB, RC, RD> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2) {
    DAGExecutionResult<Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) });
    return new Result<>((DAG2x4.Prepared<A, B, RA, RB, RC, RD>) res.getPreparerResult()
   ...
   */
  public DAG2x4.Prepared<A, B, RA, RB, RC, RD> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2) {
    return (DAG2x4.Prepared<A, B, RA, RB, RC, RD>) _executor.internalAPI()
  ...
  * @param <RD> the type of the fourth result
   */
  public static final class Result<A, B, RA, RB, RC, RD> extends AbstractDAGResult4<RA, RB, RC, RD> {
    // the prepared DAG
    private final DAG2x4.Prepared<A, B, RA, RB, RC, RD> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG2x4.Prepared<A, B, RA, RB, RC, RD> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG2x4.Prepared<A, B, RA, RB, RC, RD> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RD> the type of the fourth result
   */
  @ValueEquality
  public static class Prepared<A, B, RA, RB, RC, RD> extends
      AbstractPreparedTransformer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> implements
      PreparedDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> {
    ...
    * @param input2 the {@link Producer} providing the second input to the transformer
     ...
     */
    @Override
    public DAG2x4.Prepared<A, B, RA, RB, RC, RD> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer2<A, B, Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG2x4.Prepared<A, B, RA, RB, RC, RD>> {
      @Override
      public DAGStructure<Tuple4<RA, RB, RC, RD>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG2x4.Prepared<A, B, RA, RB, RC, RD> getInstance() {
        return DAG2x4.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG2x4.Prepared<A, B, RA, RB, RC, RD>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG2x4.Prepared<A, B, RA, RB, RC, RD> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG2x4.Prepared<A, B, RA, RB, RC, RD> withInputs(Producer<? extends A> input1, Producer<? extends B> input2) {
      return super.withAllInputs(input1, input2);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG1x4.Prepared<B, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG2x4.Prepared<A, B, RA, RB, RC, RD> dag = this.withInputs(generator, nestedPlaceholder2);
     ...
     *         the produced by the provided generator
     */
    public DAG1x4.Prepared<A, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      DAG2x4.Prepared<A, B, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, generator);
    ...
    @Override
    public Tuple4<RA, RB, RC, RD> apply(A value1, B value2) {
      try (
