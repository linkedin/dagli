 ...
 */
class VoidMethodReference6<A, B, C, D, E, F> implements VoidFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = VoidMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction6<A, B, C, D, E, F> _cachedFunction = null;

  VoidMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof VoidMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference6) func)._methodReference;
    } else {
  ...
  private VoidFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference7<Object, A, B, C, D, E, F> unbound = new VoidMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction6.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5, F value6) {
    _cachedFunction.apply(value1, value2, value3, value4, value5, value6);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference6) obj)._methodReference);
  }
