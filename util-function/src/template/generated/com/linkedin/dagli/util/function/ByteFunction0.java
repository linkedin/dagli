...
@FunctionalInterface
public interface ByteFunction0 extends FunctionBase {
  byte apply();

  static ByteFunction0 unchecked(Checked<?> checkedFunction) {
    return () -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement ByteFunction0.Serializable should override this method
   ...
   */
  static ByteFunction0.Serializable safelySerializable(Serializable function) {
    return function.safelySerializable();
  }

  interface Serializable extends ByteFunction0, java.io.Serializable {
    /**
    ...
    default Serializable safelySerializable() {
      try {
        return new ByteMethodReference0(this);
