...
public interface ByteFunctionVariadic<A> extends FunctionBase {
  ...
  static <A> ByteFunctionVariadic<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A... args) -> {
      try {
  ...
  interface Checked<A, X extends Throwable> extends FunctionBase {
    byte apply(A... args) throws X;
  }

  interface Serializable<A> extends ByteFunctionVariadic<A>, java.io.Serializable {
  }
}
