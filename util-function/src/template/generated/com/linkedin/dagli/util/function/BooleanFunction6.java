...
@FunctionalInterface
public interface BooleanFunction6<A, B, C, D, E, F> extends FunctionBase {
  boolean apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default BooleanFunction6<A, B, C, D, E, F> returnFalseOnNullArgument() {
    return new BooleanDefaultOnNullArgument6<>(this);
  }

  default BooleanFunction6<A, B, C, D, E, F> negate() {
    return BooleanNegatedFunction6.negate(this);
  }

  static <A, B, C, D, E, F> BooleanFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> BooleanFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends BooleanFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new BooleanMethodReference6<A, B, C, D, E, F>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F> returnFalseOnNullArgument() {
      return new BooleanDefaultOnNullArgument6<>(this);
    }

    @Override
    default Serializable<A, B, C, D, E, F> negate() {
      return BooleanNegatedFunction6.Serializable.negate(this);
    }
