...
@FunctionalInterface
public interface CharacterFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default CharacterFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> CharacterFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> CharacterFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends CharacterFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new CharacterMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
