 ...
 */
@ValueEquality
public class WrapperTransformer9<A, B, C, D, E, F, G, H, I, R, S extends WrapperTransformer9<A, B, C, D, E, F, G, H, I, R, S>>
    extends
    AbstractPreparableTransformer9<A, B, C, D, E, F, G, H, I, R, PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>, S> {

  private static final long serialVersionUID = 1;

  protected PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, ?> _wrappedTransformer = null;
   ...
   */
  public WrapperTransformer9(
      PreparableTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R, ?> wrappedTransformer) {
   ...
   * class' constructor using {@link #setWrappedTransformer(PreparableTransformer9)}
   */
  public WrapperTransformer9() {
  }
   ...
   */
  protected WrapperTransformer9<A, B, C, D, E, F, G, H, I, R, S> withWrappedTransformer(
      PreparableTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R, ?> wrapped) {
  ...
  protected void setWrappedTransformer(
      PreparableTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R, ?> wrapped) {
    _wrappedTransformer = PreparableTransformer9.castWithGenericPrepared(wrapped);
  ...
  @Override
  protected Preparer9<A, B, C, D, E, F, G, H, I, R, PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>> getPreparer(
      PreparerContext context) {
    return Preparer9.cast(_wrappedTransformer.internalAPI().getPreparer(context));
  }
  ...
  * @param <R> the type of result produced by the transformer
   ...
   */
  @ValueEquality
  public static abstract class Prepared<A, B, C, D, E, F, G, H, I, R, S extends WrapperTransformer9.Prepared<A, B, C, D, E, F, G, H, I, R, S>>
      extends AbstractPreparedStatefulTransformer9<A, B, C, D, E, F, G, H, I, R, Object, S> {

    private static final long serialVersionUID = 1;

    protected PreparedTransformer9<A, B, C, D, E, F, G, H, I, R> _wrappedTransformer = null;
     ...
     */
    public Prepared(
        PreparedTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R> wrappedTransformer) {
      setWrappedTransformer(wrappedTransformer);
    }

    /**
     * Constructs a new instance that will initially lack a wrapped transformer (this should be set during the derived
     * class' constructor using {@link #setWrappedTransformer(PreparedTransformer9)}
     */
    public Prepared() {
    }
     ...
     * @param wrapped the transformer to wrap
     */
    protected WrapperTransformer9.Prepared<A, B, C, D, E, F, G, H, I, R, S> withWrappedTransformer(
        PreparedTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R> wrapped) {
      return clone(c -> c.setWrappedTransformer(wrapped));
    }
    ...
    protected void setWrappedTransformer(
        PreparedTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R> wrapped) {
      _wrappedTransformer = PreparedTransformer9.cast(wrapped);
      _input1 = _wrappedTransformer.internalAPI().getInput1();
      _input2 = _wrappedTransformer.internalAPI().getInput2();
      _input3 = _wrappedTransformer.internalAPI().getInput3();
      _input4 = _wrappedTransformer.internalAPI().getInput4();
    ...
    public R apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) {
      return _wrappedTransformer.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9);
    }
    ...
    protected void applyAll(Object executionCache, List<? extends A> values1, List<? extends B> values2,
        ...
        List<? extends G> values7, List<? extends H> values8, List<? extends I> values9, List<? super R> results) {
      _wrappedTransformer.internalAPI().applyAllUnsafe(executionCache, values1.size(),
          Arrays.asList(values1, values2, values3, values4, values5, values6, values7, values8, values9), results);
    }
