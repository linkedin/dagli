 ...
 */
abstract class AbstractDAGResult4<RA, RB, RC, RD> extends WrappedObjectReader<Tuple4<RA, RB, RC, RD>> implements
    DAGResult4<RA, RB, RC, RD>, AutoCloseable {
   ...
   *
   * @param results an array of length 4 providing an {@link ObjectReader} for each of the DAG's outputs.
   */
  @SuppressWarnings("unchecked")
  AbstractDAGResult4(ObjectReader<?>[] results) {
    this((ObjectReader<RA>) results[0], (ObjectReader<RB>) results[1], (ObjectReader<RC>) results[2],
        (ObjectReader<RD>) results[3]);
   ...
   */
  AbstractDAGResult4(ObjectReader<RA> results1, ObjectReader<RB> results2, ObjectReader<RC> results3,
      ObjectReader<RD> results4) {
    super(new TupleReader<>(results1, results2, results3, results4));
