...
@FunctionalInterface
public interface ByteFunction7<A, B, C, D, E, F, G> extends FunctionBase {
  byte apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7);
   ...
   */
  default ByteFunction7<A, B, C, D, E, F, G> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument7<>(this);
  }

  static <A, B, C, D, E, F, G> ByteFunction7<A, B, C, D, E, F, G> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, X extends Throwable> extends FunctionBase {
    byte apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ByteFunction7.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G> ByteFunction7.Serializable<A, B, C, D, E, F, G> safelySerializable(
      Serializable<A, B, C, D, E, F, G> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G> extends ByteFunction7<A, B, C, D, E, F, G>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G> safelySerializable() {
      try {
        return new ByteMethodReference7<A, B, C, D, E, F, G>(this);
