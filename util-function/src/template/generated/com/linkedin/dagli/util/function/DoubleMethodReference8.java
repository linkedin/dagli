 ...
 */
class DoubleMethodReference8<A, B, C, D, E, F, G, H> implements DoubleFunction8.Serializable<A, B, C, D, E, F, G, H> {
  ...
  private static final int CLASS_HASH = DoubleMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  DoubleMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof DoubleMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference8) func)._methodReference;
    } else {
  ...
  private DoubleFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new DoubleMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction8.class), type, mh,
  ...
  public double apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference8) obj)._methodReference);
  }
