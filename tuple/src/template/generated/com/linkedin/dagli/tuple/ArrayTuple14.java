...
/**
 * A tuple of arity ArrayTuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> that is backed by an array.
 ...
 */
final class ArrayTuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> extends AbstractTuple implements
   ...
   */
  public ArrayTuple14(Object[] array) {
    assert array.length == 14;
    _array = array;
  }
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(14);
    System.arraycopy(_array, 0, result, 0, 14);
    return result;
  }
}
