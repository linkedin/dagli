...
@FunctionalInterface
public interface BooleanFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
  boolean apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10);
   ...
   */
  default BooleanFunction10<A, B, C, D, E, F, G, H, I, J> returnFalseOnNullArgument() {
    return new BooleanDefaultOnNullArgument10<>(this);
  }

  default BooleanFunction10<A, B, C, D, E, F, G, H, I, J> negate() {
    return BooleanNegatedFunction10.negate(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> BooleanFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
      Checked<A, B, C, D, E, F, G, H, I, J, ?> checkedFunction) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, D, E, F, G, H, I, J, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10)
        throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> BooleanFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends BooleanFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new BooleanMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H, I, J> returnFalseOnNullArgument() {
      return new BooleanDefaultOnNullArgument10<>(this);
    }

    @Override
    default Serializable<A, B, C, D, E, F, G, H, I, J> negate() {
      return BooleanNegatedFunction10.Serializable.negate(this);
    }
