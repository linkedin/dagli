...
/**
 * Trivial "preparer" that simply returns a provided, prepared transformer of arity 5.
 ...
 */
public class TrivialPreparer5<A, B, C, D, E, R, N extends PreparedTransformer5<A, B, C, D, E, R>> extends
    AbstractStreamPreparer5<A, B, C, D, E, R, N> {
   ...
   */
  public TrivialPreparer5(N prepared) {
  ...
  /**
     ...
     */
  public TrivialPreparer5(
      PreparedTransformer5<? super A, ? super B, ? super C, ? super D, ? super E, ? extends R> preparedForPreparationData,
