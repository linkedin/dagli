...
/**
 * A function class implementing {@link CharacterFunction8.Serializable} that composes
 * {@link CharacterFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class CharacterComposedFunction8<A, B, C, D, E, F, G, H, Q> implements
   ...
   *                as input
   */
  CharacterComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, CharacterFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public CharacterComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new CharacterComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CharacterComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof CharacterComposedFunction8) {
      return this._first.equals(((CharacterComposedFunction8) obj)._first)
          && this._andThen.equals(((CharacterComposedFunction8) obj)._andThen);
    }
    return false;
  }
