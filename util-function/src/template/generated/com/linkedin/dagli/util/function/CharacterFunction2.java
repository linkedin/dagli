...
@FunctionalInterface
public interface CharacterFunction2<A, B> extends FunctionBase {
  char apply(A value1, B value2);
   ...
   */
  default CharacterFunction2<A, B> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument2<>(this);
  }

  static <A, B> CharacterFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction2.Serializable should override this method
   ...
   */
  static <A, B> CharacterFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends CharacterFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new CharacterMethodReference2<A, B>(this);
