 ...
 */
class IntMethodReference2<A, B> implements IntFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction2<A, B> _cachedFunction = null;

  IntMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference2(Serializable<A, B> func) {
    if (func instanceof IntMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference2) func)._methodReference;
    } else {
  ...
  private IntFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference3<Object, A, B> unbound = new IntMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction2.class), type, mh,
  ...
  public int apply(A value1, B value2) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference2) obj)._methodReference);
  }
