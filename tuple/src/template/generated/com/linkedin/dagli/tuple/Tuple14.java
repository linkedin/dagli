...
/**
 * An ordered sequence of 14 elements.
 */
public interface Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> extends Tuple, TupleValue0<A>, TupleValue1<B>,
    TupleValue2<C>, TupleValue3<D>, TupleValue4<E>, TupleValue5<F>, TupleValue6<G>, TupleValue7<H>, TupleValue8<I>,
    TupleValue9<J>, TupleValue10<K>, TupleValue11<L>, TupleValue12<M>, TupleValue13<N> {
  /**
   ...
   */
  default <Z> Tuple14<Z, B, C, D, E, F, G, H, I, J, K, L, M, N> withValue0(Z value) {
   ...
   */
  default <Z> Tuple14<A, Z, C, D, E, F, G, H, I, J, K, L, M, N> withValue1(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, Z, D, E, F, G, H, I, J, K, L, M, N> withValue2(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, Z, E, F, G, H, I, J, K, L, M, N> withValue3(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, Z, F, G, H, I, J, K, L, M, N> withValue4(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, Z, G, H, I, J, K, L, M, N> withValue5(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, Z, H, I, J, K, L, M, N> withValue6(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, Z, I, J, K, L, M, N> withValue7(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, Z, J, K, L, M, N> withValue8(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, I, Z, K, L, M, N> withValue9(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, I, J, Z, L, M, N> withValue10(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, I, J, K, Z, M, N> withValue11(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, Z, N> withValue12(Z value) {
   ...
   */
  default <Z> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, Z> withValue13(Z value) {
  ...
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> of(A element0,
    ...
    return new FieldTuple14<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
   ...
   * should not be subsequently modified.  The array's length must be at least 14.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> fromArrayUnsafe(
      Object[] elements) {
    return new ArrayTuple14<>(elements);
  }

  /**
   * Creates a new tuple containing the first 14 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 14 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> fromIterableUnsafe(
      Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 14 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 14 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N> Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> fromIteratorUnsafe(
      Iterator<?> elements) {
    return new FieldTuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>((A) elements.next(), (B) elements.next(),
        ...
        (M) elements.next(), (N) elements.next());
  }
}
