 ...
 */
class IntMethodReference7<A, B, C, D, E, F, G> implements IntFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  IntMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof IntMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference7) func)._methodReference;
    } else {
  ...
  private IntFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference8<Object, A, B, C, D, E, F, G> unbound = new IntMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference7) obj)._methodReference);
  }
