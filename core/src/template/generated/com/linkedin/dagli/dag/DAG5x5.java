 ...
 *
 * DAG5x5 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x5 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>, DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>>
    implements
    PreparableDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>, DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>> {
   ...
   */
  DAG5x5(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>, DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>, DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>> {
    @Override
    ...
    @Override
    public DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> getInstance() {
      return DAG5x5.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE>>> getGraphReducers() {
   ...
   */
  public DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1,
   ...
   */
  public DAG4x5<B, C, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG4x5<A, C, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x5<A, B, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x5<A, B, C, E, RA, RB, RC, RD, RE> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x5<A, B, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RE> the type of the fifth result
   */
  private static class Preparer<A, B, C, D, E, RA, RB, RC, RD, RE>
      extends
      AbstractBatchPreparer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> {
    // the DAG being prepared
    private final DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> _dag;
     ...
     */
    Preparer(DAG5x5<A, B, C, D, E, RA, RB, RC, RD, RE> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA, RB, RC, RD, RE> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    DAGExecutionResult<Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>) res.getPreparerResult()
   ...
   */
  public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    return (DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RE> the type of the fifth result
   */
  public static final class Result<A, B, C, D, E, RA, RB, RC, RD, RE> extends AbstractDAGResult5<RA, RB, RC, RD, RE> {
    // the prepared DAG
    private final DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RE> the type of the fifth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>
      extends
      AbstractPreparedTransformer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>>
      implements PreparedDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer5<A, B, C, D, E, Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>> {
      @Override
      public DAGStructure<Tuple5<RA, RB, RC, RD, RE>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> getInstance() {
        return DAG5x5.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5) {
      return super.withAllInputs(input1, input2, input3, input4, input5);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG4x5.Prepared<B, C, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x5.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x5.Prepared<A, C, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x5.Prepared<A, B, D, E, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x5.Prepared<A, B, C, E, RA, RB, RC, RD, RE> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x5.Prepared<A, B, C, D, RA, RB, RC, RD, RE> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple5<RA, RB, RC, RD, RE> apply(A value1, B value2, C value3, D value4, E value5) {
      try (
