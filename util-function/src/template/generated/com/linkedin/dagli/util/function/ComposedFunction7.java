...
/**
 * A function class implementing {@link Function7.Serializable} that composes
 * {@link Function7} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ComposedFunction7<A, B, C, D, E, F, G, R, Q> implements Function7.Serializable<A, B, C, D, E, F, G, R> {
   ...
   *                as input
   */
  ComposedFunction7(Function7<A, B, C, D, E, F, G, Q> first, Function1<? super Q, ? extends R> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ComposedFunction7<A, B, C, D, E, F, G, R, Q> safelySerializable() {
    return new ComposedFunction7<>(((Function7.Serializable<A, B, C, D, E, F, G, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ComposedFunction7.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ComposedFunction7) {
      return this._first.equals(((ComposedFunction7) obj)._first)
          && this._andThen.equals(((ComposedFunction7) obj)._andThen);
    }
    return false;
  }
}
