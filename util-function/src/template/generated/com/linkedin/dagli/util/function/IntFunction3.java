...
@FunctionalInterface
public interface IntFunction3<A, B, C> extends FunctionBase {
  int apply(A value1, B value2, C value3);
   ...
   */
  default IntFunction3<A, B, C> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> IntFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> IntFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends IntFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new IntMethodReference3<A, B, C>(this);
