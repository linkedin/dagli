...
public abstract class AbstractPreparableTransformer7<A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>, S extends AbstractPreparableTransformer7<A, B, C, D, E, F, G, R, N, S>>
    extends
    AbstractTransformer7<A, B, C, D, E, F, G, R, PreparableTransformer7InternalAPI<A, B, C, D, E, F, G, R, N, S>, S>
    implements PreparableTransformer7<A, B, C, D, E, F, G, R, N> {
  ...
  @Override
  protected PreparableTransformer7InternalAPI<A, B, C, D, E, F, G, R, N, S> createInternalAPI() {
    return new InternalAPI();
  }

  protected class InternalAPI
      extends
      AbstractTransformer7<A, B, C, D, E, F, G, R, PreparableTransformer7InternalAPI<A, B, C, D, E, F, G, R, N, S>, S>.InternalAPI
      implements PreparableTransformer7InternalAPI<A, B, C, D, E, F, G, R, N, S> {
    @Override
    public Preparer7<A, B, C, D, E, F, G, R, N> getPreparer(PreparerContext context) {
      return AbstractPreparableTransformer7.this.getPreparer(context);
    }

    @Override
    public boolean hasIdempotentPreparer() {
      return AbstractPreparableTransformer7.this.hasIdempotentPreparer();
    }
  }

  protected abstract Preparer7<A, B, C, D, E, F, G, R, N> getPreparer(PreparerContext context);

  public AbstractPreparableTransformer7() {
    super();
  }

  public AbstractPreparableTransformer7(Producer<? extends A> input1, Producer<? extends B> input2,
