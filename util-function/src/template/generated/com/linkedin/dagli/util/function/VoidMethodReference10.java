 ...
 */
class VoidMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
  ...
  private static final int CLASS_HASH = VoidMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  VoidMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof VoidMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference10) func)._methodReference;
    } else {
  ...
  private VoidFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new VoidMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction10.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10) {
    _cachedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference10) obj)._methodReference);
  }
