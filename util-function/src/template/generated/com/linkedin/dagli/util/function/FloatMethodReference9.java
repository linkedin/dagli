 ...
 */
class FloatMethodReference9<A, B, C, D, E, F, G, H, I> implements
    FloatFunction9.Serializable<A, B, C, D, E, F, G, H, I>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  FloatMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof FloatMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference9) func)._methodReference;
    } else {
  ...
  private FloatFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new FloatMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference9) obj)._methodReference);
  }
