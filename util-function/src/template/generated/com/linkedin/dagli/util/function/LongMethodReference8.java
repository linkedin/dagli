 ...
 */
class LongMethodReference8<A, B, C, D, E, F, G, H> implements LongFunction8.Serializable<A, B, C, D, E, F, G, H>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  LongMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof LongMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference8) func)._methodReference;
    } else {
  ...
  private LongFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new LongMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference8) obj)._methodReference);
  }
