...
public abstract class AbstractPreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>, S extends AbstractPreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N, S>>
    extends
    AbstractTransformer9<A, B, C, D, E, F, G, H, I, R, PreparableTransformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, N, S>, S>
    implements PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N> {
  ...
  @Override
  protected PreparableTransformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, N, S> createInternalAPI() {
    return new InternalAPI();
  }

  protected class InternalAPI
      extends
      AbstractTransformer9<A, B, C, D, E, F, G, H, I, R, PreparableTransformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, N, S>, S>.InternalAPI
      implements PreparableTransformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, N, S> {
    @Override
    public Preparer9<A, B, C, D, E, F, G, H, I, R, N> getPreparer(PreparerContext context) {
      return AbstractPreparableTransformer9.this.getPreparer(context);
    }

    @Override
    public boolean hasIdempotentPreparer() {
      return AbstractPreparableTransformer9.this.hasIdempotentPreparer();
    }
  }

  protected abstract Preparer9<A, B, C, D, E, F, G, H, I, R, N> getPreparer(PreparerContext context);

  public AbstractPreparableTransformer9() {
    super();
  }

  public AbstractPreparableTransformer9(Producer<? extends A> input1, Producer<? extends B> input2,
