 ...
 */
abstract class AbstractDAGResult7<RA, RB, RC, RD, RE, RF, RG> extends
    WrappedObjectReader<Tuple7<RA, RB, RC, RD, RE, RF, RG>> implements DAGResult7<RA, RB, RC, RD, RE, RF, RG>,
    AutoCloseable {
   ...
   *
   * @param results an array of length 7 providing an {@link ObjectReader} for each of the DAG's outputs.
   */
  @SuppressWarnings("unchecked")
  AbstractDAGResult7(ObjectReader<?>[] results) {
   ...
   */
  AbstractDAGResult7(ObjectReader<RA> results1, ObjectReader<RB> results2, ObjectReader<RC> results3,
      ObjectReader<RD> results4, ObjectReader<RE> results5, ObjectReader<RF> results6, ObjectReader<RG> results7) {
    super(new TupleReader<>(results1, results2, results3, results4, results5, results6, results7));
