 ...
 */
class BooleanMethodReference7<A, B, C, D, E, F, G> implements BooleanFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = BooleanMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  BooleanMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof BooleanMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference7) func)._methodReference;
    } else {
  ...
  private BooleanFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference8<Object, A, B, C, D, E, F, G> unbound =
          new BooleanMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference7) obj)._methodReference);
  }
