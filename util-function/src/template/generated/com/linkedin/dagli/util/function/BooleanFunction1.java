...
public interface BooleanFunction1<A> extends FunctionBase, Predicate<A> {
  ...
  @Override
  default boolean test(A value1) {
    return apply(value1);
  }

  static <A> BooleanFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
  ...
  interface Checked<A, X extends Throwable> extends FunctionBase {
    boolean apply(A value1) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction1.Serializable should override this method
   ...
   */
  static <A> BooleanFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends BooleanFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new BooleanMethodReference1<A>(this);
    ...
    default Serializable<A> negate() {
      return BooleanNegatedFunction1.Serializable.negate(this);
    }
