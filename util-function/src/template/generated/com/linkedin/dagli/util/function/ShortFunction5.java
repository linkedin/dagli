...
@FunctionalInterface
public interface ShortFunction5<A, B, C, D, E> extends FunctionBase {
  short apply(A value1, B value2, C value3, D value4, E value5);
   ...
   */
  default ShortFunction5<A, B, C, D, E> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument5<>(this);
  }

  static <A, B, C, D, E> ShortFunction5<A, B, C, D, E> unchecked(Checked<A, B, C, D, E, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, X extends Throwable> extends FunctionBase {
    short apply(A value1, B value2, C value3, D value4, E value5) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ShortFunction5.Serializable should override this method
   ...
   */
  static <A, B, C, D, E> ShortFunction5.Serializable<A, B, C, D, E> safelySerializable(
      Serializable<A, B, C, D, E> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E> extends ShortFunction5<A, B, C, D, E>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E> safelySerializable() {
      try {
        return new ShortMethodReference5<A, B, C, D, E>(this);
