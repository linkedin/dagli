...
class BooleanMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
  ...
  private static final int CLASS_HASH = BooleanMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  BooleanMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof BooleanMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference10) func)._methodReference;
    } else {
  ...
  private BooleanFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new BooleanMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference10) obj)._methodReference);
  }
