...
@FunctionalInterface
public interface DoubleFunction4<A, B, C, D> extends FunctionBase {
  double apply(A value1, B value2, C value3, D value4);
   ...
   */
  default DoubleFunction4<A, B, C, D> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument4<>(this);
  }

  static <A, B, C, D> DoubleFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    double apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> DoubleFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends DoubleFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new DoubleMethodReference4<A, B, C, D>(this);
