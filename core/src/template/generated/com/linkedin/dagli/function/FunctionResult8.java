 ...
 */
@ValueEquality
public class FunctionResult8<A, B, C, D, E, F, G, H, R> extends
    AbstractPreparedTransformer8<A, B, C, D, E, F, G, H, R, FunctionResult8<A, B, C, D, E, F, G, H, R>> {
  private static final long serialVersionUID = 1;

  private Function8.Serializable<A, B, C, D, E, F, G, H, R> _originalFunction = null;
  @IgnoredByValueEquality
  private Function8.Serializable<A, B, C, D, E, F, G, H, R> _function = null;
   ...
   *        withFunctionUnsafe(...).
   */
  public FunctionResult8(Function8.Serializable<A, B, C, D, E, F, G, H, R> func) {
    this();
   ...
   */
  private void setFunction(Function8.Serializable<A, B, C, D, E, F, G, H, R> func) {
   ...
   */
  public FunctionResult8<A, B, C, D, E, F, G, H, R> withNullResultOnNullInput() {
    return clone(c -> {
  ...
  public FunctionResult8<A, B, C, D, E, F, G, H, R> withInputs(Producer<? extends A> input1,
   ...
   *        withFunctionUnsafe(...).
   */
  public FunctionResult8<A, B, C, D, E, F, G, H, R> withFunction(Function8.Serializable<A, B, C, D, E, F, G, H, R> func) {
   ...
   */
  public FunctionResult8<A, B, C, D, E, F, G, H, R> withFunctionUnsafe(
      Function8.Serializable<A, B, C, D, E, F, G, H, R> func) {
    return clone(c -> {
      try {
  ...
  @Override
  public R apply(A input1, B input2, C input3, D input4, E input5, F input6, G input7, H input8) {
    return _function.apply(input1, input2, input3, input4, input5, input6, input7, input8);
  }

  /**
   * Returns a new {@link FunctionResult8} that composes this instance's function with another "mapper" function such
   ...
   * @return a new {@link FunctionResult8} that composes this instance's function with another "mapper" function
   */
  @SuppressWarnings("unchecked")
  public <Q> FunctionResult8<A, B, C, D, E, F, G, H, Q> andThen(Function1.Serializable<? super R, ? extends Q> mapper) {
    return (FunctionResult8<A, B, C, D, E, F, G, H, Q>) clone(c -> ((FunctionResult8<A, B, C, D, E, F, G, H, Q>) c)
