...
@FunctionalInterface
public interface ShortFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default ShortFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> ShortFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement ShortFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> ShortFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends ShortFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new ShortMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
