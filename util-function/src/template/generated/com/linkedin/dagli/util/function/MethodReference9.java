 ...
 */
class MethodReference9<A, B, C, D, E, F, G, H, I, R> implements Function9.Serializable<A, B, C, D, E, F, G, H, I, R> {
  ...
  private static final int CLASS_HASH = MethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function9<A, B, C, D, E, F, G, H, I, R> _cachedFunction = null;

  MethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference9(Serializable<A, B, C, D, E, F, G, H, I, R> func) {
    if (func instanceof MethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference9) func)._methodReference;
    } else {
  ...
  private Function9<A, B, C, D, E, F, G, H, I, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference10<Object, A, B, C, D, E, F, G, H, I, R> unbound =
          new MethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function9<A, B, C, D, E, F, G, H, I, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference9)) {
      return false;
    }

    return _methodReference.equals(((MethodReference9) obj)._methodReference);
  }
