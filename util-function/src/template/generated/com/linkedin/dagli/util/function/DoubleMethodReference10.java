 ...
 */
class DoubleMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
  ...
  private static final int CLASS_HASH = DoubleMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  DoubleMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof DoubleMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference10) func)._methodReference;
    } else {
  ...
  private DoubleFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new DoubleMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference10) obj)._methodReference);
  }
