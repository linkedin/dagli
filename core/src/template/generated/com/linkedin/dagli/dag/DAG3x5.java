 ...
 *
 * DAG3x5 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x5 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x5<A, B, C, RA, RB, RC, RD, RE>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>, DAG3x5<A, B, C, RA, RB, RC, RD, RE>>
    implements
    PreparableDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>, DAG3x5<A, B, C, RA, RB, RC, RD, RE>> {
   ...
   */
  DAG3x5(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG3x5<A, B, C, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>, DAG3x5<A, B, C, RA, RB, RC, RD, RE>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>, DAG3x5<A, B, C, RA, RB, RC, RD, RE>> {
    @Override
    ...
    @Override
    public DAG3x5<A, B, C, RA, RB, RC, RD, RE> getInstance() {
      return DAG3x5.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x5<A, B, C, RA, RB, RC, RD, RE>>> getGraphReducers() {
   ...
   */
  public DAG3x5<A, B, C, RA, RB, RC, RD, RE> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x5<A, B, C, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3) {
   ...
   */
  public DAG2x5<B, C, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x5<A, B, C, RA, RB, RC, RD, RE> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x5<A, C, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG3x5<A, B, C, RA, RB, RC, RD, RE> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x5<A, B, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x5<A, B, C, RA, RB, RC, RD, RE> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
   ...
   * @param <RE> the type of the fifth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE> extends
      AbstractBatchPreparer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> {
    // the DAG being prepared
    private final DAG3x5<A, B, C, RA, RB, RC, RD, RE> _dag;
     ...
     */
    Preparer(DAG3x5<A, B, C, RA, RB, RC, RD, RE> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> res =
    ...
    return new Result<>((DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>) res.getPreparerResult()
   ...
   */
  public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RE> the type of the fifth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE> extends AbstractDAGResult5<RA, RB, RC, RD, RE> {
    // the prepared DAG
    private final DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RE> the type of the fifth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE> extends
      AbstractPreparedTransformer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>>
      implements PreparedDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>> {
      @Override
      public DAGStructure<Tuple5<RA, RB, RC, RD, RE>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> getInstance() {
        return DAG3x5.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG2x5.Prepared<B, C, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG2x5.Prepared<A, C, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x5.Prepared<A, B, C, RA, RB, RC, RD, RE> dag =
    ...
    public Result<RA, RB, RC, RD, RE> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
      ...
      return new Result<RA, RB, RC, RD, RE>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) }));
    }

    @Override
    public Tuple5<RA, RB, RC, RD, RE> apply(A value1, B value2, C value3) {
      try (
