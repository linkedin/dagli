...
public interface ByteFunction1<A> extends FunctionBase {
  ...
  static <A> ByteFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement ByteFunction1.Serializable should override this method
   ...
   */
  static <A> ByteFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends ByteFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new ByteMethodReference1<A>(this);
