 ...
 */
class CharacterMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
    CharacterFunction11.Serializable<A, B, C, D, E, F, G, H, I, J, K>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;

  CharacterMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof CharacterMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference11) func)._methodReference;
    } else {
  ...
  private CharacterFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(char.class);
      return (CharacterFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction11.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference11)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference11) obj)._methodReference);
  }
