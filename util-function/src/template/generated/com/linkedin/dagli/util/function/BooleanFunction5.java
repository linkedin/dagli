...
public interface BooleanFunction5<A, B, C, D, E> extends FunctionBase {
  boolean apply(A value1, B value2, C value3, D value4, E value5);
  ...
  static <A, B, C, D, E> BooleanFunction5<A, B, C, D, E> unchecked(Checked<A, B, C, D, E, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3, D value4, E value5) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction5.Serializable should override this method
   ...
   */
  static <A, B, C, D, E> BooleanFunction5.Serializable<A, B, C, D, E> safelySerializable(
      Serializable<A, B, C, D, E> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E> extends BooleanFunction5<A, B, C, D, E>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E> safelySerializable() {
      try {
        return new BooleanMethodReference5<A, B, C, D, E>(this);
    ...
    default Serializable<A, B, C, D, E> negate() {
      return BooleanNegatedFunction5.Serializable.negate(this);
    }
