 ...
 */
class DoubleMethodReference0 implements DoubleFunction0.Serializable, Named {
  ...
  DoubleMethodReference0(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference0(Serializable func) {
    if (func instanceof DoubleMethodReference0) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference0) func)._methodReference;
    } else {
  ...
  private DoubleFunction0 fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference1<Object> unbound = new DoubleMethodReference1<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction0) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction0.class), type, mh,
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((DoubleMethodReference0) obj)._methodReference);
  }
