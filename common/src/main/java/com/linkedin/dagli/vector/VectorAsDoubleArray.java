 ...
 */
@ValueEquality
public class VectorAsDoubleArray extends AbstractPreparedTransformer2<Vector, Long, double[], VectorAsDoubleArray> {
  ...
  public VectorAsDoubleArray withInput(Producer<? extends Vector> vectorInput) {
    return clone(c -> {
   ...
   * the configured minimum and maximum result array lengths to accomodate the actual elements of the input vectors.
   *
   * @return a copy of this instance that will produce arrays of uniform length
   */
  public VectorAsDoubleArray withConsistentArrayLength() {
    return clone(c -> {
   ...
   */
  public VectorAsDoubleArray withIgnoredOutOfBoundsIndices() {
   ...
   */
  public VectorAsDoubleArray withMinimumArrayLength(int minArrayLength) {
   ...
   */
  public VectorAsDoubleArray withMaximumArrayLength(int maxArrayLength) {
