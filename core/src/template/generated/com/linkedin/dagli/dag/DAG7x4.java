 ...
 *
 * DAG7x4 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG7x4 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>
    extends
    AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>, DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>>
    implements
    PreparableDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>, DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>> {
   ...
   */
  DAG7x4(DAGStructure<Tuple4<RA, RB, RC, RD>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>, DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>, DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>> {
    @Override
    ...
    @Override
    public DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> getInstance() {
      return DAG7x4.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD>>> getGraphReducers() {
   ...
   */
  public DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> withInputs(Producer<? extends A> input1,
   ...
   */
  public DAG6x4<B, C, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, C, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, B, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, B, C, E, F, G, RA, RB, RC, RD> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, B, C, D, F, G, RA, RB, RC, RD> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, B, C, D, E, G, RA, RB, RC, RD> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG6x4<A, B, C, D, E, F, RA, RB, RC, RD> withGeneratorAsInput7(Generator<G> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RD> the type of the fourth result
   */
  private static class Preparer<A, B, C, D, E, F, G, RA, RB, RC, RD>
      extends
      AbstractBatchPreparer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> {
    // the DAG being prepared
    private final DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> _dag;
     ...
     */
    Preparer(DAG7x4<A, B, C, D, E, F, G, RA, RB, RC, RD> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> finish(
  ...
  @Override
  protected Preparer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, G, RA, RB, RC, RD> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>) res.getPreparerResult()
   ...
   */
  public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6, Iterable<? extends G> values7) {
    return (DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RD> the type of the fourth result
   */
  public static final class Result<A, B, C, D, E, F, G, RA, RB, RC, RD> extends AbstractDAGResult4<RA, RB, RC, RD> {
    // the prepared DAG
    private final DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RD> the type of the fourth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>
      extends
      AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>>
      implements PreparedDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> {
    ...
    * @param input7 the {@link Producer} providing the seventh input to the transformer
     ...
     */
    @Override
    public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer7<A, B, C, D, E, F, G, Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>> {
      @Override
      public DAGStructure<Tuple4<RA, RB, RC, RD>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> getInstance() {
        return DAG7x4.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5, Producer<? extends F> input6, Producer<? extends G> input7) {
      return super.withAllInputs(input1, input2, input3, input4, input5, input6, input7);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<B, C, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      Placeholder<G> nestedPlaceholder7 = new Placeholder<>("Original Input 7");
      DAG7x4.Prepared<A, B, C, D, E, F, G, RA, RB, RC, RD> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6, nestedPlaceholder7);
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, C, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, B, D, E, F, G, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, B, C, E, F, G, RA, RB, RC, RD> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, B, C, D, F, G, RA, RB, RC, RD> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, B, C, D, E, G, RA, RB, RC, RD> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG6x4.Prepared<A, B, C, D, E, F, RA, RB, RC, RD> withGeneratorAsInput7(Generator<G> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple4<RA, RB, RC, RD> apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) {
      try (
