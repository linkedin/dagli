...
public abstract class AbstractPreparableTransformer1<A, R, N extends PreparedTransformer1<A, R>, S extends AbstractPreparableTransformer1<A, R, N, S>>
    extends AbstractTransformer1<A, R, PreparableTransformer1InternalAPI<A, R, N, S>, S> implements
    PreparableTransformer1<A, R, N> {
  ...
  @Override
  protected PreparableTransformer1InternalAPI<A, R, N, S> createInternalAPI() {
    return new InternalAPI();
  }

  protected class InternalAPI extends
      AbstractTransformer1<A, R, PreparableTransformer1InternalAPI<A, R, N, S>, S>.InternalAPI implements
      PreparableTransformer1InternalAPI<A, R, N, S> {
    @Override
    public Preparer1<A, R, N> getPreparer(PreparerContext context) {
      return AbstractPreparableTransformer1.this.getPreparer(context);
    }

    @Override
    public boolean hasIdempotentPreparer() {
      return AbstractPreparableTransformer1.this.hasIdempotentPreparer();
    }
  }

  protected abstract Preparer1<A, R, N> getPreparer(PreparerContext context);

  public AbstractPreparableTransformer1() {
    super();
  }

  public AbstractPreparableTransformer1(Producer<? extends A> input1) {
    super(input1);
  }
}
