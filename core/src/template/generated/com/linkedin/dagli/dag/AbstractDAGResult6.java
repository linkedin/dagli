 ...
 */
abstract class AbstractDAGResult6<RA, RB, RC, RD, RE, RF> extends WrappedObjectReader<Tuple6<RA, RB, RC, RD, RE, RF>>
    implements DAGResult6<RA, RB, RC, RD, RE, RF>, AutoCloseable {
   ...
   *
   * @param results an array of length 6 providing an {@link ObjectReader} for each of the DAG's outputs.
   */
  @SuppressWarnings("unchecked")
  AbstractDAGResult6(ObjectReader<?>[] results) {
   ...
   */
  AbstractDAGResult6(ObjectReader<RA> results1, ObjectReader<RB> results2, ObjectReader<RC> results3,
      ObjectReader<RD> results4, ObjectReader<RE> results5, ObjectReader<RF> results6) {
    super(new TupleReader<>(results1, results2, results3, results4, results5, results6));
