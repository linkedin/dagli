...
public interface IntFunction2<A, B> extends FunctionBase, ToIntBiFunction<A, B> {
  ...
  @Override
  default int applyAsInt(A value1, B value2) {
    return apply(value1, value2);
  }

  static <A, B> IntFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction2.Serializable should override this method
   ...
   */
  static <A, B> IntFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends IntFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new IntMethodReference2<A, B>(this);
