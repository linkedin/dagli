...
@FunctionalInterface
interface VoidFunction11<A, B, C, D, E, F, G, H, I, J, K> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10,
      K value11);
   ...
   */
  default VoidFunction11<A, B, C, D, E, F, G, H, I, J, K> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument11<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J, K> VoidFunction11<A, B, C, D, E, F, G, H, I, J, K> unchecked(
      Checked<A, B, C, D, E, F, G, H, I, J, K, ?> checkedFunction) {
    return (A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10,
        K value11) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11);
      } catch (Throwable e) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, D, E, F, G, H, I, J, K, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10,
        K value11) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction11.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J, K> VoidFunction11.Serializable<A, B, C, D, E, F, G, H, I, J, K> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J, K> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J, K> extends VoidFunction11<A, B, C, D, E, F, G, H, I, J, K>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J, K> safelySerializable() {
      try {
        return new VoidMethodReference11<A, B, C, D, E, F, G, H, I, J, K>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H, I, J, K> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument11<>(this);
    }
