 ...
 *
 * DAG3x4 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x4 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x4<A, B, C, RA, RB, RC, RD>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>, DAG3x4<A, B, C, RA, RB, RC, RD>>
    implements
    PreparableDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>, DAG3x4<A, B, C, RA, RB, RC, RD>> {
   ...
   */
  DAG3x4(DAGStructure<Tuple4<RA, RB, RC, RD>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG3x4<A, B, C, RA, RB, RC, RD> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>, DAG3x4<A, B, C, RA, RB, RC, RD>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>, DAG3x4<A, B, C, RA, RB, RC, RD>> {
    @Override
    ...
    @Override
    public DAG3x4<A, B, C, RA, RB, RC, RD> getInstance() {
      return DAG3x4.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x4<A, B, C, RA, RB, RC, RD>>> getGraphReducers() {
   ...
   */
  public DAG3x4<A, B, C, RA, RB, RC, RD> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x4<A, B, C, RA, RB, RC, RD> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3) {
   ...
   */
  public DAG2x4<B, C, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x4<A, B, C, RA, RB, RC, RD> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput2(), getInput3());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG2x4<A, C, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG3x4<A, B, C, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder3)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput3());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG2x4<A, B, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x4<A, B, C, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput2());
  }
   ...
   * @param <RD> the type of the fourth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD> extends
      AbstractBatchPreparer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> {
    // the DAG being prepared
    private final DAG3x4<A, B, C, RA, RB, RC, RD> _dag;
     ...
     */
    Preparer(DAG3x4<A, B, C, RA, RB, RC, RD> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple4<RA, RB, RC, RD>>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> res =
    ...
    return new Result<>((DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>) res.getPreparerResult()
   ...
   */
  public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3) {
    return (DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RD> the type of the fourth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD> extends AbstractDAGResult4<RA, RB, RC, RD> {
    // the prepared DAG
    private final DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RD> the type of the fourth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD> extends
      AbstractPreparedTransformer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> implements
      PreparedDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>> {
      @Override
      public DAGStructure<Tuple4<RA, RB, RC, RD>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> getInstance() {
        return DAG3x4.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x4.Prepared<A, B, C, RA, RB, RC, RD>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG2x4.Prepared<B, C, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x4.Prepared<A, C, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x4.Prepared<A, B, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    public Result<RA, RB, RC, RD> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
        Iterable<? extends C> values3) {
      return new Result<RA, RB, RC, RD>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) }));
    }

    @Override
    public Tuple4<RA, RB, RC, RD> apply(A value1, B value2, C value3) {
      try (
