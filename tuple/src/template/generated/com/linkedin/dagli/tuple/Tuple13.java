...
/**
 * An ordered sequence of 13 elements.
 */
public interface Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> extends Tuple, TupleValue0<A>, TupleValue1<B>,
    TupleValue2<C>, TupleValue3<D>, TupleValue4<E>, TupleValue5<F>, TupleValue6<G>, TupleValue7<H>, TupleValue8<I>,
    TupleValue9<J>, TupleValue10<K>, TupleValue11<L>, TupleValue12<M> {
  /**
   ...
   */
  default <Z> Tuple13<Z, B, C, D, E, F, G, H, I, J, K, L, M> withValue0(Z value) {
   ...
   */
  default <Z> Tuple13<A, Z, C, D, E, F, G, H, I, J, K, L, M> withValue1(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, Z, D, E, F, G, H, I, J, K, L, M> withValue2(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, Z, E, F, G, H, I, J, K, L, M> withValue3(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, Z, F, G, H, I, J, K, L, M> withValue4(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, Z, G, H, I, J, K, L, M> withValue5(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, Z, H, I, J, K, L, M> withValue6(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, Z, I, J, K, L, M> withValue7(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, H, Z, J, K, L, M> withValue8(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, H, I, Z, K, L, M> withValue9(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, H, I, J, Z, L, M> withValue10(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, H, I, J, K, Z, M> withValue11(Z value) {
   ...
   */
  default <Z> Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, Z> withValue12(Z value) {
  ...
  static <A, B, C, D, E, F, G, H, I, J, K, L, M> Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> of(A element0,
    ...
    return new FieldTuple13<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
   ...
   * should not be subsequently modified.  The array's length must be at least 13.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M> Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> fromArrayUnsafe(
      Object[] elements) {
    return new ArrayTuple13<>(elements);
  }

  /**
   * Creates a new tuple containing the first 13 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 13 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M> Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> fromIterableUnsafe(
      Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 13 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 13 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J, K, L, M> Tuple13<A, B, C, D, E, F, G, H, I, J, K, L, M> fromIteratorUnsafe(
      Iterator<?> elements) {
    return new FieldTuple13<A, B, C, D, E, F, G, H, I, J, K, L, M>((A) elements.next(), (B) elements.next(),
