 ...
 */
class ByteMethodReference1<A> implements ByteFunction1.Serializable<A>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction1<A> _cachedFunction = null;

  ByteMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference1(Serializable<A> func) {
    if (func instanceof ByteMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference1) func)._methodReference;
    } else {
  ...
  private ByteFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference2<Object, A> unbound = new ByteMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference1)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference1) obj)._methodReference);
  }
