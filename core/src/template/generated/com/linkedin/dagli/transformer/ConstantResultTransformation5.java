 ...
 */
@ValueEquality
public final class ConstantResultTransformation5<A, B, C, D, E, R>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, R, ConstantResultTransformation5.Prepared<A, B, C, D, E, R>, ConstantResultTransformation5<A, B, C, D, E, R>>
    implements ConstantResultTransformation<R, ConstantResultTransformation5<A, B, C, D, E, R>> {
   ...
   */
  public ConstantResultTransformation5() {
  }
   ...
   */
  public ConstantResultTransformation5<A, B, C, D, E, R> withResult(R result) {
    return clone(c -> {
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation5<A, B, C, D, E, R> withResultForPreparationData(R result) {
    return clone(c -> {
      c._resultForPreparationData = result;
    });
  }
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation5<A, B, C, D, E, R> withResultForNewData(R result) {
    return clone(c -> {
      c._resultForNewData = result;
    });
  }
  ...
  @Override
  protected Preparer5<A, B, C, D, E, R, ConstantResultTransformation5.Prepared<A, B, C, D, E, R>> getPreparer(
      PreparerContext context) {
    ConstantResultTransformation5.Prepared<A, B, C, D, E, R> resultForPrepData =
        new ConstantResultTransformation5.Prepared<A, B, C, D, E, R>(_resultForPreparationData);
    return _resultForPreparationData == _resultForNewData ? new TrivialPreparer5<>(resultForPrepData)
        : new TrivialPreparer5<>(resultForPrepData, new ConstantResultTransformation5.Prepared<A, B, C, D, E, R>(
            _resultForNewData));
  }

  @Override
  public ConstantResultTransformation5<A, B, C, D, E, R> withInput1(Producer<? extends A> inputA) {
    return super.withInput1(inputA);
  }

  @Override
  public ConstantResultTransformation5<A, B, C, D, E, R> withInput2(Producer<? extends B> inputB) {
    return super.withInput2(inputB);
  }

  @Override
  public ConstantResultTransformation5<A, B, C, D, E, R> withInput3(Producer<? extends C> inputC) {
    return super.withInput3(inputC);
  }

  @Override
  public ConstantResultTransformation5<A, B, C, D, E, R> withInput4(Producer<? extends D> inputD) {
    return super.withInput4(inputD);
  }

  @Override
  public ConstantResultTransformation5<A, B, C, D, E, R> withInput5(Producer<? extends E> inputE) {
    return super.withInput5(inputE);
  }

  @Override
  public String getName() {
    return "ConstantResultTransformation5("
  ...
  * @param <E> the type of the fifth input
   ...
   */
  @ValueEquality
  public static final class Prepared<A, B, C, D, E, R> extends
      AbstractPreparedTransformer5<A, B, C, D, E, R, ConstantResultTransformation5.Prepared<A, B, C, D, E, R>>
      implements ConstantResultTransformation.Prepared<R, ConstantResultTransformation5.Prepared<A, B, C, D, E, R>> {
    private static final long serialVersionUID = 1;
     ...
     * @return a copy of this transformer that will always have the specified constant result
     */
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withResult(R result) {
    ...
    @Override
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withInput1(Producer<? extends A> inputA) {
      return super.withInput1(inputA);
    }

    @Override
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withInput2(Producer<? extends B> inputB) {
      return super.withInput2(inputB);
    }

    @Override
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withInput3(Producer<? extends C> inputC) {
      return super.withInput3(inputC);
    }

    @Override
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withInput4(Producer<? extends D> inputD) {
      return super.withInput4(inputD);
    }

    @Override
    public ConstantResultTransformation5.Prepared<A, B, C, D, E, R> withInput5(Producer<? extends E> inputE) {
      return super.withInput5(inputE);
    }

    @Override
    public String getName() {
      return "ConstantResultTransformation5.Prepared(" + _result + ")";
    }
  }
}
