 ...
 *
 * DAG2x9 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG2x9 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>
    extends
    AbstractPreparableTransformer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
    implements
    PreparableDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
   ...
   */
  DAG2x9(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    @Override
    ...
    @Override
    public DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
      return DAG2x9.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
   ...
   */
  public DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2) {
   ...
   */
  public DAG1x9<B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag = this.withInputs(generator, nestedPlaceholder2);
   ...
   *         the produced by the provided generator
   */
  public DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag = this.withInputs(nestedPlaceholder1, generator);
   ...
   * @param <RI> the type of the ninth result
   */
  private static class Preparer<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractBatchPreparer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    // the DAG being prepared
    private final DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> _dag;
     ...
     */
    Preparer(DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> finish(
  ...
  @Override
  protected Preparer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    DAGExecutionResult<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) });
    return new Result<>((DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>) res.getPreparerResult()
   ...
   */
  public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    return (DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>) _executor.internalAPI()
  ...
  * @param <RI> the type of the ninth result
   */
  public static final class Result<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
      AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
    // the prepared DAG
    private final DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RI> the type of the ninth result
   */
  @ValueEquality
  public static class Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractPreparedTransformer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
      implements
      PreparedDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    ...
    * @param input2 the {@link Producer} providing the second input to the transformer
     ...
     */
    @Override
    public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer2<A, B, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
      @Override
      public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
        return DAG2x9.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2) {
      return super.withAllInputs(input1, input2);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG1x9.Prepared<B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag = this.withInputs(generator, nestedPlaceholder2);
      ...
      return DAG.Prepared
          ...
          .withExecutor(_executor).withInput(getInput2());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag = this.withInputs(nestedPlaceholder1, generator);
      ...
      return DAG.Prepared
          ...
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
              new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
              new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
          .withExecutor(_executor).withInput(getInput1());
    }
    ...
    public Result<RA, RB, RC, RD, RE, RF, RG, RH, RI> applyAll(Iterable<? extends A> values1,
        Iterable<? extends B> values2) {
      return new Result<RA, RB, RC, RD, RE, RF, RG, RH, RI>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) }));
    }

    @Override
    public Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI> apply(A value1, B value2) {
      try (
