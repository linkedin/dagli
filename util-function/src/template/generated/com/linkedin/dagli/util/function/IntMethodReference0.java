 ...
 */
class IntMethodReference0 implements IntFunction0.Serializable, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference0.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction0 _cachedFunction = null;

  IntMethodReference0(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference0(Serializable func) {
    if (func instanceof IntMethodReference0) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference0) func)._methodReference;
    } else {
  ...
  private IntFunction0 fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference1<Object> unbound = new IntMethodReference1<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction0) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction0.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference0)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference0) obj)._methodReference);
  }
