 ...
 */
class LongMethodReference6<A, B, C, D, E, F> implements LongFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction6<A, B, C, D, E, F> _cachedFunction = null;

  LongMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof LongMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference6) func)._methodReference;
    } else {
  ...
  private LongFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference7<Object, A, B, C, D, E, F> unbound = new LongMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference6) obj)._methodReference);
  }
