 ...
 */
class VoidMethodReference1<A> implements VoidFunction1.Serializable<A>, Named {
  ...
  VoidMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference1(Serializable<A> func) {
    if (func instanceof VoidMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference1) func)._methodReference;
    } else {
  ...
  private VoidFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference2<Object, A> unbound = new VoidMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((VoidMethodReference1) obj)._methodReference);
  }
