...
public interface IntFunction4<A, B, C, D> extends FunctionBase {
  int apply(A value1, B value2, C value3, D value4);
  ...
  static <A, B, C, D> IntFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> IntFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends IntFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new IntMethodReference4<A, B, C, D>(this);
