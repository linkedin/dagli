 ...
 */
class IntMethodReference3<A, B, C> implements IntFunction3.Serializable<A, B, C>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference3.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction3<A, B, C> _cachedFunction = null;

  IntMethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference3(Serializable<A, B, C> func) {
    if (func instanceof IntMethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference3) func)._methodReference;
    } else {
  ...
  private IntFunction3<A, B, C> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference4<Object, A, B, C> unbound = new IntMethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction3<A, B, C>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction3.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference3)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference3) obj)._methodReference);
  }
