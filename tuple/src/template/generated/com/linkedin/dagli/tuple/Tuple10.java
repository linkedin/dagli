...
/**
 * An ordered sequence of 10 elements.
 */
public interface Tuple10<A, B, C, D, E, F, G, H, I, J> extends Tuple, TupleValue0<A>, TupleValue1<B>, TupleValue2<C>,
    TupleValue3<D>, TupleValue4<E>, TupleValue5<F>, TupleValue6<G>, TupleValue7<H>, TupleValue8<I>, TupleValue9<J> {
  /**
   ...
   */
  default <Z> Tuple10<Z, B, C, D, E, F, G, H, I, J> withValue0(Z value) {
    return of(value, get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, Z, C, D, E, F, G, H, I, J> withValue1(Z value) {
    return of(get0(), value, get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, Z, D, E, F, G, H, I, J> withValue2(Z value) {
    return of(get0(), get1(), value, get3(), get4(), get5(), get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, Z, E, F, G, H, I, J> withValue3(Z value) {
    return of(get0(), get1(), get2(), value, get4(), get5(), get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, Z, F, G, H, I, J> withValue4(Z value) {
    return of(get0(), get1(), get2(), get3(), value, get5(), get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, E, Z, G, H, I, J> withValue5(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), value, get6(), get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, E, F, Z, H, I, J> withValue6(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), value, get7(), get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, E, F, G, Z, I, J> withValue7(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), value, get8(), get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, E, F, G, H, Z, J> withValue8(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), value, get9());
  }
   ...
   */
  default <Z> Tuple10<A, B, C, D, E, F, G, H, I, Z> withValue9(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), value);
  }
  ...
  static <A, B, C, D, E, F, G, H, I, J> Tuple10<A, B, C, D, E, F, G, H, I, J> of(A element0, B element1, C element2,
    ...
    return new FieldTuple10<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
        element9);
  }

  /**
   * Creates a new tuple that contains the given elements.  The tuple takes ownership of the provided array, which
   * should not be subsequently modified.  The array's length must be at least 10.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J> Tuple10<A, B, C, D, E, F, G, H, I, J> fromArrayUnsafe(Object[] elements) {
    return new ArrayTuple10<>(elements);
  }

  /**
   * Creates a new tuple containing the first 10 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 10 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J> Tuple10<A, B, C, D, E, F, G, H, I, J> fromIterableUnsafe(Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 10 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 10 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J> Tuple10<A, B, C, D, E, F, G, H, I, J> fromIteratorUnsafe(Iterator<?> elements) {
    return new FieldTuple10<A, B, C, D, E, F, G, H, I, J>((A) elements.next(), (B) elements.next(),
        (C) elements.next(), (D) elements.next(), (E) elements.next(), (F) elements.next(), (G) elements.next(),
        (H) elements.next(), (I) elements.next(), (J) elements.next());
  }
}
