...
/**
 * A function class implementing {@link Function4.Serializable} that composes
 * {@link Function4} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ComposedFunction4<A, B, C, D, R, Q> implements Function4.Serializable<A, B, C, D, R>, Named {
   ...
   *                as input
   */
  ComposedFunction4(Function4<A, B, C, D, Q> first, Function1<? super Q, ? extends R> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ComposedFunction4<A, B, C, D, R, Q> safelySerializable() {
    return new ComposedFunction4<>(((Function4.Serializable<A, B, C, D, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ComposedFunction4.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ComposedFunction4) {
      return this._first.equals(((ComposedFunction4) obj)._first)
          && this._andThen.equals(((ComposedFunction4) obj)._andThen);
    }
    return false;
  }
