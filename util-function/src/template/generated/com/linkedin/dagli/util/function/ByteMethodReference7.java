 ...
 */
class ByteMethodReference7<A, B, C, D, E, F, G> implements ByteFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  ByteMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof ByteMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference7) func)._methodReference;
    } else {
  ...
  private ByteFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference8<Object, A, B, C, D, E, F, G> unbound = new ByteMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference7) obj)._methodReference);
  }
