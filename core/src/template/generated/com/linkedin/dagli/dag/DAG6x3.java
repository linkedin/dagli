 ...
 *
 * DAG6x3 is a <i>preparable</i> DAG.
 *
 ...
 */
@ValueEquality
public class DAG6x3<A, B, C, D, E, F, RA, RB, RC>
    extends
    AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>, DAG6x3<A, B, C, D, E, F, RA, RB, RC>>
    implements
    PreparableDAGTransformer<Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>, DAG6x3<A, B, C, D, E, F, RA, RB, RC>> {
   ...
   */
  DAG6x3(DAGStructure<Tuple3<RA, RB, RC>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG6x3<A, B, C, D, E, F, RA, RB, RC> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>, DAG6x3<A, B, C, D, E, F, RA, RB, RC>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>, DAG6x3<A, B, C, D, E, F, RA, RB, RC>> {
    @Override
    ...
    @Override
    public DAG6x3<A, B, C, D, E, F, RA, RB, RC> getInstance() {
      return DAG6x3.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG6x3<A, B, C, D, E, F, RA, RB, RC>>> getGraphReducers() {
   ...
   */
  public DAG6x3<A, B, C, D, E, F, RA, RB, RC> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG6x3<A, B, C, D, E, F, RA, RB, RC> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6) {
   ...
   */
  public DAG5x3<B, C, D, E, F, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG6x3<A, B, C, D, E, F, RA, RB, RC> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG5x3<A, C, D, E, F, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG5x3<A, B, D, E, F, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x3<A, B, C, E, F, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x3<A, B, C, D, F, RA, RB, RC> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG5x3<A, B, C, D, E, RA, RB, RC> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RC> the type of the third result
   */
  private static class Preparer<A, B, C, D, E, F, RA, RB, RC> extends
      AbstractBatchPreparer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> {
    // the DAG being prepared
    private final DAG6x3<A, B, C, D, E, F, RA, RB, RC> _dag;
     ...
     */
    Preparer(DAG6x3<A, B, C, D, E, F, RA, RB, RC> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> finish(
  ...
  @Override
  protected Preparer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, RA, RB, RC> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>) res.getPreparerResult()
   ...
   */
  public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6) {
    return (DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RC> the type of the third result
   */
  public static final class Result<A, B, C, D, E, F, RA, RB, RC> extends AbstractDAGResult3<RA, RB, RC> {
    // the prepared DAG
    private final DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RC> the type of the third result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, RA, RB, RC> extends
      AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>>
      implements PreparedDAGTransformer<Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> {
    ...
    * @param input6 the {@link Producer} providing the sixth input to the transformer
     ...
     */
    @Override
    public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>> {
      @Override
      public DAGStructure<Tuple3<RA, RB, RC>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> getInstance() {
        return DAG6x3.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<B, C, D, E, F, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      DAG6x3.Prepared<A, B, C, D, E, F, RA, RB, RC> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6);
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<A, C, D, E, F, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<A, B, D, E, F, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<A, B, C, E, F, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<A, B, C, D, F, RA, RB, RC> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG5x3.Prepared<A, B, C, D, E, RA, RB, RC> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple3<RA, RB, RC> apply(A value1, B value2, C value3, D value4, E value5, F value6) {
      try (
