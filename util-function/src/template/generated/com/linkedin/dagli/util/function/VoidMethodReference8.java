 ...
 */
class VoidMethodReference8<A, B, C, D, E, F, G, H> implements VoidFunction8.Serializable<A, B, C, D, E, F, G, H>, Named {
  ...
  private static final int CLASS_HASH = VoidMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  VoidMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof VoidMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference8) func)._methodReference;
    } else {
  ...
  private VoidFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new VoidMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction8.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) {
    _cachedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference8) obj)._methodReference);
  }
