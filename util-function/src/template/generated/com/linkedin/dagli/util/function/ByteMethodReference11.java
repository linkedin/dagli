 ...
 */
class ByteMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
  ...
  private static final int CLASS_HASH = ByteMethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;

  ByteMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof ByteMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference11) func)._methodReference;
    } else {
  ...
  private ByteFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(byte.class);
      return (ByteFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction11.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference11)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference11) obj)._methodReference);
  }
