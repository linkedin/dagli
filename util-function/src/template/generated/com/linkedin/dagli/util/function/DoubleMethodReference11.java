 ...
 */
class DoubleMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
    DoubleFunction11.Serializable<A, B, C, D, E, F, G, H, I, J, K>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;

  DoubleMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof DoubleMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference11) func)._methodReference;
    } else {
  ...
  private DoubleFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(double.class);
      return (DoubleFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction11.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference11)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference11) obj)._methodReference);
  }
