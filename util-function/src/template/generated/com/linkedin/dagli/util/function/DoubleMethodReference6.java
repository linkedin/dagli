 ...
 */
class DoubleMethodReference6<A, B, C, D, E, F> implements DoubleFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction6<A, B, C, D, E, F> _cachedFunction = null;

  DoubleMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof DoubleMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference6) func)._methodReference;
    } else {
  ...
  private DoubleFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference7<Object, A, B, C, D, E, F> unbound =
          new DoubleMethodReference7<>(_methodReference.unbind());
      return (A value1, B value2, C value3, D value4, E value5, F value6) -> unbound.apply(
          _methodReference.getBoundInstance(), value1, value2, value3, value4, value5, value6);
    }
    ...
    try {
      ...
      return (DoubleFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction6.class), type, mh,
  ...
  public double apply(A value1, B value2, C value3, D value4, E value5, F value6) {
    return _cachedFunction.apply(value1, value2, value3, value4, value5, value6);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference6) obj)._methodReference);
  }
