...
abstract class AbstractTransformer5<A, B, C, D, E, R, IF extends Transformer5InternalAPI<A, B, C, D, E, R, S>, S extends AbstractTransformer5<A, B, C, D, E, R, IF, S>>
    extends AbstractTransformer<R, IF, S> implements Transformer5<A, B, C, D, E, R> {

  private static final long serialVersionUID = 1;

  @Override
  protected List<Producer<?>> getInputList() {
    return Arrays.asList(getInput1(), getInput2(), getInput3(), getInput4(), getInput5());
  }
  ...
  public AbstractTransformer5() {
    this(MissingInput.get(), MissingInput.get(), MissingInput.get(), MissingInput.get(), MissingInput.get());
  }

  public AbstractTransformer5(Producer<? extends A> input1, Producer<? extends B> input2, Producer<? extends C> input3,
  ...
  /**
   * Returns a copy of this instance that will accept the provided {@link Producer} as its fifth
   * input.
   *
  ...
  protected abstract class InternalAPI extends AbstractTransformer<R, IF, S>.InternalAPI implements
      Transformer5InternalAPI<A, B, C, D, E, R, S> {
    @Override
    public Producer<? extends A> getInput1() {
      return AbstractTransformer5.this.getInput1();
    }

    @Override
    public Producer<? extends B> getInput2() {
      return AbstractTransformer5.this.getInput2();
    }

    @Override
    public Producer<? extends C> getInput3() {
      return AbstractTransformer5.this.getInput3();
    }

    @Override
    public Producer<? extends D> getInput4() {
      return AbstractTransformer5.this.getInput4();
    }

    @Override
    public Producer<? extends E> getInput5() {
      return AbstractTransformer5.this.getInput5();
    }

    @Override
    public S withInputs(Producer<? extends A> input1, Producer<? extends B> input2, Producer<? extends C> input3,
        Producer<? extends D> input4, Producer<? extends E> input5) {
      return AbstractTransformer5.this.withAllInputs(input1, input2, input3, input4, input5);
    }

    @Override
    public List<Producer<?>> getInputList() {
      return AbstractTransformer5.this.getInputList();
    }
  }
}
