...
/**
 * A tuple of arity ArrayTuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> that is backed by an array.
 ...
 */
final class ArrayTuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> extends AbstractTuple implements
   ...
   */
  public ArrayTuple15(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(15);
    System.arraycopy(_array, 0, result, 0, 15);
    return result;
  }
}
