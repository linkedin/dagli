...
@FunctionalInterface
public interface DoubleFunction2<A, B> extends FunctionBase, ToDoubleBiFunction<A, B> {
  double apply(A value1, B value2);
   ...
   */
  default DoubleFunction2<A, B> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument2<>(this);
  }

  @Override
  default double applyAsDouble(A value1, B value2) {
    return apply(value1, value2);
  }

  static <A, B> DoubleFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    double apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction2.Serializable should override this method
   ...
   */
  static <A, B> DoubleFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends DoubleFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new DoubleMethodReference2<A, B>(this);
