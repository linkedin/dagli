...
public interface LongFunction6<A, B, C, D, E, F> extends FunctionBase {
  long apply(A value1, B value2, C value3, D value4, E value5, F value6);
  ...
  static <A, B, C, D, E, F> LongFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    long apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement LongFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> LongFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends LongFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new LongMethodReference6<A, B, C, D, E, F>(this);
