 ...
 */
class FloatMethodReference1<A> implements FloatFunction1.Serializable<A>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction1<A> _cachedFunction = null;

  FloatMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference1(Serializable<A> func) {
    if (func instanceof FloatMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference1) func)._methodReference;
    } else {
  ...
  private FloatFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference2<Object, A> unbound = new FloatMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference1)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference1) obj)._methodReference);
  }
