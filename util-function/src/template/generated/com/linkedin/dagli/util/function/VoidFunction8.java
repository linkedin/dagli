...
@FunctionalInterface
public interface VoidFunction8<A, B, C, D, E, F, G, H> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8);
   ...
   */
  default VoidFunction8<A, B, C, D, E, F, G, H> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument8<>(this);
  }

  static <A, B, C, D, E, F, G, H> VoidFunction8<A, B, C, D, E, F, G, H> unchecked(
      Checked<A, B, C, D, E, F, G, H, ?> checkedFunction) {
    return (A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, D, E, F, G, H, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction8.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H> VoidFunction8.Serializable<A, B, C, D, E, F, G, H> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H> extends VoidFunction8<A, B, C, D, E, F, G, H>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G, H> safelySerializable() {
      try {
        return new VoidMethodReference8<A, B, C, D, E, F, G, H>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument8<>(this);
    }
