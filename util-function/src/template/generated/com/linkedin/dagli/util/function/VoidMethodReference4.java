 ...
 */
class VoidMethodReference4<A, B, C, D> implements VoidFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = VoidMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction4<A, B, C, D> _cachedFunction = null;

  VoidMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof VoidMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference4) func)._methodReference;
    } else {
  ...
  private VoidFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference5<Object, A, B, C, D> unbound = new VoidMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction4.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4) {
    _cachedFunction.apply(value1, value2, value3, value4);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference4) obj)._methodReference);
  }
