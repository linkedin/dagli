 ...
 *
 * DAG5x6 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x6 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>, DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>
    implements
    PreparableDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>, DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> {
   ...
   */
  DAG5x6(DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>, DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>, DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> {
    @Override
    ...
    @Override
    public DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> getInstance() {
      return DAG5x6.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
   ...
   */
  public DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
   ...
   */
  public DAG4x6<B, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG4x6<A, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x6<A, B, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x6<A, B, C, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x6<A, B, C, D, RA, RB, RC, RD, RE, RF> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RF> the type of the sixth result
   */
  private static class Preparer<A, B, C, D, E, RA, RB, RC, RD, RE, RF>
      extends
      AbstractBatchPreparer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> {
    // the DAG being prepared
    private final DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> _dag;
     ...
     */
    Preparer(DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    DAGExecutionResult<Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>) res.getPreparerResult()
   ...
   */
  public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    return (DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RF> the type of the sixth result
   */
  public static final class Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF> extends
      AbstractDAGResult6<RA, RB, RC, RD, RE, RF> {
    // the prepared DAG
    private final DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RF> the type of the sixth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>
      extends
      AbstractPreparedTransformer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>
      implements
      PreparedDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer5<A, B, C, D, E, Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>> {
      @Override
      public DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> getInstance() {
        return DAG5x6.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5) {
      return super.withAllInputs(input1, input2, input3, input4, input5);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG4x6.Prepared<B, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x6.Prepared<A, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x6.Prepared<A, B, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x6.Prepared<A, B, C, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x6.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple6<RA, RB, RC, RD, RE, RF> apply(A value1, B value2, C value3, D value4, E value5) {
      try (
