...
/**
 * A function class implementing {@link CharacterFunction7.Serializable} that composes
 * {@link CharacterFunction7} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class CharacterComposedFunction7<A, B, C, D, E, F, G, Q> implements
   ...
   *                as input
   */
  CharacterComposedFunction7(Function7<A, B, C, D, E, F, G, Q> first, CharacterFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public CharacterComposedFunction7<A, B, C, D, E, F, G, Q> safelySerializable() {
    return new CharacterComposedFunction7<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CharacterComposedFunction7.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof CharacterComposedFunction7) {
      return this._first.equals(((CharacterComposedFunction7) obj)._first)
          && this._andThen.equals(((CharacterComposedFunction7) obj)._andThen);
    }
    return false;
  }
