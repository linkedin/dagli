 ...
 */
class MethodReference11<A, B, C, D, E, F, G, H, I, J, K, R> implements
  ...
  private static final int CLASS_HASH = MethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function11<A, B, C, D, E, F, G, H, I, J, K, R> _cachedFunction = null;

  MethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K, R> func) {
    if (func instanceof MethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference11) func)._methodReference;
    } else {
  ...
  private Function11<A, B, C, D, E, F, G, H, I, J, K, R> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic();
      return (Function11<A, B, C, D, E, F, G, H, I, J, K, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function11.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference11)) {
      return false;
    }

    return _methodReference.equals(((MethodReference11) obj)._methodReference);
  }
