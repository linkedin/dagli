 ...
 *
 * DAG6x7 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG6x7 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>
    extends
    AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>, DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>
    implements
    PreparableDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>, DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> {
   ...
   */
  DAG6x7(DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>, DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>, DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> {
    @Override
    ...
    @Override
    public DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> getInstance() {
      return DAG6x7.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
   ...
   */
  public DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
      Producer<? extends E> input5, Producer<? extends F> input6) {
   ...
   */
  public DAG5x7<B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG5x7<A, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG5x7<A, B, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x7<A, B, C, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x7<A, B, C, D, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RG> the type of the seventh result
   */
  private static class Preparer<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractBatchPreparer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> {
    // the DAG being prepared
    private final DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> _dag;
     ...
     */
    Preparer(DAG6x7<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> finish(
  ...
  @Override
  protected Preparer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>) res.getPreparerResult()
   ...
   */
  public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6) {
    return (DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RG> the type of the seventh result
   */
  public static final class Result<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> extends
      AbstractDAGResult7<RA, RB, RC, RD, RE, RF, RG> {
    // the prepared DAG
    private final DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RG> the type of the seventh result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>
      implements
      PreparedDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> {
    ...
    * @param input6 the {@link Producer} providing the sixth input to the transformer
     ...
     */
    @Override
    public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>> {
      @Override
      public DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> getInstance() {
        return DAG6x7.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5, Producer<? extends F> input6) {
      return super.withAllInputs(input1, input2, input3, input4, input5, input6);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      DAG6x7.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6);
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<A, C, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<A, B, D, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<A, B, C, E, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<A, B, C, D, F, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
