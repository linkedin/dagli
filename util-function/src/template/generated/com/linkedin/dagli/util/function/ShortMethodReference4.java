 ...
 */
class ShortMethodReference4<A, B, C, D> implements ShortFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction4<A, B, C, D> _cachedFunction = null;

  ShortMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof ShortMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference4) func)._methodReference;
    } else {
  ...
  private ShortFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference5<Object, A, B, C, D> unbound = new ShortMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction4.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference4) obj)._methodReference);
  }
