 ...
 */
class DoubleMethodReference1<A> implements DoubleFunction1.Serializable<A>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction1<A> _cachedFunction = null;

  DoubleMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference1(Serializable<A> func) {
    if (func instanceof DoubleMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference1) func)._methodReference;
    } else {
  ...
  private DoubleFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference2<Object, A> unbound = new DoubleMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference1)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference1) obj)._methodReference);
  }
