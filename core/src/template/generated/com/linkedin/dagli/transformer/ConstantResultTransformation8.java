...
import com.linkedin.dagli.preparer.TrivialPreparer8;
 ...
 */
@ValueEquality
public final class ConstantResultTransformation8<A, B, C, D, E, F, G, H, R>
    extends
    AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, R, ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>, ConstantResultTransformation8<A, B, C, D, E, F, G, H, R>>
    implements ConstantResultTransformation<R, ConstantResultTransformation8<A, B, C, D, E, F, G, H, R>> {
   ...
   */
  public ConstantResultTransformation8() {
  }
   ...
   */
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withResult(R result) {
    return clone(c -> {
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withResultForPreparationData(R result) {
    return clone(c -> {
      c._resultForPreparationData = result;
    });
  }
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withResultForNewData(R result) {
    return clone(c -> {
      c._resultForNewData = result;
    });
  }
  ...
  @Override
  protected Preparer8<A, B, C, D, E, F, G, H, R, ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>> getPreparer(
      PreparerContext context) {
    ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> resultForPrepData =
        new ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>(_resultForPreparationData);
    return _resultForPreparationData == _resultForNewData ? new TrivialPreparer8<>(resultForPrepData)
        : new TrivialPreparer8<>(resultForPrepData,
            new ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>(_resultForNewData));
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput1(Producer<? extends A> inputA) {
    return super.withInput1(inputA);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput2(Producer<? extends B> inputB) {
    return super.withInput2(inputB);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput3(Producer<? extends C> inputC) {
    return super.withInput3(inputC);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput4(Producer<? extends D> inputD) {
    return super.withInput4(inputD);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput5(Producer<? extends E> inputE) {
    return super.withInput5(inputE);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput6(Producer<? extends F> inputF) {
    return super.withInput6(inputF);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput7(Producer<? extends G> inputG) {
    return super.withInput7(inputG);
  }

  @Override
  public ConstantResultTransformation8<A, B, C, D, E, F, G, H, R> withInput8(Producer<? extends H> inputH) {
    return super.withInput8(inputH);
  }

  @Override
  public String getName() {
    return "ConstantResultTransformation8("
  ...
  * @param <H> the type of the eighth input
   ...
   */
  @ValueEquality
  public static final class Prepared<A, B, C, D, E, F, G, H, R>
      extends
      AbstractPreparedTransformer8<A, B, C, D, E, F, G, H, R, ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>>
      implements
      ConstantResultTransformation.Prepared<R, ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R>> {
    private static final long serialVersionUID = 1;
     ...
     * @return a copy of this transformer that will always have the specified constant result
     */
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withResult(R result) {
    ...
    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput1(Producer<? extends A> inputA) {
      return super.withInput1(inputA);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput2(Producer<? extends B> inputB) {
      return super.withInput2(inputB);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput3(Producer<? extends C> inputC) {
      return super.withInput3(inputC);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput4(Producer<? extends D> inputD) {
      return super.withInput4(inputD);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput5(Producer<? extends E> inputE) {
      return super.withInput5(inputE);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput6(Producer<? extends F> inputF) {
      return super.withInput6(inputF);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput7(Producer<? extends G> inputG) {
      return super.withInput7(inputG);
    }

    @Override
    public ConstantResultTransformation8.Prepared<A, B, C, D, E, F, G, H, R> withInput8(Producer<? extends H> inputH) {
      return super.withInput8(inputH);
    }

    @Override
    public String getName() {
      return "ConstantResultTransformation8.Prepared(" + _result + ")";
    }
  }
}
