...
public interface PreparableTransformer8<A, B, C, D, E, F, G, H, R, N extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>>
    extends Transformer8<A, B, C, D, E, F, G, H, R>, PreparableTransformer<R, N> {
  ...
  static <A, B, C, D, E, F, G, H, R, N extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>> PreparableTransformer8<A, B, C, D, E, F, G, H, R, N> cast(
      PreparableTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R, ? extends N> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer8<A, B, C, D, E, F, G, H, R, N>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, R> PreparableTransformer8<A, B, C, D, E, F, G, H, R, PreparedTransformer8<A, B, C, D, E, F, G, H, R>> castWithGenericPrepared(
      PreparableTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R, ?> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer8<A, B, C, D, E, F, G, H, R, PreparedTransformer8<A, B, C, D, E, F, G, H, R>>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, R, N extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>> PreparerResultMixed<PreparedTransformer8<A, B, C, D, E, F, G, H, R>, N> prepare(
      PreparableTransformer8<A, B, C, D, E, F, G, H, R, N> preparable, Iterable<? extends A> values1,
    ...
    return (PreparerResultMixed<PreparedTransformer8<A, B, C, D, E, F, G, H, R>, N>) preparable.internalAPI().prepare(
        PreparerContext.builder(Iterables.size64(values1)).setExecutor(new SimpleDAGExecutor()).build(), values1,
        values2, values3, values4, values5, values6, values7, values8);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, R> DAG8x1<A, B, C, D, E, F, G, H, R> toDAG(
      PreparableTransformer8<A, B, C, D, E, F, G, H, R, ?> transformer) {
    if (transformer instanceof DAG8x1) {
      return (DAG8x1<A, B, C, D, E, F, G, H, R>) transformer;
    }
