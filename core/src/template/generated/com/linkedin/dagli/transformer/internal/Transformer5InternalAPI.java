...
public interface Transformer5InternalAPI<A, B, C, D, E, R, S extends Transformer5<A, B, C, D, E, R>> extends
  ...
  default S withInputsUnsafe(List<? extends Producer<?>> newInputs) {
    return withInputs((Producer<? extends A>) newInputs.get(0), (Producer<? extends B>) newInputs.get(1),
        ...
        (Producer<? extends E>) newInputs.get(4));
  }
  ...
  <F> Transformer6<A, B, C, D, E, F, R> withArity6(Producer<? extends F> newInput6);

  <N> Transformer6<N, A, B, C, D, E, R> withPrependedArity6(Producer<? extends N> newInput1);

  Transformer1<Tuple5<? extends A, ? extends B, ? extends C, ? extends D, ? extends E>, R> withArity1(
