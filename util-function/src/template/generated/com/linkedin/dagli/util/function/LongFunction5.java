...
@FunctionalInterface
public interface LongFunction5<A, B, C, D, E> extends FunctionBase {
  long apply(A value1, B value2, C value3, D value4, E value5);
   ...
   */
  default LongFunction5<A, B, C, D, E> returnZeroOnNullArgument() {
    return new LongDefaultOnNullArgument5<>(this);
  }

  static <A, B, C, D, E> LongFunction5<A, B, C, D, E> unchecked(Checked<A, B, C, D, E, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, X extends Throwable> extends FunctionBase {
    long apply(A value1, B value2, C value3, D value4, E value5) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement LongFunction5.Serializable should override this method
   ...
   */
  static <A, B, C, D, E> LongFunction5.Serializable<A, B, C, D, E> safelySerializable(
      Serializable<A, B, C, D, E> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E> extends LongFunction5<A, B, C, D, E>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E> safelySerializable() {
      try {
        return new LongMethodReference5<A, B, C, D, E>(this);
