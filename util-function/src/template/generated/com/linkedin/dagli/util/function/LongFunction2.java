...
public interface LongFunction2<A, B> extends FunctionBase, ToLongBiFunction<A, B> {
  ...
  @Override
  default long applyAsLong(A value1, B value2) {
    return apply(value1, value2);
  }

  static <A, B> LongFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    long apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement LongFunction2.Serializable should override this method
   ...
   */
  static <A, B> LongFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends LongFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new LongMethodReference2<A, B>(this);
