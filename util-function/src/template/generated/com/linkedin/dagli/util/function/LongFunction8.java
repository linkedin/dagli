...
public interface LongFunction8<A, B, C, D, E, F, G, H> extends FunctionBase {
  long apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8);
  ...
  static <A, B, C, D, E, F, G, H> LongFunction8<A, B, C, D, E, F, G, H> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, H, X extends Throwable> extends FunctionBase {
    long apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement LongFunction8.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H> LongFunction8.Serializable<A, B, C, D, E, F, G, H> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H> extends LongFunction8<A, B, C, D, E, F, G, H>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G, H> safelySerializable() {
      try {
        return new LongMethodReference8<A, B, C, D, E, F, G, H>(this);
