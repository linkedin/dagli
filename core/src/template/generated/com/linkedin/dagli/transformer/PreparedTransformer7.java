...
public interface PreparedTransformer7<A, B, C, D, E, F, G, R> extends Transformer7<A, B, C, D, E, F, G, R>,
   ...
   */
  static <A, B, C, D, E, F, G, R> DAG7x1.Prepared<A, B, C, D, E, F, G, R> toDAG(
      PreparedTransformer7<A, B, C, D, E, F, G, R> transformer) {
    if (transformer instanceof DAG7x1.Prepared) {
      return (DAG7x1.Prepared<A, B, C, D, E, F, G, R>) transformer;
    }
