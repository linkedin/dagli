...
@FunctionalInterface
public interface ShortFunction8<A, B, C, D, E, F, G, H> extends FunctionBase {
  short apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8);
   ...
   */
  default ShortFunction8<A, B, C, D, E, F, G, H> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument8<>(this);
  }

  static <A, B, C, D, E, F, G, H> ShortFunction8<A, B, C, D, E, F, G, H> unchecked(
  ...
  interface Serializable<A, B, C, D, E, F, G, H> extends ShortFunction8<A, B, C, D, E, F, G, H>, java.io.Serializable {
    ...
    default Serializable<A, B, C, D, E, F, G, H> safelySerializable() {
      try {
        return new ShortMethodReference8<A, B, C, D, E, F, G, H>(this);
