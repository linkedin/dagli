 ...
 */
class ByteMethodReference3<A, B, C> implements ByteFunction3.Serializable<A, B, C>, Named {
  ...
  ByteMethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference3(Serializable<A, B, C> func) {
    if (func instanceof ByteMethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference3) func)._methodReference;
    } else {
  ...
  private ByteFunction3<A, B, C> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference4<Object, A, B, C> unbound = new ByteMethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction3<A, B, C>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction3.class), type, mh,
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((ByteMethodReference3) obj)._methodReference);
  }
