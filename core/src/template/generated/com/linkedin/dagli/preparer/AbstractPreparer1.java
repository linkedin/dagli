 ...
 * {@link PreparerMode#STREAM} modes, it should derive from {@link AbstractBatchPreparer1} or
 * {@link AbstractStreamPreparer1} instead.
 *
 ...
 */
public abstract class AbstractPreparer1<A, R, N extends PreparedTransformer1<A, R>> extends AbstractPreparer<R, N>
    implements Preparer1<A, R, N> {

  @Override
  public final void processUnsafe(Object[] values) {
    Preparer1.super.processUnsafe(values);
  }

  @Override
  public final PreparerResultMixed<? extends PreparedTransformer1<? super A, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return Preparer1.super.finishUnsafe(inputs);
  }
}
