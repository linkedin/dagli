 ...
 *
 * DAG8x1 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG8x1 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG8x1<A, B, C, D, E, F, G, H, RA>
    extends
    AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>, DAG8x1<A, B, C, D, E, F, G, H, RA>>
    implements
    PreparableDAGTransformer<RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>, DAG8x1<A, B, C, D, E, F, G, H, RA>> {
   ...
   */
  DAG8x1(DAGStructure<RA> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG8x1<A, B, C, D, E, F, G, H, RA> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>, DAG8x1<A, B, C, D, E, F, G, H, RA>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>, DAG8x1<A, B, C, D, E, F, G, H, RA>> {
    @Override
    ...
    @Override
    public DAG8x1<A, B, C, D, E, F, G, H, RA> getInstance() {
      return DAG8x1.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG8x1<A, B, C, D, E, F, G, H, RA>>> getGraphReducers() {
   ...
   */
  public DAG8x1<A, B, C, D, E, F, G, H, RA> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG8x1<A, B, C, D, E, F, G, H, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6, Producer<? extends G> input7, Producer<? extends H> input8) {
   ...
   */
  public DAG7x1<B, C, D, E, F, G, H, RA> withGeneratorAsInput1(Generator<A> generator) {
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
            nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8).withOutput(dag).withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, C, D, E, F, G, H, RA> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, D, E, F, G, H, RA> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, C, E, F, G, H, RA> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, C, D, F, G, H, RA> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, C, D, E, G, H, RA> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder7, nestedPlaceholder8).withOutput(dag).withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, C, D, E, F, H, RA> withGeneratorAsInput7(Generator<G> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder8).withOutput(dag).withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG7x1<A, B, C, D, E, F, G, RA> withGeneratorAsInput8(Generator<H> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder7).withOutput(dag).withExecutor(_executor)
   ...
   * @param <RA> the type of the first result
   */
  private static class Preparer<A, B, C, D, E, F, G, H, RA> extends
      AbstractBatchPreparer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> {
    // the DAG being prepared
    private final DAG8x1<A, B, C, D, E, F, G, H, RA> _dag;
     ...
     */
    Preparer(DAG8x1<A, B, C, D, E, F, G, H, RA> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer8<A, B, C, D, E, F, G, H, RA>, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> finish(
  ...
  @Override
  protected Preparer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, G, H, RA> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    ...
                    .wrap(values8) });
    return new Result<>((DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>) res.getPreparerResult()
   ...
   */
  public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6, Iterable<? extends G> values7,
      Iterable<? extends H> values8) {
    return (DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RA> the type of the first result
   */
  public static final class Result<A, B, C, D, E, F, G, H, RA> extends AbstractDAGResult1<RA> {
    // the prepared DAG
    private final DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RA> the type of the first result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, G, H, RA> extends
      AbstractPreparedTransformer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> implements
      PreparedDAGTransformer<RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> {
    ...
    * @param input8 the {@link Producer} providing the eighth input to the transformer
     ...
     */
    @Override
    public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer8<A, B, C, D, E, F, G, H, RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<RA, DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>> {
      @Override
      public DAGStructure<RA> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> getInstance() {
        return DAG8x1.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<B, C, D, E, F, G, H, RA> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      ...
      Placeholder<G> nestedPlaceholder7 = new Placeholder<>("Original Input 7");
      Placeholder<H> nestedPlaceholder8 = new Placeholder<>("Original Input 8");
      DAG8x1.Prepared<A, B, C, D, E, F, G, H, RA> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8);
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, C, D, E, F, G, H, RA> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, D, E, F, G, H, RA> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, C, E, F, G, H, RA> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, C, D, F, G, H, RA> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, C, D, E, G, H, RA> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, C, D, E, F, H, RA> withGeneratorAsInput7(Generator<G> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG7x1.Prepared<A, B, C, D, E, F, G, RA> withGeneratorAsInput8(Generator<H> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public RA apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) {
      try (
