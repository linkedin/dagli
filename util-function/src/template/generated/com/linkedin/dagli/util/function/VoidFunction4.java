...
@FunctionalInterface
public interface VoidFunction4<A, B, C, D> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4);
   ...
   */
  default VoidFunction4<A, B, C, D> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument4<>(this);
  }

  static <A, B, C, D> VoidFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
    return (A value1, B value2, C value3, D value4) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> VoidFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends VoidFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new VoidMethodReference4<A, B, C, D>(this);
    ...
    @Override
    default Serializable<A, B, C, D> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument4<>(this);
    }
