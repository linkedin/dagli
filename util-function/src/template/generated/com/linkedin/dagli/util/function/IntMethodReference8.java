 ...
 */
class IntMethodReference8<A, B, C, D, E, F, G, H> implements IntFunction8.Serializable<A, B, C, D, E, F, G, H>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  IntMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof IntMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference8) func)._methodReference;
    } else {
  ...
  private IntFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new IntMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference8) obj)._methodReference);
  }
