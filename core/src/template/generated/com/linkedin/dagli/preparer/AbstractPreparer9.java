 ...
 * {@link PreparerMode#STREAM} modes, it should derive from {@link AbstractBatchPreparer9} or
 * {@link AbstractStreamPreparer9} instead.
 *
 ...
 */
public abstract class AbstractPreparer9<A, B, C, D, E, F, G, H, I, R, N extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>>
    extends AbstractPreparer<R, N> implements Preparer9<A, B, C, D, E, F, G, H, I, R, N> {

  @Override
  public final void processUnsafe(Object[] values) {
    Preparer9.super.processUnsafe(values);
  }

  @Override
  public final PreparerResultMixed<? extends PreparedTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return Preparer9.super.finishUnsafe(inputs);
  }
}
