...
@FunctionalInterface
public interface ShortFunction3<A, B, C> extends FunctionBase {
  short apply(A value1, B value2, C value3);
   ...
   */
  default ShortFunction3<A, B, C> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> ShortFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    short apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ShortFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> ShortFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends ShortFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new ShortMethodReference3<A, B, C>(this);
