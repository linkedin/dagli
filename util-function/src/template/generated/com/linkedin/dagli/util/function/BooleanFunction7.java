...
@FunctionalInterface
public interface BooleanFunction7<A, B, C, D, E, F, G> extends FunctionBase {
  boolean apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7);
   ...
   */
  default BooleanFunction7<A, B, C, D, E, F, G> returnFalseOnNullArgument() {
    return new BooleanDefaultOnNullArgument7<>(this);
  }

  default BooleanFunction7<A, B, C, D, E, F, G> negate() {
    return BooleanNegatedFunction7.negate(this);
  }

  static <A, B, C, D, E, F, G> BooleanFunction7<A, B, C, D, E, F, G> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction7.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G> BooleanFunction7.Serializable<A, B, C, D, E, F, G> safelySerializable(
      Serializable<A, B, C, D, E, F, G> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G> extends BooleanFunction7<A, B, C, D, E, F, G>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G> safelySerializable() {
      try {
        return new BooleanMethodReference7<A, B, C, D, E, F, G>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G> returnFalseOnNullArgument() {
      return new BooleanDefaultOnNullArgument7<>(this);
    }

    @Override
    default Serializable<A, B, C, D, E, F, G> negate() {
      return BooleanNegatedFunction7.Serializable.negate(this);
    }
