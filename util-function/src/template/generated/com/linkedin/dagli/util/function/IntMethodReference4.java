 ...
 */
class IntMethodReference4<A, B, C, D> implements IntFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction4<A, B, C, D> _cachedFunction = null;

  IntMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof IntMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference4) func)._methodReference;
    } else {
  ...
  private IntFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference5<Object, A, B, C, D> unbound = new IntMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction4.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference4) obj)._methodReference);
  }
