...
import com.linkedin.dagli.transformer.internal.PreparableTransformer9InternalAPI;
import com.linkedin.dagli.util.collection.Iterables;


public interface PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>>
    extends Transformer9<A, B, C, D, E, F, G, H, I, R>, PreparableTransformer<R, N> {

  @Override
  PreparableTransformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, N, ? extends PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N>> internalAPI();
  ...
  static <A, B, C, D, E, F, G, H, I, R, N extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>> PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N> cast(
      PreparableTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R, ? extends N> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, R> PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>> castWithGenericPrepared(
      PreparableTransformer9<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R, ?> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, R, N extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>> PreparerResultMixed<PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>, N> prepare(
      PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, N> preparable, Iterable<? extends A> values1,
    ...
    return (PreparerResultMixed<PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>, N>) preparable.internalAPI()
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, R> DAG9x1<A, B, C, D, E, F, G, H, I, R> toDAG(
      PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, ?> transformer) {
    if (transformer instanceof DAG9x1) {
      return (DAG9x1<A, B, C, D, E, F, G, H, I, R>) transformer;
    }
