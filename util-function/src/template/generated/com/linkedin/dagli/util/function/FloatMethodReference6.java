 ...
 */
class FloatMethodReference6<A, B, C, D, E, F> implements FloatFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction6<A, B, C, D, E, F> _cachedFunction = null;

  FloatMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof FloatMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference6) func)._methodReference;
    } else {
  ...
  private FloatFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference7<Object, A, B, C, D, E, F> unbound = new FloatMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference6) obj)._methodReference);
  }
