 ...
 *
 * DAG4x4 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x4 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x4<A, B, C, D, RA, RB, RC, RD>
    extends
    AbstractPreparableTransformer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>, DAG4x4<A, B, C, D, RA, RB, RC, RD>>
    implements
    PreparableDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>, DAG4x4<A, B, C, D, RA, RB, RC, RD>> {
   ...
   */
  DAG4x4(DAGStructure<Tuple4<RA, RB, RC, RD>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG4x4<A, B, C, D, RA, RB, RC, RD> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>, DAG4x4<A, B, C, D, RA, RB, RC, RD>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>, DAG4x4<A, B, C, D, RA, RB, RC, RD>> {
    @Override
    ...
    @Override
    public DAG4x4<A, B, C, D, RA, RB, RC, RD> getInstance() {
      return DAG4x4.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG4x4<A, B, C, D, RA, RB, RC, RD>>> getGraphReducers() {
   ...
   */
  public DAG4x4<A, B, C, D, RA, RB, RC, RD> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x4<A, B, C, D, RA, RB, RC, RD> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4) {
   ...
   */
  public DAG3x4<B, C, D, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG4x4<A, B, C, D, RA, RB, RC, RD> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput2(), getInput3(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x4<A, C, D, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput3(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x4<A, B, D, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x4<A, B, C, D, RA, RB, RC, RD> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x4<A, B, C, RA, RB, RC, RD> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x4<A, B, C, D, RA, RB, RC, RD> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3());
  }
   ...
   * @param <RD> the type of the fourth result
   */
  private static class Preparer<A, B, C, D, RA, RB, RC, RD> extends
      AbstractBatchPreparer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> {
    // the DAG being prepared
    private final DAG4x4<A, B, C, D, RA, RB, RC, RD> _dag;
     ...
     */
    Preparer(DAG4x4<A, B, C, D, RA, RB, RC, RD> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, Tuple4<RA, RB, RC, RD>>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> finish(
  ...
  @Override
  protected Preparer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA, RB, RC, RD> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>) res.getPreparerResult()
   ...
   */
  public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RD> the type of the fourth result
   */
  public static final class Result<A, B, C, D, RA, RB, RC, RD> extends AbstractDAGResult4<RA, RB, RC, RD> {
    // the prepared DAG
    private final DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RD> the type of the fourth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA, RB, RC, RD> extends
      AbstractPreparedTransformer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>>
      implements PreparedDAGTransformer<Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer4<A, B, C, D, Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple4<RA, RB, RC, RD>, DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>> {
      @Override
      public DAGStructure<Tuple4<RA, RB, RC, RD>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> getInstance() {
        return DAG4x4.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG3x4.Prepared<B, C, D, RA, RB, RC, RD> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);
     ...
     *         the produced by the provided generator
     */
    public DAG3x4.Prepared<A, C, D, RA, RB, RC, RD> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x4.Prepared<A, B, D, RA, RB, RC, RD> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG3x4.Prepared<A, B, C, RA, RB, RC, RD> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG4x4.Prepared<A, B, C, D, RA, RB, RC, RD> dag =
    ...
    @Override
    public Tuple4<RA, RB, RC, RD> apply(A value1, B value2, C value3, D value4) {
      try (
