...
/**
 * A function class implementing {@link ShortFunction8.Serializable} that composes
 * {@link ShortFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ShortComposedFunction8<A, B, C, D, E, F, G, H, Q> implements ShortFunction8.Serializable<A, B, C, D, E, F, G, H>,
    Named {
   ...
   *                as input
   */
  ShortComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, ShortFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ShortComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new ShortComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ShortComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ShortComposedFunction8) {
      return this._first.equals(((ShortComposedFunction8) obj)._first)
          && this._andThen.equals(((ShortComposedFunction8) obj)._andThen);
    }
    return false;
  }
