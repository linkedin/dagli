...
public interface FloatFunction7<A, B, C, D, E, F, G> extends FunctionBase {
  float apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7);
  ...
  static <A, B, C, D, E, F, G> FloatFunction7<A, B, C, D, E, F, G> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, X extends Throwable> extends FunctionBase {
    float apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement FloatFunction7.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G> FloatFunction7.Serializable<A, B, C, D, E, F, G> safelySerializable(
      Serializable<A, B, C, D, E, F, G> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G> extends FloatFunction7<A, B, C, D, E, F, G>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G> safelySerializable() {
      try {
        return new FloatMethodReference7<A, B, C, D, E, F, G>(this);
