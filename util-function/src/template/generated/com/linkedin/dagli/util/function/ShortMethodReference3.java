 ...
 */
class ShortMethodReference3<A, B, C> implements ShortFunction3.Serializable<A, B, C>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference3.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction3<A, B, C> _cachedFunction = null;

  ShortMethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference3(Serializable<A, B, C> func) {
    if (func instanceof ShortMethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference3) func)._methodReference;
    } else {
  ...
  private ShortFunction3<A, B, C> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference4<Object, A, B, C> unbound = new ShortMethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction3<A, B, C>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction3.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference3)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference3) obj)._methodReference);
  }
