...
public interface BooleanFunction2<A, B> extends FunctionBase, BiPredicate<A, B> {
  boolean apply(A value1, B value2);
  ...
  @Override
  default boolean test(A value1, B value2) {
    return apply(value1, value2);
  }

  static <A, B> BooleanFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction2.Serializable should override this method
   ...
   */
  static <A, B> BooleanFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends BooleanFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new BooleanMethodReference2<A, B>(this);
    ...
    default Serializable<A, B> negate() {
      return BooleanNegatedFunction2.Serializable.negate(this);
    }
