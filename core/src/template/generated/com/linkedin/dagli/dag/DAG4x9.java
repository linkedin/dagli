 ...
 *
 * DAG4x9 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x9 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>
    extends
    AbstractPreparableTransformer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
    implements
    PreparableDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
   ...
   */
  DAG4x9(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    @Override
    ...
    @Override
    public DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
      return DAG4x9.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
   ...
   */
  public DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4) {
    return super.withAllInputs(input1, input2, input3, input4);
  }

  /**
   * Creates a new DAG that invokes this transformer, except that the first input is replaced by the specified {@link Generator}.
   * The resultant DAG will thus have an arity of 3 (one less than this transformer), and values that were formerly
   ...
   */
  public DAG3x9<B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);

    return DAG
        .withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            ...
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag)).withExecutor(_executor)
        .withInputs(getInput2(), getInput3(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x9<A, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3, nestedPlaceholder4);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag)).withExecutor(_executor)
        .withInputs(getInput1(), getInput3(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x9<A, B, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator, nestedPlaceholder4);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag)).withExecutor(_executor)
        .withInputs(getInput1(), getInput2(), getInput4());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, generator);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag)).withExecutor(_executor)
        .withInputs(getInput1(), getInput2(), getInput3());
  }
   ...
   * @param <RI> the type of the ninth result
   */
  private static class Preparer<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractBatchPreparer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    // the DAG being prepared
    private final DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> _dag;
     ...
     */
    Preparer(DAG4x9<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> finish(
        ObjectReader<Tuple4<A, B, C, D>> inputs) {
      return (PreparerResultMixed) _dag._executor.internalAPI().prepareUnsafe(_dag,
          ObjectReader.split(4, inputs.lazyMap(tuple -> tuple.toArray())));
    }
  ...
  @Override
  protected Preparer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>) res.getPreparerResult()
   ...
   */
  public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                .wrap(values4) }).getPreparedTransformerForNewData();
  }
  ...
  * @param <RI> the type of the ninth result
   */
  public static final class Result<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
      AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
    // the prepared DAG
    private final DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RI> the type of the ninth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractPreparedTransformer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
      implements
      PreparedDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer4<A, B, C, D, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
      @Override
      public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
        return DAG4x9.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4) {
      return super.withAllInputs(input1, input2, input3, input4);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x9.Prepared<B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);
      ...
      return DAG.Prepared
          ...
          .withExecutor(_executor).withInputs(getInput2(), getInput3(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x9.Prepared<A, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
      ...
      return DAG.Prepared
          ...
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
              new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
              new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput3(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x9.Prepared<A, B, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
      ...
      return DAG.Prepared
          ...
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
              new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
              new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG4x9.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
      ...
      return DAG.Prepared
          ...
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
              new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
              new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3());
    }
          ...
          _executor.internalAPI()
              .applyUnsafe(
                  ...
                  new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader
                      .wrap(values3), ObjectReader.wrap(values4) }));
    }

    @Override
    public Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI> apply(A value1, B value2, C value3, D value4) {
      try (
          AutoCloseableArray<ObjectReader<?>> res =
              new AutoCloseableArray<>(_executor.internalAPI().applyUnsafe(
                  ...
                  new ObjectReader[] { ObjectReader.singleton(value1), ObjectReader.singleton(value2), ObjectReader
                      .singleton(value3), ObjectReader.singleton(value4) }));
