...
@FunctionalInterface
public interface ByteFunction3<A, B, C> extends FunctionBase {
  byte apply(A value1, B value2, C value3);
   ...
   */
  default ByteFunction3<A, B, C> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> ByteFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    byte apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ByteFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> ByteFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends ByteFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new ByteMethodReference3<A, B, C>(this);
