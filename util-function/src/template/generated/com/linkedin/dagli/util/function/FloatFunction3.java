...
@FunctionalInterface
public interface FloatFunction3<A, B, C> extends FunctionBase {
  float apply(A value1, B value2, C value3);
   ...
   */
  default FloatFunction3<A, B, C> returnZeroOnNullArgument() {
    return new FloatDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> FloatFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    float apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement FloatFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> FloatFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends FloatFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new FloatMethodReference3<A, B, C>(this);
