 ...
 */
class CharacterMethodReference4<A, B, C, D> implements CharacterFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction4<A, B, C, D> _cachedFunction = null;

  CharacterMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof CharacterMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference4) func)._methodReference;
    } else {
  ...
  private CharacterFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference5<Object, A, B, C, D> unbound =
          new CharacterMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction4.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference4) obj)._methodReference);
  }
