...
@FunctionalInterface
public interface CharacterFunction6<A, B, C, D, E, F> extends FunctionBase {
  char apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default CharacterFunction6<A, B, C, D, E, F> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument6<>(this);
  }

  static <A, B, C, D, E, F> CharacterFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> CharacterFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends CharacterFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new CharacterMethodReference6<A, B, C, D, E, F>(this);
