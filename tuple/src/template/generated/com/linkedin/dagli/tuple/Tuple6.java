...
/**
 * An ordered sequence of 6 elements.
 */
public interface Tuple6<A, B, C, D, E, F> extends Tuple, TupleValue0<A>, TupleValue1<B>, TupleValue2<C>,
    TupleValue3<D>, TupleValue4<E>, TupleValue5<F> {
  /**
   ...
   */
  default <Z> Tuple6<Z, B, C, D, E, F> withValue0(Z value) {
    return of(value, get1(), get2(), get3(), get4(), get5());
  }
   ...
   */
  default <Z> Tuple6<A, Z, C, D, E, F> withValue1(Z value) {
    return of(get0(), value, get2(), get3(), get4(), get5());
  }
   ...
   */
  default <Z> Tuple6<A, B, Z, D, E, F> withValue2(Z value) {
    return of(get0(), get1(), value, get3(), get4(), get5());
  }
   ...
   */
  default <Z> Tuple6<A, B, C, Z, E, F> withValue3(Z value) {
    return of(get0(), get1(), get2(), value, get4(), get5());
  }
   ...
   */
  default <Z> Tuple6<A, B, C, D, Z, F> withValue4(Z value) {
    return of(get0(), get1(), get2(), get3(), value, get5());
  }
   ...
   */
  default <Z> Tuple6<A, B, C, D, E, Z> withValue5(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), value);
  }
  ...
  static <A, B, C, D, E, F> Tuple6<A, B, C, D, E, F> of(A element0, B element1, C element2, D element3, E element4,
      F element5) {
    return new FieldTuple6<>(element0, element1, element2, element3, element4, element5);
  }

  /**
   * Creates a new tuple that contains the given elements.  The tuple takes ownership of the provided array, which
   * should not be subsequently modified.  The array's length must be at least 6.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F> Tuple6<A, B, C, D, E, F> fromArrayUnsafe(Object[] elements) {
    return new ArrayTuple6<>(elements);
  }

  /**
   * Creates a new tuple containing the first 6 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 6 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F> Tuple6<A, B, C, D, E, F> fromIterableUnsafe(Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 6 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 6 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F> Tuple6<A, B, C, D, E, F> fromIteratorUnsafe(Iterator<?> elements) {
    return new FieldTuple6<A, B, C, D, E, F>((A) elements.next(), (B) elements.next(), (C) elements.next(),
        (D) elements.next(), (E) elements.next(), (F) elements.next());
  }
}
