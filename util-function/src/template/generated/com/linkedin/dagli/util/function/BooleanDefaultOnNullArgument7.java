...
class BooleanDefaultOnNullArgument7<A, B, C, D, E, F, G> implements BooleanFunction7.Serializable<A, B, C, D, E, F, G> {
  ...
  BooleanDefaultOnNullArgument7(BooleanFunction7<A, B, C, D, E, F, G> wrapped) {
    // stacking this wrapper multiple times should be idempotent:
    if (wrapped instanceof BooleanDefaultOnNullArgument7) {
      _wrapped = ((BooleanDefaultOnNullArgument7) wrapped)._wrapped;
    } else {
  ...
  @Override
  public BooleanDefaultOnNullArgument7<A, B, C, D, E, F, G> safelySerializable() {
    return new BooleanDefaultOnNullArgument7<>(
        ((BooleanFunction7.Serializable<A, B, C, D, E, F, G>) _wrapped).safelySerializable());
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof BooleanDefaultOnNullArgument7) {
