...
/**
 * An ordered sequence of 18 elements.
 */
public interface Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> extends Tuple, TupleValue0<A>,
    ...
    TupleValue14<O>, TupleValue15<P>, TupleValue16<Q>, TupleValue17<R> {
  /**
   ...
   */
  default <Z> Tuple18<Z, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> withValue0(Z value) {
    return of(value, get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(), get12(),
        get13(), get14(), get15(), get16(), get17());
  }
   ...
   */
  default <Z> Tuple18<A, Z, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> withValue1(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, Z, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> withValue2(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, Z, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> withValue3(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, Z, F, G, H, I, J, K, L, M, N, O, P, Q, R> withValue4(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, Z, G, H, I, J, K, L, M, N, O, P, Q, R> withValue5(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, Z, H, I, J, K, L, M, N, O, P, Q, R> withValue6(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, Z, I, J, K, L, M, N, O, P, Q, R> withValue7(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, Z, J, K, L, M, N, O, P, Q, R> withValue8(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, Z, K, L, M, N, O, P, Q, R> withValue9(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, Z, L, M, N, O, P, Q, R> withValue10(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, Z, M, N, O, P, Q, R> withValue11(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, Z, N, O, P, Q, R> withValue12(Z value) {
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, Z, O, P, Q, R> withValue13(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), value, get14(), get15(), get16(), get17());
  }
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, Z, P, Q, R> withValue14(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), value, get15(), get16(), get17());
  }
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Z, Q, R> withValue15(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), get14(), value, get16(), get17());
  }
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Z, R> withValue16(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), get14(), get15(), value, get17());
  }
   ...
   */
  default <Z> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, Z> withValue17(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), get14(), get15(), get16(), value);
  }
  ...
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> of(
    ...
    return new FieldTuple18<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
   ...
   * should not be subsequently modified.  The array's length must be at least 18.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> fromArrayUnsafe(
      Object[] elements) {
    return new ArrayTuple18<>(elements);
  }

  /**
   * Creates a new tuple containing the first 18 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 18 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> fromIterableUnsafe(
      Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 18 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 18 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> fromIteratorUnsafe(
      Iterator<?> elements) {
    return new FieldTuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R>((A) elements.next(),
        ...
        (Q) elements.next(), (R) elements.next());
  }
}
