 ...
 *
 * DAG2x5 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG2x5 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG2x5<A, B, RA, RB, RC, RD, RE>
    extends
    AbstractPreparableTransformer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>, DAG2x5<A, B, RA, RB, RC, RD, RE>>
    implements
    PreparableDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>, DAG2x5<A, B, RA, RB, RC, RD, RE>> {
   ...
   */
  DAG2x5(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1, Producer<? extends B> input2) {
    super(input1, input2);
    _dag = dag;
   ...
   */
  @Override
  public DAG2x5<A, B, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>, DAG2x5<A, B, RA, RB, RC, RD, RE>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>, DAG2x5<A, B, RA, RB, RC, RD, RE>> {
    @Override
    ...
    @Override
    public DAG2x5<A, B, RA, RB, RC, RD, RE> getInstance() {
      return DAG2x5.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG2x5<A, B, RA, RB, RC, RD, RE>>> getGraphReducers() {
   ...
   */
  public DAG2x5<A, B, RA, RB, RC, RD, RE> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG2x5<A, B, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1, Producer<? extends B> input2) {
   ...
   */
  public DAG1x5<B, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG2x5<A, B, RA, RB, RC, RD, RE> dag = this.withInputs(generator, nestedPlaceholder2);

    return DAG
        .withPlaceholder(nestedPlaceholder2)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag)).withExecutor(_executor).withInput(getInput2());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG1x5<A, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    DAG2x5<A, B, RA, RB, RC, RD, RE> dag = this.withInputs(nestedPlaceholder1, generator);

    return DAG
        .withPlaceholder(nestedPlaceholder1)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag)).withExecutor(_executor).withInput(getInput1());
  }
   ...
   * @param <RE> the type of the fifth result
   */
  private static class Preparer<A, B, RA, RB, RC, RD, RE> extends
      AbstractBatchPreparer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> {
    // the DAG being prepared
    private final DAG2x5<A, B, RA, RB, RC, RD, RE> _dag;
     ...
     */
    Preparer(DAG2x5<A, B, RA, RB, RC, RD, RE> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer2<A, B, Tuple5<RA, RB, RC, RD, RE>>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> finish(
  ...
  @Override
  protected Preparer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, RA, RB, RC, RD, RE> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2) {
    DAGExecutionResult<Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) });
    return new Result<>((DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>) res.getPreparerResult()
   ...
   */
  public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2) {
    return (DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>) _executor.internalAPI()
  ...
  * @param <RE> the type of the fifth result
   */
  public static final class Result<A, B, RA, RB, RC, RD, RE> extends AbstractDAGResult5<RA, RB, RC, RD, RE> {
    // the prepared DAG
    private final DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RE> the type of the fifth result
   */
  @ValueEquality
  public static class Prepared<A, B, RA, RB, RC, RD, RE> extends
      AbstractPreparedTransformer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>>
      implements PreparedDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> {
    ...
    * @param input2 the {@link Producer} providing the second input to the transformer
     ...
     */
    @Override
    public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer2<A, B, Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>> {
      @Override
      public DAGStructure<Tuple5<RA, RB, RC, RD, RE>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> getInstance() {
        return DAG2x5.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG1x5.Prepared<B, RA, RB, RC, RD, RE> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> dag = this.withInputs(generator, nestedPlaceholder2);
     ...
     *         the produced by the provided generator
     */
    public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      DAG2x5.Prepared<A, B, RA, RB, RC, RD, RE> dag = this.withInputs(nestedPlaceholder1, generator);
    ...
    @Override
    public Tuple5<RA, RB, RC, RD, RE> apply(A value1, B value2) {
      try (
