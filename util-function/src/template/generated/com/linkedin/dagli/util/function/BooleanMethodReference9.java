 ...
 */
class BooleanMethodReference9<A, B, C, D, E, F, G, H, I> implements
  ...
  private static final int CLASS_HASH = BooleanMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  BooleanMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof BooleanMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference9) func)._methodReference;
    } else {
  ...
  private BooleanFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new BooleanMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference9) obj)._methodReference);
  }
