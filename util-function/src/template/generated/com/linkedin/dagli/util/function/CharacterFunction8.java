...
@FunctionalInterface
public interface CharacterFunction8<A, B, C, D, E, F, G, H> extends FunctionBase {
  char apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8);
   ...
   */
  default CharacterFunction8<A, B, C, D, E, F, G, H> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument8<>(this);
  }

  static <A, B, C, D, E, F, G, H> CharacterFunction8<A, B, C, D, E, F, G, H> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, H, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction8.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H> CharacterFunction8.Serializable<A, B, C, D, E, F, G, H> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H> extends CharacterFunction8<A, B, C, D, E, F, G, H>,
    ...
    default Serializable<A, B, C, D, E, F, G, H> safelySerializable() {
      try {
        return new CharacterMethodReference8<A, B, C, D, E, F, G, H>(this);
