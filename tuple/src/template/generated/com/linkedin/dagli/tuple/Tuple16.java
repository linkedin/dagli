...
/**
 * An ordered sequence of 16 elements.
 */
public interface Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> extends Tuple, TupleValue0<A>, TupleValue1<B>,
    TupleValue2<C>, TupleValue3<D>, TupleValue4<E>, TupleValue5<F>, TupleValue6<G>, TupleValue7<H>, TupleValue8<I>,
    TupleValue9<J>, TupleValue10<K>, TupleValue11<L>, TupleValue12<M>, TupleValue13<N>, TupleValue14<O>,
    TupleValue15<P> {
  /**
   ...
   */
  default <Z> Tuple16<Z, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> withValue0(Z value) {
   ...
   */
  default <Z> Tuple16<A, Z, C, D, E, F, G, H, I, J, K, L, M, N, O, P> withValue1(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, Z, D, E, F, G, H, I, J, K, L, M, N, O, P> withValue2(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, Z, E, F, G, H, I, J, K, L, M, N, O, P> withValue3(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, Z, F, G, H, I, J, K, L, M, N, O, P> withValue4(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, Z, G, H, I, J, K, L, M, N, O, P> withValue5(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, Z, H, I, J, K, L, M, N, O, P> withValue6(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, Z, I, J, K, L, M, N, O, P> withValue7(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, Z, J, K, L, M, N, O, P> withValue8(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, Z, K, L, M, N, O, P> withValue9(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, Z, L, M, N, O, P> withValue10(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, K, Z, M, N, O, P> withValue11(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, Z, N, O, P> withValue12(Z value) {
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, Z, O, P> withValue13(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), value, get14(), get15());
  }
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, Z, P> withValue14(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), value, get15());
  }
   ...
   */
  default <Z> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Z> withValue15(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), get14(), value);
  }
  ...
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> of(
    ...
    return new FieldTuple16<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
   ...
   * should not be subsequently modified.  The array's length must be at least 16.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> fromArrayUnsafe(
      Object[] elements) {
    return new ArrayTuple16<>(elements);
  }

  /**
   * Creates a new tuple containing the first 16 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 16 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> fromIterableUnsafe(
      Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 16 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 16 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> Tuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> fromIteratorUnsafe(
      Iterator<?> elements) {
    return new FieldTuple16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P>((A) elements.next(), (B) elements.next(),
        ...
        (M) elements.next(), (N) elements.next(), (O) elements.next(), (P) elements.next());
  }
}
