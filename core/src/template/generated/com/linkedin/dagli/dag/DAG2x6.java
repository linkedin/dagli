 ...
 *
 * DAG2x6 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG2x6 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG2x6<A, B, RA, RB, RC, RD, RE, RF>
    extends
    AbstractPreparableTransformer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>, DAG2x6<A, B, RA, RB, RC, RD, RE, RF>>
    implements
    PreparableDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>, DAG2x6<A, B, RA, RB, RC, RD, RE, RF>> {
   ...
   */
  DAG2x6(DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> dag, Producer<? extends A> input1, Producer<? extends B> input2) {
    super(input1, input2);
    _dag = dag;
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>, DAG2x6<A, B, RA, RB, RC, RD, RE, RF>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>, DAG2x6<A, B, RA, RB, RC, RD, RE, RF>> {
    @Override
   ...
   */
  public DAG2x6<A, B, RA, RB, RC, RD, RE, RF> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG2x6<A, B, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1, Producer<? extends B> input2) {
  ...
  public DAG1x6<B, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG2x6<A, B, RA, RB, RC, RD, RE, RF> dag = this.withInputs(generator, nestedPlaceholder2);
  ...
  public DAG1x6<A, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
    ...
    DAG2x6<A, B, RA, RB, RC, RD, RE, RF> dag = this.withInputs(nestedPlaceholder1, generator);
   ...
   * @param <RF> the type of the sixth result
   */
  private static class Preparer<A, B, RA, RB, RC, RD, RE, RF> extends
      AbstractBatchPreparer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> {
     ...
     */
    Preparer(DAG2x6<A, B, RA, RB, RC, RD, RE, RF> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> finish(
  ...
  @Override
  protected Preparer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, RA, RB, RC, RD, RE, RF> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    DAGExecutionResult<Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2) });
    return new Result<>((DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>) res.getPreparerResult()
   ...
   */
  public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2) {
    return (DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>) _executor.internalAPI()
  ...
  * @param <RF> the type of the sixth result
  ...
  public static final class Result<A, B, RA, RB, RC, RD, RE, RF> extends AbstractDAGResult6<RA, RB, RC, RD, RE, RF> {
    // the prepared DAG
    private final DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RF> the type of the sixth result
   */
  @ValueEquality
  public static class Prepared<A, B, RA, RB, RC, RD, RE, RF> extends
      AbstractPreparedTransformer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>>
      implements PreparedDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> {
    ...
    * @param input2 the {@link Producer} providing the second input to the transformer
     ...
     */
    @Override
    public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer2<A, B, Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>> {
      @Override
      public DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> getInstance() {
        return DAG2x6.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2) {
      return super.withAllInputs(input1, input2);
    }
    ...
    public DAG1x6.Prepared<B, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> dag = this.withInputs(generator, nestedPlaceholder2);
    ...
    public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> dag = this.withInputs(nestedPlaceholder1, generator);
    ...
    @Override
    public Tuple6<RA, RB, RC, RD, RE, RF> apply(A value1, B value2) {
      try (
