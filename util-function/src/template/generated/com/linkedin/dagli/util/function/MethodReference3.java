 ...
 */
class MethodReference3<A, B, C, R> implements Function3.Serializable<A, B, C, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference3.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function3<A, B, C, R> _cachedFunction = null;

  MethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference3(Serializable<A, B, C, R> func) {
    if (func instanceof MethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference3) func)._methodReference;
    } else {
  ...
  private Function3<A, B, C, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference4<Object, A, B, C, R> unbound = new MethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function3<A, B, C, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function3.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference3)) {
      return false;
    }

    return _methodReference.equals(((MethodReference3) obj)._methodReference);
  }
