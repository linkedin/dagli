 ...
 *
 * DAG3x7 is a <i>preparable</i> DAG.
 *
 ...
 */
@ValueEquality
public class DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>, DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>>
    implements
    PreparableDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>, DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>> {
   ...
   */
  DAG3x7(DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>, DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>, DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>> {
    @Override
    ...
    @Override
    public DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> getInstance() {
      return DAG3x7.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
   ...
   */
  public DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3) {
   ...
   */
  public DAG2x7<B, C, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG2x7<A, C, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG2x7<A, B, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag =
   ...
   * @param <RG> the type of the seventh result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractBatchPreparer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> {
    // the DAG being prepared
    private final DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> _dag;
     ...
     */
    Preparer(DAG3x7<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE, RF, RG> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> res =
    ...
    return new Result<>((DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>) res.getPreparerResult()
   ...
   */
  public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RG> the type of the seventh result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE, RF, RG> extends
      AbstractDAGResult7<RA, RB, RC, RD, RE, RF, RG> {
    // the prepared DAG
    private final DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RG> the type of the seventh result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractPreparedTransformer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>>
      implements
      PreparedDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>> {
      @Override
      public DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> getInstance() {
        return DAG3x7.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x7.Prepared<B, C, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x7.Prepared<A, C, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag =
          this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x7.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x7.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG> dag =
          this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    @Override
    public Tuple7<RA, RB, RC, RD, RE, RF, RG> apply(A value1, B value2, C value3) {
      try (
