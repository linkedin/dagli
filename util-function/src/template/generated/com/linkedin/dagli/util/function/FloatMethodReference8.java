 ...
 */
class FloatMethodReference8<A, B, C, D, E, F, G, H> implements FloatFunction8.Serializable<A, B, C, D, E, F, G, H> {
  ...
  private static final int CLASS_HASH = FloatMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  FloatMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof FloatMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference8) func)._methodReference;
    } else {
  ...
  private FloatFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new FloatMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference8) obj)._methodReference);
  }
