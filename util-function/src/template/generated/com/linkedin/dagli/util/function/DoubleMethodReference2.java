 ...
 */
class DoubleMethodReference2<A, B> implements DoubleFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction2<A, B> _cachedFunction = null;

  DoubleMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference2(Serializable<A, B> func) {
    if (func instanceof DoubleMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference2) func)._methodReference;
    } else {
  ...
  private DoubleFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference3<Object, A, B> unbound = new DoubleMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction2.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference2) obj)._methodReference);
  }
