 ...
 * {@link PreparerMode#STREAM} modes, it should derive from {@link AbstractBatchPreparer6} or
 * {@link AbstractStreamPreparer6} instead.
 *
 ...
 */
public abstract class AbstractPreparer6<A, B, C, D, E, F, R, N extends PreparedTransformer6<A, B, C, D, E, F, R>>
    extends AbstractPreparer<R, N> implements Preparer6<A, B, C, D, E, F, R, N> {

  @Override
  public final void processUnsafe(Object[] values) {
    Preparer6.super.processUnsafe(values);
  }

  @Override
  public final PreparerResultMixed<? extends PreparedTransformer6<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return Preparer6.super.finishUnsafe(inputs);
  }
}
