...
@FunctionalInterface
public interface VoidFunction9<A, B, C, D, E, F, G, H, I> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9);
   ...
   */
  default VoidFunction9<A, B, C, D, E, F, G, H, I> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument9<>(this);
  }

  static <A, B, C, D, E, F, G, H, I> VoidFunction9<A, B, C, D, E, F, G, H, I> unchecked(
    ...
    return (A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, D, E, F, G, H, I, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction9.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I> VoidFunction9.Serializable<A, B, C, D, E, F, G, H, I> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I> extends VoidFunction9<A, B, C, D, E, F, G, H, I>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I> safelySerializable() {
      try {
        return new VoidMethodReference9<A, B, C, D, E, F, G, H, I>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H, I> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument9<>(this);
    }
