...
@FunctionalInterface
public interface ByteFunction4<A, B, C, D> extends FunctionBase {
  byte apply(A value1, B value2, C value3, D value4);
   ...
   */
  default ByteFunction4<A, B, C, D> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument4<>(this);
  }

  static <A, B, C, D> ByteFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    byte apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ByteFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> ByteFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends ByteFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new ByteMethodReference4<A, B, C, D>(this);
