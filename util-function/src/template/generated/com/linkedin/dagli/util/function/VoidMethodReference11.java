 ...
 */
class VoidMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
  ...
  VoidMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof VoidMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference11) func)._methodReference;
    } else {
  ...
  private VoidFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {
    ...
    try {
      ...
      return (VoidFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction11.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9,
      J value10, K value11) {
    _cachedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((VoidMethodReference11) obj)._methodReference);
  }
