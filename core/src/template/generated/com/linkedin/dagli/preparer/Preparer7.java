...
public interface Preparer7<A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>> extends
    Preparer<R, N> {
  @Override
  ...
  default PreparerResultMixed<? extends PreparedTransformer7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R>, N> finishUnsafe(
    ...
    return finish(inputs == null ? null : inputs.lazyMap(Tuple7::fromArrayUnsafe));
  }
   ...
   */
  PreparerResultMixed<? extends PreparedTransformer7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R>, N> finish(
  ...
  static <A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>> Preparer7<A, B, C, D, E, F, G, R, N> cast(
      Preparer7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R, ? extends N> preparer) {
    // safe due to semantics of preparers:
    return (Preparer7<A, B, C, D, E, F, G, R, N>) preparer;
  }
}
