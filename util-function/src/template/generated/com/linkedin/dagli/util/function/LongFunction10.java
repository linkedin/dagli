...
@FunctionalInterface
public interface LongFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default LongFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new LongDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> LongFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement LongFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> LongFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends LongFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new LongMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
