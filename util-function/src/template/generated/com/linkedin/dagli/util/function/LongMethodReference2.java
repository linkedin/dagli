 ...
 */
class LongMethodReference2<A, B> implements LongFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction2<A, B> _cachedFunction = null;

  LongMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference2(Serializable<A, B> func) {
    if (func instanceof LongMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference2) func)._methodReference;
    } else {
  ...
  private LongFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference3<Object, A, B> unbound = new LongMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction2.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference2) obj)._methodReference);
  }
