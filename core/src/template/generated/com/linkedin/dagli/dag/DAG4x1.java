 ...
 *
 * DAG4x1 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x1 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x1<A, B, C, D, RA> extends
    AbstractPreparableTransformer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>, DAG4x1<A, B, C, D, RA>> implements
    PreparableDAGTransformer<RA, DAG4x1.Prepared<A, B, C, D, RA>, DAG4x1<A, B, C, D, RA>> {
   ...
   */
  DAG4x1(DAGStructure<RA> dag, Producer<? extends A> input1, Producer<? extends B> input2,
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>, DAG4x1<A, B, C, D, RA>>.InternalAPI
      implements PreparableDAGTransformer.InternalAPI<RA, DAG4x1.Prepared<A, B, C, D, RA>, DAG4x1<A, B, C, D, RA>> {
    @Override
   ...
   */
  public DAG4x1<A, B, C, D, RA> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x1<A, B, C, D, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4) {
  ...
  public DAG3x1<B, C, D, RA> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG4x1<A, B, C, D, RA> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);

    return DAG.withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4).withOutput(dag)
  ...
  public DAG3x1<A, C, D, RA> withGeneratorAsInput2(Generator<B> generator) {
    ...
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x1<A, B, C, D, RA> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3, nestedPlaceholder4);

    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4).withOutput(dag)
  ...
  public DAG3x1<A, B, D, RA> withGeneratorAsInput3(Generator<C> generator) {
    ...
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x1<A, B, C, D, RA> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator, nestedPlaceholder4);

    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4).withOutput(dag)
  ...
  public DAG3x1<A, B, C, RA> withGeneratorAsInput4(Generator<D> generator) {
    ...
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x1<A, B, C, D, RA> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, generator);

    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3).withOutput(dag)
   ...
   * @param <RA> the type of the first result
   */
  private static class Preparer<A, B, C, D, RA> extends
      AbstractBatchPreparer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>> {
     ...
     */
    Preparer(DAG4x1<A, B, C, D, RA> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, RA>, DAG4x1.Prepared<A, B, C, D, RA>> finish(
  ...
  @Override
  protected Preparer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>> getPreparer(PreparerContext context) {
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<RA, DAG4x1.Prepared<A, B, C, D, RA>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x1.Prepared<A, B, C, D, RA>) res.getPreparerResult().getPreparedTransformerForNewData(),
        res.getOutputs());
  }
   ...
   */
  public DAG4x1.Prepared<A, B, C, D, RA> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x1.Prepared<A, B, C, D, RA>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RA> the type of the first result
  ...
  public static final class Result<A, B, C, D, RA> extends AbstractDAGResult1<RA> {
    // the prepared DAG
    private final DAG4x1.Prepared<A, B, C, D, RA> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x1.Prepared<A, B, C, D, RA> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x1.Prepared<A, B, C, D, RA> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RA> the type of the first result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA> extends
      AbstractPreparedTransformer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>> implements
      PreparedDAGTransformer<RA, DAG4x1.Prepared<A, B, C, D, RA>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x1.Prepared<A, B, C, D, RA> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer4<A, B, C, D, RA, DAG4x1.Prepared<A, B, C, D, RA>>.InternalAPI implements
        PreparedDAGTransformer.InternalAPI<RA, DAG4x1.Prepared<A, B, C, D, RA>> {
      @Override
      public DAGStructure<RA> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x1.Prepared<A, B, C, D, RA> getInstance() {
        return DAG4x1.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x1.Prepared<A, B, C, D, RA>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x1.Prepared<A, B, C, D, RA> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x1.Prepared<A, B, C, D, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
        Producer<? extends C> input3, Producer<? extends D> input4) {
      return super.withAllInputs(input1, input2, input3, input4);
    }
    ...
    public DAG3x1.Prepared<B, C, D, RA> withGeneratorAsInput1(Generator<A> generator) {
      ...
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x1.Prepared<A, B, C, D, RA> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);

      return DAG.Prepared.withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4).withOutput(dag)
          .withExecutor(_executor).withInputs(getInput2(), getInput3(), getInput4());
    }
    ...
    public DAG3x1.Prepared<A, C, D, RA> withGeneratorAsInput2(Generator<B> generator) {
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4).withOutput(dag)
          .withExecutor(_executor).withInputs(getInput1(), getInput3(), getInput4());
    }
    ...
    public DAG3x1.Prepared<A, B, D, RA> withGeneratorAsInput3(Generator<C> generator) {
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4).withOutput(dag)
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput4());
    }
    ...
    public DAG3x1.Prepared<A, B, C, RA> withGeneratorAsInput4(Generator<D> generator) {
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3).withOutput(dag)
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3());
    }
    ...
    @Override
    public RA apply(A value1, B value2, C value3, D value4) {
      try (
