 ...
 *
 * DAG4x3 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG4x3 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG4x3<A, B, C, D, RA, RB, RC>
    extends
    AbstractPreparableTransformer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>, DAG4x3<A, B, C, D, RA, RB, RC>>
    implements
    PreparableDAGTransformer<Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>, DAG4x3<A, B, C, D, RA, RB, RC>> {
   ...
   */
  DAG4x3(DAGStructure<Tuple3<RA, RB, RC>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG4x3<A, B, C, D, RA, RB, RC> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>, DAG4x3<A, B, C, D, RA, RB, RC>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>, DAG4x3<A, B, C, D, RA, RB, RC>> {
    @Override
    ...
    @Override
    public DAG4x3<A, B, C, D, RA, RB, RC> getInstance() {
      return DAG4x3.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG4x3<A, B, C, D, RA, RB, RC>>> getGraphReducers() {
   ...
   */
  public DAG4x3<A, B, C, D, RA, RB, RC> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG4x3<A, B, C, D, RA, RB, RC> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4) {
   ...
   */
  public DAG3x3<B, C, D, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG4x3<A, B, C, D, RA, RB, RC> dag =
        this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);

    return DAG.withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4)
   ...
   *         the produced by the provided generator
   */
  public DAG3x3<A, C, D, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
   ...
   *         the produced by the provided generator
   */
  public DAG3x3<A, B, D, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    DAG4x3<A, B, C, D, RA, RB, RC> dag =
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
   ...
   *         the produced by the provided generator
   */
  public DAG3x3<A, B, C, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG4x3<A, B, C, D, RA, RB, RC> dag =
    ...
    return DAG.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
   ...
   * @param <RC> the type of the third result
   */
  private static class Preparer<A, B, C, D, RA, RB, RC> extends
      AbstractBatchPreparer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> {
    // the DAG being prepared
    private final DAG4x3<A, B, C, D, RA, RB, RC> _dag;
     ...
     */
    Preparer(DAG4x3<A, B, C, D, RA, RB, RC> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer4<A, B, C, D, Tuple3<RA, RB, RC>>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> finish(
  ...
  @Override
  protected Preparer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, RA, RB, RC> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    DAGExecutionResult<Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    .wrap(values4) });
    return new Result<>((DAG4x3.Prepared<A, B, C, D, RA, RB, RC>) res.getPreparerResult()
   ...
   */
  public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4) {
    return (DAG4x3.Prepared<A, B, C, D, RA, RB, RC>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RC> the type of the third result
   */
  public static final class Result<A, B, C, D, RA, RB, RC> extends AbstractDAGResult3<RA, RB, RC> {
    // the prepared DAG
    private final DAG4x3.Prepared<A, B, C, D, RA, RB, RC> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG4x3.Prepared<A, B, C, D, RA, RB, RC> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RC> the type of the third result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, RA, RB, RC> extends
      AbstractPreparedTransformer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> implements
      PreparedDAGTransformer<Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> {
    ...
    * @param input4 the {@link Producer} providing the fourth input to the transformer
     ...
     */
    @Override
    public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer4<A, B, C, D, Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG4x3.Prepared<A, B, C, D, RA, RB, RC>> {
      @Override
      public DAGStructure<Tuple3<RA, RB, RC>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> getInstance() {
        return DAG4x3.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG4x3.Prepared<A, B, C, D, RA, RB, RC>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG4x3.Prepared<A, B, C, D, RA, RB, RC> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG3x3.Prepared<B, C, D, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x3.Prepared<A, B, C, D, RA, RB, RC> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4);

      return DAG.Prepared.withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4)
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput2(), getInput3(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x3.Prepared<A, C, D, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x3.Prepared<A, B, C, D, RA, RB, RC> dag =
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder3, nestedPlaceholder4)
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput3(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x3.Prepared<A, B, D, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      DAG4x3.Prepared<A, B, C, D, RA, RB, RC> dag =
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder4)
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput4());
    }
     ...
     *         the produced by the provided generator
     */
    public DAG3x3.Prepared<A, B, C, RA, RB, RC> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG4x3.Prepared<A, B, C, D, RA, RB, RC> dag =
      ...
      return DAG.Prepared.withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3)
          .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag))
          .withExecutor(_executor).withInputs(getInput1(), getInput2(), getInput3());
    }
    ...
    @Override
    public Tuple3<RA, RB, RC> apply(A value1, B value2, C value3, D value4) {
      try (
