...
/**
 * A function class implementing {@link IntFunction8.Serializable} that composes
 * {@link IntFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class IntComposedFunction8<A, B, C, D, E, F, G, H, Q> implements IntFunction8.Serializable<A, B, C, D, E, F, G, H>,
    Named {
   ...
   *                as input
   */
  IntComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, IntFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public IntComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new IntComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(IntComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof IntComposedFunction8) {
      return this._first.equals(((IntComposedFunction8) obj)._first)
          && this._andThen.equals(((IntComposedFunction8) obj)._andThen);
    }
    return false;
  }
