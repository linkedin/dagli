...
/**
 * A function class implementing {@link FloatFunction9.Serializable} that composes
 * {@link FloatFunction9} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class FloatComposedFunction9<A, B, C, D, E, F, G, H, I, Q> implements
   ...
   *                as input
   */
  FloatComposedFunction9(Function9<A, B, C, D, E, F, G, H, I, Q> first, FloatFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public FloatComposedFunction9<A, B, C, D, E, F, G, H, I, Q> safelySerializable() {
    return new FloatComposedFunction9<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(FloatComposedFunction9.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof FloatComposedFunction9) {
      return this._first.equals(((FloatComposedFunction9) obj)._first)
          && this._andThen.equals(((FloatComposedFunction9) obj)._andThen);
    }
    return false;
  }
