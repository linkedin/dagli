 ...
 */
class MethodReference1<A, R> implements Function1.Serializable<A, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function1<A, R> _cachedFunction = null;

  MethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference1(Serializable<A, R> func) {
    if (func instanceof MethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference1) func)._methodReference;
    } else {
  ...
  private Function1<A, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference2<Object, A, R> unbound = new MethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function1<A, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference1)) {
      return false;
    }

    return _methodReference.equals(((MethodReference1) obj)._methodReference);
  }
