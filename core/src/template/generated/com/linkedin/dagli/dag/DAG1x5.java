 ...
 *
 * DAG1x5 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG1x5 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG1x5<A, RA, RB, RC, RD, RE>
    extends
    AbstractPreparableTransformer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>, DAG1x5<A, RA, RB, RC, RD, RE>>
    implements
    PreparableDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>, DAG1x5<A, RA, RB, RC, RD, RE>> {
   ...
   */
  DAG1x5(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1) {
    super(input1);
    _dag = dag;
   ...
   */
  @Override
  public DAG1x5<A, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>, DAG1x5<A, RA, RB, RC, RD, RE>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>, DAG1x5<A, RA, RB, RC, RD, RE>> {
    @Override
    ...
    @Override
    public DAG1x5<A, RA, RB, RC, RD, RE> getInstance() {
      return DAG1x5.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG1x5<A, RA, RB, RC, RD, RE>>> getGraphReducers() {
   ...
   */
  public DAG1x5<A, RA, RB, RC, RD, RE> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG1x5<A, RA, RB, RC, RD, RE> withInput(Producer<? extends A> input1) {
   ...
   * @param <RE> the type of the fifth result
   */
  private static class Preparer<A, RA, RB, RC, RD, RE> extends
      AbstractBatchPreparer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> {
    // the DAG being prepared
    private final DAG1x5<A, RA, RB, RC, RD, RE> _dag;
     ...
     */
    Preparer(DAG1x5<A, RA, RB, RC, RD, RE> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer1<A, Tuple5<RA, RB, RC, RD, RE>>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> finish(
  ...
  @Override
  protected Preparer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, RA, RB, RC, RD, RE> prepareAndApply(Iterable<? extends A> values1) {
    DAGExecutionResult<Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this, new ObjectReader[] { ObjectReader.wrap(values1) });
    return new Result<>((DAG1x5.Prepared<A, RA, RB, RC, RD, RE>) res.getPreparerResult()
   ...
   */
  public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> prepare(Iterable<? extends A> values1) {
    return (DAG1x5.Prepared<A, RA, RB, RC, RD, RE>) _executor.internalAPI()
  ...
  * @param <RE> the type of the fifth result
   */
  public static final class Result<A, RA, RB, RC, RD, RE> extends AbstractDAGResult5<RA, RB, RC, RD, RE> {
    // the prepared DAG
    private final DAG1x5.Prepared<A, RA, RB, RC, RD, RE> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG1x5.Prepared<A, RA, RB, RC, RD, RE> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RE> the type of the fifth result
   */
  @ValueEquality
  public static class Prepared<A, RA, RB, RC, RD, RE> extends
      AbstractPreparedTransformer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> implements
      PreparedDAGTransformer<Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> {
    ...
    * @param input1 the {@link Producer} providing the first input to the transformer
     */
    Prepared(DAGStructure<Tuple5<RA, RB, RC, RD, RE>> dag, Producer<? extends A> input1) {
      super(input1);
      _dag = dag;
      _executor = new LocalDAGExecutor();
    }
     ...
     */
    @Override
    public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer1<A, Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple5<RA, RB, RC, RD, RE>, DAG1x5.Prepared<A, RA, RB, RC, RD, RE>> {
      @Override
      public DAGStructure<Tuple5<RA, RB, RC, RD, RE>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> getInstance() {
        return DAG1x5.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG1x5.Prepared<A, RA, RB, RC, RD, RE>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parent
     */
    public DAG1x5.Prepared<A, RA, RB, RC, RD, RE> withInput(Producer<? extends A> input1) {
      return super.withAllInputs(input1);
    }
