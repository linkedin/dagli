 ...
 */
class ByteMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
    ByteFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> {
  ...
  private static final int CLASS_HASH = ByteMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  ByteMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof ByteMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference10) func)._methodReference;
    } else {
  ...
  private ByteFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new ByteMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference10) obj)._methodReference);
  }
