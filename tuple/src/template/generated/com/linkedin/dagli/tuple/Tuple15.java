...
/**
 * An ordered sequence of 15 elements.
 */
public interface Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> extends Tuple, TupleValue0<A>, TupleValue1<B>,
   ...
   */
  default <Z> Tuple15<Z, B, C, D, E, F, G, H, I, J, K, L, M, N, O> withValue0(Z value) {
   ...
   */
  default <Z> Tuple15<A, Z, C, D, E, F, G, H, I, J, K, L, M, N, O> withValue1(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, Z, D, E, F, G, H, I, J, K, L, M, N, O> withValue2(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, Z, E, F, G, H, I, J, K, L, M, N, O> withValue3(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, Z, F, G, H, I, J, K, L, M, N, O> withValue4(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, Z, G, H, I, J, K, L, M, N, O> withValue5(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, Z, H, I, J, K, L, M, N, O> withValue6(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, Z, I, J, K, L, M, N, O> withValue7(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, Z, J, K, L, M, N, O> withValue8(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, Z, K, L, M, N, O> withValue9(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, J, Z, L, M, N, O> withValue10(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, J, K, Z, M, N, O> withValue11(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, Z, N, O> withValue12(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, Z, O> withValue13(Z value) {
   ...
   */
  default <Z> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, Z> withValue14(Z value) {
    return of(get0(), get1(), get2(), get3(), get4(), get5(), get6(), get7(), get8(), get9(), get10(), get11(),
        get12(), get13(), value);
  }
  ...
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> of(
    ...
    return new FieldTuple15<>(element0, element1, element2, element3, element4, element5, element6, element7, element8,
   ...
   * should not be subsequently modified.  The array's length must be at least 15.
   *
   ...
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> fromArrayUnsafe(
      Object[] elements) {
    return new ArrayTuple15<>(elements);
  }

  /**
   * Creates a new tuple containing the first 15 elements of the provided iterable.
   *
   ...
   * @throws java.util.NoSuchElementException if there are fewer than 15 elements in the provided iterable.
   * @return a new tuple with the provided elements
   */
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> fromIterableUnsafe(
      Iterable<?> elements) {
  ...
  /**
   * Creates a new tuple containing the first 15 elements of the provided iterator.
   *
   * This method is "unsafe" because the iterated values cannot be type-checked to ensure that they conform to their
   * purported types.
   *
   * @param elements the iterator containing the elements to copy into a new tuple.
   * @throws java.util.NoSuchElementException if there are fewer than 15 elements in the provided iterator.
   * @return a new tuple with the provided elements
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> fromIteratorUnsafe(
      Iterator<?> elements) {
    return new FieldTuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>((A) elements.next(), (B) elements.next(),
        ...
        (M) elements.next(), (N) elements.next(), (O) elements.next());
  }
}
