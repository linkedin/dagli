 ...
 *
 * DAG3x6 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x6 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>, DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>>
    implements
    PreparableDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>, DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>> {
   ...
   */
  DAG3x6(DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>, DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>, DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>> {
    @Override
    ...
    @Override
    public DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> getInstance() {
      return DAG3x6.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
   ...
   */
  public DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3) {
   ...
   */
  public DAG2x6<B, C, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x6<A, C, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x6<A, B, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
   ...
   * @param <RF> the type of the sixth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE, RF> extends
      AbstractBatchPreparer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> {
    // the DAG being prepared
    private final DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> _dag;
     ...
     */
    Preparer(DAG3x6<A, B, C, RA, RB, RC, RD, RE, RF> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE, RF> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> res =
    ...
    return new Result<>((DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>) res.getPreparerResult()
   ...
   */
  public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RF> the type of the sixth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE, RF> extends AbstractDAGResult6<RA, RB, RC, RD, RE, RF> {
    // the prepared DAG
    private final DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RF> the type of the sixth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE, RF>
      extends
      AbstractPreparedTransformer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>>
      implements
      PreparedDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>> {
      @Override
      public DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> getInstance() {
        return DAG3x6.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x6.Prepared<B, C, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG2x6.Prepared<A, C, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> dag =
     ...
     *         the produced by the provided generator
     */
    public DAG2x6.Prepared<A, B, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x6.Prepared<A, B, C, RA, RB, RC, RD, RE, RF> dag =
    ...
    public Result<RA, RB, RC, RD, RE, RF> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
      ...
      return new Result<RA, RB, RC, RD, RE, RF>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) }));
    }

    @Override
    public Tuple6<RA, RB, RC, RD, RE, RF> apply(A value1, B value2, C value3) {
      try (
