 ...
 */
class ShortMethodReference6<A, B, C, D, E, F> implements ShortFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction6<A, B, C, D, E, F> _cachedFunction = null;

  ShortMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof ShortMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference6) func)._methodReference;
    } else {
  ...
  private ShortFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference7<Object, A, B, C, D, E, F> unbound = new ShortMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference6) obj)._methodReference);
  }
