...
@FunctionalInterface
public interface ByteFunction6<A, B, C, D, E, F> extends FunctionBase {
  byte apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default ByteFunction6<A, B, C, D, E, F> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument6<>(this);
  }

  static <A, B, C, D, E, F> ByteFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    byte apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ByteFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> ByteFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends ByteFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new ByteMethodReference6<A, B, C, D, E, F>(this);
