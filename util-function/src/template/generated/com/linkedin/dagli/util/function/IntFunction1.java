...
@FunctionalInterface
public interface IntFunction1<A> extends FunctionBase, ToIntFunction<A> {
  int apply(A value1);
   ...
   */
  default IntFunction1<A> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument1<>(this);
  }

  @Override
  default int applyAsInt(A value1) {
    return apply(value1);
  }

  static <A> IntFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement IntFunction1.Serializable should override this method
   ...
   */
  static <A> IntFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends IntFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new IntMethodReference1<A>(this);
