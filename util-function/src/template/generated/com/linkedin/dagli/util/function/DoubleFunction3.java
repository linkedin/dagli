...
@FunctionalInterface
public interface DoubleFunction3<A, B, C> extends FunctionBase {
  double apply(A value1, B value2, C value3);
   ...
   */
  default DoubleFunction3<A, B, C> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> DoubleFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    double apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> DoubleFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends DoubleFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new DoubleMethodReference3<A, B, C>(this);
