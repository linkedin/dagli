...
@FunctionalInterface
public interface IntFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default IntFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> IntFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement IntFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> IntFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends IntFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new IntMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
