...
@FunctionalInterface
public interface BooleanFunction4<A, B, C, D> extends FunctionBase {
  boolean apply(A value1, B value2, C value3, D value4);
   ...
   */
  default BooleanFunction4<A, B, C, D> returnFalseOnNullArgument() {
    return new BooleanDefaultOnNullArgument4<>(this);
  }

  default BooleanFunction4<A, B, C, D> negate() {
    return BooleanNegatedFunction4.negate(this);
  }

  static <A, B, C, D> BooleanFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> BooleanFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends BooleanFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new BooleanMethodReference4<A, B, C, D>(this);
    ...
    @Override
    default Serializable<A, B, C, D> returnFalseOnNullArgument() {
      return new BooleanDefaultOnNullArgument4<>(this);
    }

    @Override
    default Serializable<A, B, C, D> negate() {
      return BooleanNegatedFunction4.Serializable.negate(this);
    }
