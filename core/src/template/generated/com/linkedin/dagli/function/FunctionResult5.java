 ...
 */
@ValueEquality
public class FunctionResult5<A, B, C, D, E, R> extends
  ...
  @Override
  public R apply(A input1, B input2, C input3, D input4, E input5) {
    return _function.apply(input1, input2, input3, input4, input5);
  }

  /**
   * Returns a new {@link FunctionResult5} that composes this instance's function with another "mapper" function such
   ...
   * @return a new {@link FunctionResult5} that composes this instance's function with another "mapper" function
   */
