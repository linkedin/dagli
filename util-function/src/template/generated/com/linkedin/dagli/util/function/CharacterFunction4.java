...
@FunctionalInterface
public interface CharacterFunction4<A, B, C, D> extends FunctionBase {
  char apply(A value1, B value2, C value3, D value4);
   ...
   */
  default CharacterFunction4<A, B, C, D> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument4<>(this);
  }

  static <A, B, C, D> CharacterFunction4<A, B, C, D> unchecked(Checked<A, B, C, D, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3, D value4) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction4.Serializable should override this method
   ...
   */
  static <A, B, C, D> CharacterFunction4.Serializable<A, B, C, D> safelySerializable(Serializable<A, B, C, D> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D> extends CharacterFunction4<A, B, C, D>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D> safelySerializable() {
      try {
        return new CharacterMethodReference4<A, B, C, D>(this);
