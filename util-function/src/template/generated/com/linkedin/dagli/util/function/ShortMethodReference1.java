 ...
 */
class ShortMethodReference1<A> implements ShortFunction1.Serializable<A>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction1<A> _cachedFunction = null;

  ShortMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference1(Serializable<A> func) {
    if (func instanceof ShortMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference1) func)._methodReference;
    } else {
  ...
  private ShortFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference2<Object, A> unbound = new ShortMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference1)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference1) obj)._methodReference);
  }
