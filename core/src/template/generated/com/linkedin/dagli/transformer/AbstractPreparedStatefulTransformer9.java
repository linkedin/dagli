...
/**
 * Base class for prepared transformers of arity 9 that extends {@link AbstractPreparedTransformer9} to
 ...
 */
public abstract class AbstractPreparedStatefulTransformer9<A, B, C, D, E, F, G, H, I, R, Q, S extends AbstractPreparedTransformer9<A, B, C, D, E, F, G, H, I, R, S>>
    extends AbstractPreparedTransformer9<A, B, C, D, E, F, G, H, I, R, S> {

  private static final long serialVersionUID = 1;

  public AbstractPreparedStatefulTransformer9() {
    super();
  }

  public AbstractPreparedStatefulTransformer9(Producer<? extends A> input1, Producer<? extends B> input2,
  ...
  protected void applyAll(Q executionCache, List<? extends A> values1, List<? extends B> values2,
    ...
    for (int i = 0; i < values1.size(); i++) {
      results.add(apply(executionCache, values1.get(i), values2.get(i), values3.get(i), values4.get(i), values5.get(i),
          values6.get(i), values7.get(i), values8.get(i), values9.get(i)));
    }
  }
  ...
  protected class InternalAPI extends AbstractPreparedTransformer9<A, B, C, D, E, F, G, H, I, R, S>.InternalAPI {
    @Override
    public R apply(Object executionCache, A value1, B value2, C value3, D value4, E value5, F value6, G value7,
        H value8, I value9) {
      return AbstractPreparedStatefulTransformer9.this.apply((Q) executionCache, value1, value2, value3, value4,
          value5, value6, value7, value8, value9);
    }

    @Override
    public Object createExecutionCache(long exampleCountGuess) {
      return AbstractPreparedStatefulTransformer9.this.createExecutionCache(exampleCountGuess);
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, Object[][] values, Object[] results) {
      AbstractPreparedStatefulTransformer9.this.applyAll((Q) executionCache, new UnmodifiableArrayList<>(
          ...
          (I[]) values[8], count), new FixedCapacityArrayList<>(results));
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, List<? extends List<?>> values, List<? super R> results) {
      AbstractPreparedStatefulTransformer9.this.applyAll((Q) executionCache,
          ...
          (List<I>) Lists.limit(values.get(8), count), results);
    }

    @Override
    public int getPreferredMinibatchSize() {
      return AbstractPreparedStatefulTransformer9.this.getPreferredMinibatchSize();
    }
  }
}
