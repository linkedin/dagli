 ...
 *
 * DAG6x1 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG6x1 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG6x1<A, B, C, D, E, F, RA>
    extends
    AbstractPreparableTransformer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>, DAG6x1<A, B, C, D, E, F, RA>>
    implements PreparableDAGTransformer<RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>, DAG6x1<A, B, C, D, E, F, RA>> {
   ...
   */
  DAG6x1(DAGStructure<RA> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG6x1<A, B, C, D, E, F, RA> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>, DAG6x1<A, B, C, D, E, F, RA>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>, DAG6x1<A, B, C, D, E, F, RA>> {
    @Override
    ...
    @Override
    public DAG6x1<A, B, C, D, E, F, RA> getInstance() {
      return DAG6x1.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG6x1<A, B, C, D, E, F, RA>>> getGraphReducers() {
   ...
   */
  public DAG6x1<A, B, C, D, E, F, RA> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG6x1<A, B, C, D, E, F, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6) {
   ...
   */
  public DAG5x1<B, C, D, E, F, RA> withGeneratorAsInput1(Generator<A> generator) {
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
            nestedPlaceholder6).withOutput(dag).withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG5x1<A, C, D, E, F, RA> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG5x1<A, B, D, E, F, RA> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x1<A, B, C, E, F, RA> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x1<A, B, C, D, F, RA> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG5x1<A, B, C, D, E, RA> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5).withOutput(dag).withExecutor(_executor)
   ...
   * @param <RA> the type of the first result
   */
  private static class Preparer<A, B, C, D, E, F, RA> extends
      AbstractBatchPreparer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> {
    // the DAG being prepared
    private final DAG6x1<A, B, C, D, E, F, RA> _dag;
     ...
     */
    Preparer(DAG6x1<A, B, C, D, E, F, RA> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer6<A, B, C, D, E, F, RA>, DAG6x1.Prepared<A, B, C, D, E, F, RA>> finish(
  ...
  @Override
  protected Preparer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> getPreparer(PreparerContext context) {
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, RA> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5,
      Iterable<? extends F> values6) {
    DAGExecutionResult<RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG6x1.Prepared<A, B, C, D, E, F, RA>) res.getPreparerResult()
   ...
   */
  public DAG6x1.Prepared<A, B, C, D, E, F, RA> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5,
      Iterable<? extends F> values6) {
    return (DAG6x1.Prepared<A, B, C, D, E, F, RA>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RA> the type of the first result
   */
  public static final class Result<A, B, C, D, E, F, RA> extends AbstractDAGResult1<RA> {
    // the prepared DAG
    private final DAG6x1.Prepared<A, B, C, D, E, F, RA> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG6x1.Prepared<A, B, C, D, E, F, RA> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG6x1.Prepared<A, B, C, D, E, F, RA> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RA> the type of the first result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, RA> extends
      AbstractPreparedTransformer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> implements
      PreparedDAGTransformer<RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> {
    ...
    * @param input6 the {@link Producer} providing the sixth input to the transformer
     ...
     */
    @Override
    public DAG6x1.Prepared<A, B, C, D, E, F, RA> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer6<A, B, C, D, E, F, RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>>.InternalAPI implements
        PreparedDAGTransformer.InternalAPI<RA, DAG6x1.Prepared<A, B, C, D, E, F, RA>> {
      @Override
      public DAGStructure<RA> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG6x1.Prepared<A, B, C, D, E, F, RA> getInstance() {
        return DAG6x1.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG6x1.Prepared<A, B, C, D, E, F, RA>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG6x1.Prepared<A, B, C, D, E, F, RA> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG6x1.Prepared<A, B, C, D, E, F, RA> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
        Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
        Producer<? extends F> input6) {
      return super.withAllInputs(input1, input2, input3, input4, input5, input6);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<B, C, D, E, F, RA> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      DAG6x1.Prepared<A, B, C, D, E, F, RA> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6);
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<A, C, D, E, F, RA> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<A, B, D, E, F, RA> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<A, B, C, E, F, RA> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<A, B, C, D, F, RA> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG5x1.Prepared<A, B, C, D, E, RA> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public RA apply(A value1, B value2, C value3, D value4, E value5, F value6) {
      try (
