...
@FunctionalInterface
public interface ByteFunction2<A, B> extends FunctionBase {
  byte apply(A value1, B value2);
   ...
   */
  default ByteFunction2<A, B> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument2<>(this);
  }

  static <A, B> ByteFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    byte apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ByteFunction2.Serializable should override this method
   ...
   */
  static <A, B> ByteFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends ByteFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new ByteMethodReference2<A, B>(this);
