 ...
 *
 * DAG1x6 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG1x6 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG1x6<A, RA, RB, RC, RD, RE, RF>
    extends
    AbstractPreparableTransformer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>, DAG1x6<A, RA, RB, RC, RD, RE, RF>>
    implements
    PreparableDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>, DAG1x6<A, RA, RB, RC, RD, RE, RF>> {
   ...
   */
  DAG1x6(DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> dag, Producer<? extends A> input1) {
    super(input1);
    _dag = dag;
   ...
   */
  @Override
  public DAG1x6<A, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>, DAG1x6<A, RA, RB, RC, RD, RE, RF>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>, DAG1x6<A, RA, RB, RC, RD, RE, RF>> {
    @Override
    ...
    @Override
    public DAG1x6<A, RA, RB, RC, RD, RE, RF> getInstance() {
      return DAG1x6.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG1x6<A, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
   ...
   */
  public DAG1x6<A, RA, RB, RC, RD, RE, RF> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG1x6<A, RA, RB, RC, RD, RE, RF> withInput(Producer<? extends A> input1) {
   ...
   * @param <RF> the type of the sixth result
   */
  private static class Preparer<A, RA, RB, RC, RD, RE, RF> extends
      AbstractBatchPreparer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> {
    // the DAG being prepared
    private final DAG1x6<A, RA, RB, RC, RD, RE, RF> _dag;
     ...
     */
    Preparer(DAG1x6<A, RA, RB, RC, RD, RE, RF> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer1<A, Tuple6<RA, RB, RC, RD, RE, RF>>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> finish(
  ...
  @Override
  protected Preparer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, RA, RB, RC, RD, RE, RF> prepareAndApply(Iterable<? extends A> values1) {
    DAGExecutionResult<Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this, new ObjectReader[] { ObjectReader.wrap(values1) });
    return new Result<>((DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>) res.getPreparerResult()
   ...
   */
  public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> prepare(Iterable<? extends A> values1) {
    return (DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>) _executor.internalAPI()
  ...
  * @param <RF> the type of the sixth result
   */
  public static final class Result<A, RA, RB, RC, RD, RE, RF> extends AbstractDAGResult6<RA, RB, RC, RD, RE, RF> {
    // the prepared DAG
    private final DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RF> the type of the sixth result
   */
  @ValueEquality
  public static class Prepared<A, RA, RB, RC, RD, RE, RF> extends
      AbstractPreparedTransformer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>>
      implements PreparedDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> {
    ...
    * @param input1 the {@link Producer} providing the first input to the transformer
     ...
     */
    @Override
    public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer1<A, Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>> {
      @Override
      public DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> getInstance() {
        return DAG1x6.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parent
     */
    public DAG1x6.Prepared<A, RA, RB, RC, RD, RE, RF> withInput(Producer<? extends A> input1) {
      return super.withAllInputs(input1);
    }
