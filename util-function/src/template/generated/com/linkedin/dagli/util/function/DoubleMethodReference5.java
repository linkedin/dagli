 ...
 */
class DoubleMethodReference5<A, B, C, D, E> implements DoubleFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction5<A, B, C, D, E> _cachedFunction = null;

  DoubleMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof DoubleMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference5) func)._methodReference;
    } else {
  ...
  private DoubleFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference6<Object, A, B, C, D, E> unbound = new DoubleMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference5) obj)._methodReference);
  }
