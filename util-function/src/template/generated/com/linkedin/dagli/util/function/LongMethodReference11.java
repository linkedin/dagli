 ...
 */
class LongMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
  ...
  private static final int CLASS_HASH = LongMethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;

  LongMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof LongMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference11) func)._methodReference;
    } else {
  ...
  private LongFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(long.class);
      return (LongFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction11.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference11)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference11) obj)._methodReference);
  }
