...
/**
 * A function class implementing {@link LongFunction8.Serializable} that composes
 * {@link LongFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
...
class LongComposedFunction8<A, B, C, D, E, F, G, H, Q> implements LongFunction8.Serializable<A, B, C, D, E, F, G, H> {
   ...
   *                as input
   */
  LongComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, LongFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public LongComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new LongComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(LongComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof LongComposedFunction8) {
      return this._first.equals(((LongComposedFunction8) obj)._first)
          && this._andThen.equals(((LongComposedFunction8) obj)._andThen);
    }
    return false;
  }
}
