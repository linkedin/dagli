 ...
 *
 * DAG1x10 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG1x10 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
    extends
    AbstractPreparableTransformer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
    implements
    PreparableDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
   ...
   */
  DAG1x10(DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> dag, Producer<? extends A> input1) {
    super(input1);
    _dag = dag;
   ...
   */
  @Override
  public DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    @Override
    ...
    @Override
    public DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
      return DAG1x10.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
   ...
   */
  public DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInput(Producer<? extends A> input1) {
   ...
   * @param <RJ> the type of the tenth result
   */
  private static class Preparer<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractBatchPreparer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    // the DAG being prepared
    private final DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _dag;
     ...
     */
    Preparer(DAG1x10<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> finish(
  ...
  @Override
  protected Preparer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepareAndApply(Iterable<? extends A> values1) {
    DAGExecutionResult<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this, new ObjectReader[] { ObjectReader.wrap(values1) });
    return new Result<>((DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) res.getPreparerResult()
   ...
   */
  public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepare(Iterable<? extends A> values1) {
    return (DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) _executor.internalAPI()
  ...
  * @param <RJ> the type of the tenth result
   */
  public static final class Result<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> extends
      AbstractDAGResult10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> {
    // the prepared DAG
    private final DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RJ> the type of the tenth result
   */
  @ValueEquality
  public static class Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractPreparedTransformer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
      implements
      PreparedDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    ...
    * @param input1 the {@link Producer} providing the first input to the transformer
     ...
     */
    @Override
    public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer1<A, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
      @Override
      public DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
        return DAG1x10.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parent
     */
    public DAG1x10.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInput(Producer<? extends A> input1) {
      return super.withAllInputs(input1);
    }
    ...
    @Override
    public Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> apply(A value1) {
      try (
