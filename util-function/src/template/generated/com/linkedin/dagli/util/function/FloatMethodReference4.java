 ...
 */
class FloatMethodReference4<A, B, C, D> implements FloatFunction4.Serializable<A, B, C, D>, Named {
  ...
  FloatMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof FloatMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference4) func)._methodReference;
    } else {
  ...
  private FloatFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference5<Object, A, B, C, D> unbound = new FloatMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction4.class), type, mh,
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((FloatMethodReference4) obj)._methodReference);
  }
