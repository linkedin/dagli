 ...
 */
@ValueEquality
public class WrapperTransformer8<A, B, C, D, E, F, G, H, R, S extends WrapperTransformer8<A, B, C, D, E, F, G, H, R, S>>
    extends
    AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, R, PreparedTransformer8<A, B, C, D, E, F, G, H, R>, S> {

  private static final long serialVersionUID = 1;

  protected PreparableTransformer8<A, B, C, D, E, F, G, H, R, ?> _wrappedTransformer = null;
   ...
   */
  public WrapperTransformer8(
      PreparableTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R, ?> wrappedTransformer) {
   ...
   * class' constructor using {@link #setWrappedTransformer(PreparableTransformer8)}
   */
  public WrapperTransformer8() {
  }
   ...
   */
  protected WrapperTransformer8<A, B, C, D, E, F, G, H, R, S> withWrappedTransformer(
      PreparableTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R, ?> wrapped) {
  ...
  protected void setWrappedTransformer(
      PreparableTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R, ?> wrapped) {
    _wrappedTransformer = PreparableTransformer8.castWithGenericPrepared(wrapped);
  ...
  @Override
  protected Preparer8<A, B, C, D, E, F, G, H, R, PreparedTransformer8<A, B, C, D, E, F, G, H, R>> getPreparer(
      PreparerContext context) {
    return Preparer8.cast(_wrappedTransformer.internalAPI().getPreparer(context));
  }
  ...
  * @param <R> the type of result produced by the transformer
   ...
   */
  @ValueEquality
  public static abstract class Prepared<A, B, C, D, E, F, G, H, R, S extends WrapperTransformer8.Prepared<A, B, C, D, E, F, G, H, R, S>>
      extends AbstractPreparedStatefulTransformer8<A, B, C, D, E, F, G, H, R, Object, S> {

    private static final long serialVersionUID = 1;

    protected PreparedTransformer8<A, B, C, D, E, F, G, H, R> _wrappedTransformer = null;
     ...
     */
    public Prepared(
        PreparedTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R> wrappedTransformer) {
      setWrappedTransformer(wrappedTransformer);
    }

    /**
     * Constructs a new instance that will initially lack a wrapped transformer (this should be set during the derived
     * class' constructor using {@link #setWrappedTransformer(PreparedTransformer8)}
     */
    public Prepared() {
    }
     ...
     * @param wrapped the transformer to wrap
     */
    protected WrapperTransformer8.Prepared<A, B, C, D, E, F, G, H, R, S> withWrappedTransformer(
        PreparedTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R> wrapped) {
      return clone(c -> c.setWrappedTransformer(wrapped));
    }
    ...
    protected void setWrappedTransformer(
        PreparedTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R> wrapped) {
      _wrappedTransformer = PreparedTransformer8.cast(wrapped);
      _input1 = _wrappedTransformer.internalAPI().getInput1();
      _input2 = _wrappedTransformer.internalAPI().getInput2();
      _input3 = _wrappedTransformer.internalAPI().getInput3();
      _input4 = _wrappedTransformer.internalAPI().getInput4();
    ...
    public R apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) {
      return _wrappedTransformer.apply(value1, value2, value3, value4, value5, value6, value7, value8);
    }
    ...
    protected void applyAll(Object executionCache, List<? extends A> values1, List<? extends B> values2,
      ...
      _wrappedTransformer.internalAPI().applyAllUnsafe(executionCache, values1.size(),
          Arrays.asList(values1, values2, values3, values4, values5, values6, values7, values8), results);
    }
