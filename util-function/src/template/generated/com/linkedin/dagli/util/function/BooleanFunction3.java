...
@FunctionalInterface
public interface BooleanFunction3<A, B, C> extends FunctionBase {
  boolean apply(A value1, B value2, C value3);
   ...
   */
  default BooleanFunction3<A, B, C> returnFalseOnNullArgument() {
    return new BooleanDefaultOnNullArgument3<>(this);
  }

  default BooleanFunction3<A, B, C> negate() {
    return BooleanNegatedFunction3.negate(this);
  }

  static <A, B, C> BooleanFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    boolean apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement BooleanFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> BooleanFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends BooleanFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new BooleanMethodReference3<A, B, C>(this);
    ...
    @Override
    default Serializable<A, B, C> returnFalseOnNullArgument() {
      return new BooleanDefaultOnNullArgument3<>(this);
    }

    @Override
    default Serializable<A, B, C> negate() {
      return BooleanNegatedFunction3.Serializable.negate(this);
    }
