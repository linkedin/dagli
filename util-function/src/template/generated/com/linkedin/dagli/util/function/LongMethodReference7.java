 ...
 */
class LongMethodReference7<A, B, C, D, E, F, G> implements LongFunction7.Serializable<A, B, C, D, E, F, G>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference7.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction7<A, B, C, D, E, F, G> _cachedFunction = null;

  LongMethodReference7(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference7(Serializable<A, B, C, D, E, F, G> func) {
    if (func instanceof LongMethodReference7) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference7) func)._methodReference;
    } else {
  ...
  private LongFunction7<A, B, C, D, E, F, G> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference8<Object, A, B, C, D, E, F, G> unbound = new LongMethodReference8<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction7<A, B, C, D, E, F, G>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction7.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference7)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference7) obj)._methodReference);
  }
