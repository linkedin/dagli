 ...
 */
class CharacterMethodReference9<A, B, C, D, E, F, G, H, I> implements
  ...
  private static final int CLASS_HASH = CharacterMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  CharacterMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof CharacterMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference9) func)._methodReference;
    } else {
  ...
  private CharacterFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new CharacterMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction9.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference9) obj)._methodReference);
  }
