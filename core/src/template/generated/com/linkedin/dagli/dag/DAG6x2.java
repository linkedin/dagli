 ...
 *
 * DAG6x2 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG6x2 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG6x2<A, B, C, D, E, F, RA, RB>
    extends
    AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>, DAG6x2<A, B, C, D, E, F, RA, RB>>
    implements
    PreparableDAGTransformer<Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>, DAG6x2<A, B, C, D, E, F, RA, RB>> {
   ...
   */
  DAG6x2(DAGStructure<Tuple2<RA, RB>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG6x2<A, B, C, D, E, F, RA, RB> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>, DAG6x2<A, B, C, D, E, F, RA, RB>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>, DAG6x2<A, B, C, D, E, F, RA, RB>> {
    @Override
    ...
    @Override
    public DAG6x2<A, B, C, D, E, F, RA, RB> getInstance() {
      return DAG6x2.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG6x2<A, B, C, D, E, F, RA, RB>>> getGraphReducers() {
   ...
   */
  public DAG6x2<A, B, C, D, E, F, RA, RB> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG6x2<A, B, C, D, E, F, RA, RB> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3, Producer<? extends D> input4, Producer<? extends E> input5,
      Producer<? extends F> input6) {
   ...
   */
  public DAG5x2<B, C, D, E, F, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
            nestedPlaceholder6).withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag))
   ...
   *         the produced by the provided generator
   */
  public DAG5x2<A, C, D, E, F, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG5x2<A, B, D, E, F, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x2<A, B, C, E, F, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x2<A, B, C, D, F, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG5x2<A, B, C, D, E, RA, RB> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5).withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag))
   ...
   * @param <RB> the type of the second result
   */
  private static class Preparer<A, B, C, D, E, F, RA, RB> extends
      AbstractBatchPreparer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> {
    // the DAG being prepared
    private final DAG6x2<A, B, C, D, E, F, RA, RB> _dag;
     ...
     */
    Preparer(DAG6x2<A, B, C, D, E, F, RA, RB> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer6<A, B, C, D, E, F, Tuple2<RA, RB>>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> finish(
  ...
  @Override
  protected Preparer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, RA, RB> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3, Iterable<? extends D> values4, Iterable<? extends E> values5,
      Iterable<? extends F> values6) {
    DAGExecutionResult<Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>) res.getPreparerResult()
   ...
   */
  public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> prepare(Iterable<? extends A> values1,
    ...
    return (DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RB> the type of the second result
   */
  public static final class Result<A, B, C, D, E, F, RA, RB> extends AbstractDAGResult2<RA, RB> {
    // the prepared DAG
    private final DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RB> the type of the second result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, RA, RB> extends
      AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>>
      implements PreparedDAGTransformer<Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> {
    ...
    * @param input6 the {@link Producer} providing the sixth input to the transformer
     ...
     */
    @Override
    public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple2<RA, RB>, DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>> {
      @Override
      public DAGStructure<Tuple2<RA, RB>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> getInstance() {
        return DAG6x2.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG6x2.Prepared<A, B, C, D, E, F, RA, RB>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> withInputs(Producer<? extends A> input1,
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<B, C, D, E, F, RA, RB> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      DAG6x2.Prepared<A, B, C, D, E, F, RA, RB> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6);
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<A, C, D, E, F, RA, RB> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<A, B, D, E, F, RA, RB> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<A, B, C, E, F, RA, RB> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<A, B, C, D, F, RA, RB> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG5x2.Prepared<A, B, C, D, E, RA, RB> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple2<RA, RB> apply(A value1, B value2, C value3, D value4, E value5, F value6) {
      try (
