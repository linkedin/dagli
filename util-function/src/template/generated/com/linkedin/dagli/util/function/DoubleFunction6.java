...
@FunctionalInterface
public interface DoubleFunction6<A, B, C, D, E, F> extends FunctionBase {
  double apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default DoubleFunction6<A, B, C, D, E, F> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument6<>(this);
  }

  static <A, B, C, D, E, F> DoubleFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    double apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> DoubleFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends DoubleFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new DoubleMethodReference6<A, B, C, D, E, F>(this);
