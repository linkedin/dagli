 ...
 */
class DoubleMethodReference4<A, B, C, D> implements DoubleFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = DoubleMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction4<A, B, C, D> _cachedFunction = null;

  DoubleMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof DoubleMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference4) func)._methodReference;
    } else {
  ...
  private DoubleFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference5<Object, A, B, C, D> unbound = new DoubleMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction4.class), type, mh,
  ...
  public double apply(A value1, B value2, C value3, D value4) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference4) obj)._methodReference);
  }
