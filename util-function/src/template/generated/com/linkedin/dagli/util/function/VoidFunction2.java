...
public interface VoidFunction2<A, B> extends FunctionBase, BiConsumer<A, B> {
  ...
  static <A, B> VoidFunction2<A, B> unchecked(Checked<A, B, ?> checkedFunction) {
    return (A value1, B value2) -> {
      try {
        checkedFunction.apply(value1, value2);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction2.Serializable should override this method
   ...
   */
  static <A, B> VoidFunction2.Serializable<A, B> safelySerializable(Serializable<A, B> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B> extends VoidFunction2<A, B>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B> safelySerializable() {
      try {
        return new VoidMethodReference2<A, B>(this);
