...
public interface Transformer6InternalAPI<A, B, C, D, E, F, R, S extends Transformer6<A, B, C, D, E, F, R>> extends
  ...
  <G> Transformer7<A, B, C, D, E, F, G, R> withArity7(Producer<? extends G> newInput7);

  <N> Transformer7<N, A, B, C, D, E, F, R> withPrependedArity7(Producer<? extends N> newInput1);

  Transformer1<Tuple6<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F>, R> withArity1(
