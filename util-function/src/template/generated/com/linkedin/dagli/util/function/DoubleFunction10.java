...
@FunctionalInterface
public interface DoubleFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default DoubleFunction10<A, B, C, D, E, F, G, H, I, J> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> DoubleFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> DoubleFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends DoubleFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new DoubleMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
