...
/**
 * Layer that outputs the mean of the the vector sequences provided as inputs.
 *
 * Each vector in the output sequence is the mean of the vectors at the corresponding timestep in the inputs.
 *
...
public class NNVectorSequenceMeanLayer extends AbstractElementWiseSequenceLayer<NNVectorSequenceMeanLayer>
