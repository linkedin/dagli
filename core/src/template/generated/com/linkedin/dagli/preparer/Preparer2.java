...
public interface Preparer2<A, B, R, N extends PreparedTransformer2<A, B, R>> extends Preparer<R, N> {
  ...
  default PreparerResultMixed<? extends PreparedTransformer2<? super A, ? super B, ? extends R>, N> finishUnsafe(
    ...
    return finish(inputs == null ? null : inputs.lazyMap(Tuple2::fromArrayUnsafe));
  }
   ...
   */
  PreparerResultMixed<? extends PreparedTransformer2<? super A, ? super B, ? extends R>, N> finish(
  ...
  static <A, B, R, N extends PreparedTransformer2<A, B, R>> Preparer2<A, B, R, N> cast(
      Preparer2<? super A, ? super B, ? extends R, ? extends N> preparer) {
    // safe due to semantics of preparers:
    return (Preparer2<A, B, R, N>) preparer;
  }
}
