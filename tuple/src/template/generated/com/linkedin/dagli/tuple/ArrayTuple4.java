...
/**
 * A tuple of arity ArrayTuple4<A, B, C, D> that is backed by an array.
 ...
 */
final class ArrayTuple4<A, B, C, D> extends AbstractTuple implements Tuple4<A, B, C, D> {
   ...
   */
  public ArrayTuple4(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(4);
    System.arraycopy(_array, 0, result, 0, 4);
    return result;
  }
}
