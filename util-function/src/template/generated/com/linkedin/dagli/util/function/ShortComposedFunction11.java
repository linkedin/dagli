...
/**
 * A function class implementing {@link ShortFunction11.Serializable} that composes
 * {@link ShortFunction11} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ShortComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> implements
   ...
   *                as input
   */
  ShortComposedFunction11(Function11<A, B, C, D, E, F, G, H, I, J, K, Q> first, ShortFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ShortComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> safelySerializable() {
    return new ShortComposedFunction11<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ShortComposedFunction11.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ShortComposedFunction11) {
      return this._first.equals(((ShortComposedFunction11) obj)._first)
          && this._andThen.equals(((ShortComposedFunction11) obj)._andThen);
    }
    return false;
  }
