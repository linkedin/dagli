 ...
 */
class CharacterMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
    CharacterFunction10.Serializable<A, B, C, D, E, F, G, H, I, J>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  CharacterMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof CharacterMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference10) func)._methodReference;
    } else {
  ...
  private CharacterFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new CharacterMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction10.class), type,
  ...
  public char apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference10) obj)._methodReference);
  }
