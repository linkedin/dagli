 ...
 */
class VoidMethodReference5<A, B, C, D, E> implements VoidFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = VoidMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient VoidFunction5<A, B, C, D, E> _cachedFunction = null;

  VoidMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof VoidMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference5) func)._methodReference;
    } else {
  ...
  private VoidFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference6<Object, A, B, C, D, E> unbound = new VoidMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction5.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5) {
    _cachedFunction.apply(value1, value2, value3, value4, value5);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof VoidMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((VoidMethodReference5) obj)._methodReference);
  }
