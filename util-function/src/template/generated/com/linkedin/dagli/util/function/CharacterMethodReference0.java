 ...
 */
class CharacterMethodReference0 implements CharacterFunction0.Serializable, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference0.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction0 _cachedFunction = null;

  CharacterMethodReference0(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference0(Serializable func) {
    if (func instanceof CharacterMethodReference0) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference0) func)._methodReference;
    } else {
  ...
  private CharacterFunction0 fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference1<Object> unbound = new CharacterMethodReference1<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction0) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction0.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference0)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference0) obj)._methodReference);
  }
