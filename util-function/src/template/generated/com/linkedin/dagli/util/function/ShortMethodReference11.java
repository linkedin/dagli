 ...
 */
class ShortMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
  ...
  private transient ShortFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;
   ...
   *        will be thrown.
   */
  public ShortMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
  ...
  private ShortFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(short.class);
      return (ShortFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
