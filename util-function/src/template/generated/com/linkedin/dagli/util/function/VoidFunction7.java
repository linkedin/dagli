...
@FunctionalInterface
public interface VoidFunction7<A, B, C, D, E, F, G> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7);
   ...
   */
  default VoidFunction7<A, B, C, D, E, F, G> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument7<>(this);
  }

  static <A, B, C, D, E, F, G> VoidFunction7<A, B, C, D, E, F, G> unchecked(
      Checked<A, B, C, D, E, F, G, ?> checkedFunction) {
    return (A value1, B value2, C value3, D value4, E value5, F value6, G value7) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6, value7);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, D, E, F, G, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction7.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G> VoidFunction7.Serializable<A, B, C, D, E, F, G> safelySerializable(
      Serializable<A, B, C, D, E, F, G> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G> extends VoidFunction7<A, B, C, D, E, F, G>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G> safelySerializable() {
      try {
        return new VoidMethodReference7<A, B, C, D, E, F, G>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument7<>(this);
    }
