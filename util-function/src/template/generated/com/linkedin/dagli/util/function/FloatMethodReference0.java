 ...
 */
class FloatMethodReference0 implements FloatFunction0.Serializable, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference0.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction0 _cachedFunction = null;

  FloatMethodReference0(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference0(Serializable func) {
    if (func instanceof FloatMethodReference0) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference0) func)._methodReference;
    } else {
  ...
  private FloatFunction0 fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference1<Object> unbound = new FloatMethodReference1<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction0) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction0.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference0)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference0) obj)._methodReference);
  }
