...
/**
 * A tuple of arity ArrayTuple9<A, B, C, D, E, F, G, H, I> that is backed by an array.
 ...
 */
final class ArrayTuple9<A, B, C, D, E, F, G, H, I> extends AbstractTuple implements Tuple9<A, B, C, D, E, F, G, H, I> {
   ...
   */
  public ArrayTuple9(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(9);
    System.arraycopy(_array, 0, result, 0, 9);
    return result;
  }
}
