...
public interface PreparedTransformer7InternalAPI<A, B, C, D, E, F, G, R, S extends PreparedTransformer7<A, B, C, D, E, F, G, R>>
    extends Transformer7InternalAPI<A, B, C, D, E, F, G, R, S>, PreparedTransformerInternalAPI<R, S> {

  R apply(Object executionCache, A value1, B value2, C value3, D value4, E value5, F value6, G value7);
  ...
  default R applyUnsafe(Object executionCache, List<?> values) {
    ...
    return apply(executionCache, (A) values.get(0), (B) values.get(1), (C) values.get(2), (D) values.get(3),
        (E) values.get(4), (F) values.get(5), (G) values.get(6));
  }
  ...
  default R applyUnsafe(Object executionCache, Object[][] values, int exampleIndex) {
    ...
    return apply(executionCache, (A) values[0][exampleIndex], (B) values[1][exampleIndex], (C) values[2][exampleIndex],
        ...
        (G) values[6][exampleIndex]);
  }

  @Override
  default <H> PreparedTransformer8<A, B, C, D, E, F, G, H, R> withArity8(Producer<? extends H> newInput8) {
  ...
  @Override
  default <N> PreparedTransformer8<N, A, B, C, D, E, F, G, R> withPrependedArity8(Producer<? extends N> newInput1) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
  ...
  @Override
  default PreparedTransformer1<Tuple7<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G>, R> withArity1(
