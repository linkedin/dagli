...
@FunctionalInterface
public interface IntFunction5<A, B, C, D, E> extends FunctionBase {
  int apply(A value1, B value2, C value3, D value4, E value5);
   ...
   */
  default IntFunction5<A, B, C, D, E> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument5<>(this);
  }

  static <A, B, C, D, E> IntFunction5<A, B, C, D, E> unchecked(Checked<A, B, C, D, E, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2, C value3, D value4, E value5) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction5.Serializable should override this method
   ...
   */
  static <A, B, C, D, E> IntFunction5.Serializable<A, B, C, D, E> safelySerializable(
      Serializable<A, B, C, D, E> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E> extends IntFunction5<A, B, C, D, E>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E> safelySerializable() {
      try {
        return new IntMethodReference5<A, B, C, D, E>(this);
