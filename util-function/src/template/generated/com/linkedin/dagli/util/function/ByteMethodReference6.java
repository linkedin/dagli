 ...
 */
class ByteMethodReference6<A, B, C, D, E, F> implements ByteFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction6<A, B, C, D, E, F> _cachedFunction = null;

  ByteMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof ByteMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference6) func)._methodReference;
    } else {
  ...
  private ByteFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference7<Object, A, B, C, D, E, F> unbound = new ByteMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction6.class), type, mh,
  ...
  public byte apply(A value1, B value2, C value3, D value4, E value5, F value6) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference6) obj)._methodReference);
  }
