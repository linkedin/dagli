 ...
 *
 * DAG5x7 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG5x7 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>
    extends
    AbstractPreparableTransformer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>, DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>
    implements
    PreparableDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>, DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> {
   ...
   */
  DAG5x7(DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>, DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>, DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> {
    @Override
    ...
    @Override
    public DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> getInstance() {
      return DAG5x7.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
   ...
   */
  public DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
      Producer<? extends E> input5) {
   ...
   */
  public DAG4x7<B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG4x7<A, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG4x7<A, B, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x7<A, B, C, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG4x7<A, B, C, D, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RG> the type of the seventh result
   */
  private static class Preparer<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractBatchPreparer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> {
    // the DAG being prepared
    private final DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> _dag;
     ...
     */
    Preparer(DAG5x7<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> finish(
  ...
  @Override
  protected Preparer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    DAGExecutionResult<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>) res.getPreparerResult()
   ...
   */
  public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5) {
    return (DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RG> the type of the seventh result
   */
  public static final class Result<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> extends
      AbstractDAGResult7<RA, RB, RC, RD, RE, RF, RG> {
    // the prepared DAG
    private final DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RG> the type of the seventh result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>
      extends
      AbstractPreparedTransformer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>
      implements
      PreparedDAGTransformer<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> {
    ...
    * @param input5 the {@link Producer} providing the fifth input to the transformer
     ...
     */
    @Override
    public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer5<A, B, C, D, E, Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple7<RA, RB, RC, RD, RE, RF, RG>, DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>> {
      @Override
      public DAGStructure<Tuple7<RA, RB, RC, RD, RE, RF, RG>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> getInstance() {
        return DAG5x7.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5) {
      return super.withAllInputs(input1, input2, input3, input4, input5);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG4x7.Prepared<B, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      DAG5x7.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF, RG> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5);
     ...
     *         the produced by the provided generator
     */
    public DAG4x7.Prepared<A, C, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x7.Prepared<A, B, D, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x7.Prepared<A, B, C, E, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG4x7.Prepared<A, B, C, D, RA, RB, RC, RD, RE, RF, RG> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple7<RA, RB, RC, RD, RE, RF, RG> apply(A value1, B value2, C value3, D value4, E value5) {
      try (
