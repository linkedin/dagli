 ...
 */
class ByteMethodReference4<A, B, C, D> implements ByteFunction4.Serializable<A, B, C, D>, Named {
  ...
  private static final int CLASS_HASH = ByteMethodReference4.class.hashCode();

  private final MethodReference _methodReference;
  private transient ByteFunction4<A, B, C, D> _cachedFunction = null;

  ByteMethodReference4(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ByteMethodReference4(Serializable<A, B, C, D> func) {
    if (func instanceof ByteMethodReference4) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ByteMethodReference4) func)._methodReference;
    } else {
  ...
  private ByteFunction4<A, B, C, D> fromMethodReference() {
    if (_methodReference.isBound()) {
      ByteMethodReference5<Object, A, B, C, D> unbound = new ByteMethodReference5<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ByteFunction4<A, B, C, D>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ByteFunction4.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ByteMethodReference4)) {
      return false;
    }

    return _methodReference.equals(((ByteMethodReference4) obj)._methodReference);
  }
