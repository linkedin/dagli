 ...
 */
class MethodReference6<A, B, C, D, E, F, R> implements Function6.Serializable<A, B, C, D, E, F, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function6<A, B, C, D, E, F, R> _cachedFunction = null;

  MethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference6(Serializable<A, B, C, D, E, F, R> func) {
    if (func instanceof MethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference6) func)._methodReference;
    } else {
  ...
  private Function6<A, B, C, D, E, F, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference7<Object, A, B, C, D, E, F, R> unbound = new MethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function6<A, B, C, D, E, F, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference6)) {
      return false;
    }

    return _methodReference.equals(((MethodReference6) obj)._methodReference);
  }
