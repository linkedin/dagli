 ...
 */
public interface DAGResult10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> extends
    ObjectReader<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
  /**
  ...
  /**
   * Gets the results produced by the tenth output node of the DAG as an {@link ObjectReader}.  This
   * {@link ObjectReader} is parallel to the examples inputted to the DAG: that is, the ith value of the
   * {@link ObjectReader} corresponds to the ith example.  The size of the {@link ObjectReader} will (of course) also
   * equal the number of examples.
   *
   * @return the values produced by the tenth output node of the DAG for the inputted examples
   */
  public abstract ObjectReader<RJ> getResult10();
}
