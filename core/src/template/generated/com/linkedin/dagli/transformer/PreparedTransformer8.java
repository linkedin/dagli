...
public interface PreparedTransformer8<A, B, C, D, E, F, G, H, R> extends Transformer8<A, B, C, D, E, F, G, H, R>,
  ...
  default ObjectReader<R> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
    ...
    ObjectReader
        .concatenate(Object[]::new, ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3),
            ...
            ObjectReader.wrap(values7), ObjectReader.wrap(values8)).lazyMap(Arrays::asList)
  ...
  @Override
  PreparedTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, ? extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>> internalAPI();
  ...
  static <A, B, C, D, E, F, G, H, R> PreparedTransformer8<A, B, C, D, E, F, G, H, R> cast(
