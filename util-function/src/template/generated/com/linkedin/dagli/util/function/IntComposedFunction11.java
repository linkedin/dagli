...
/**
 * A function class implementing {@link IntFunction11.Serializable} that composes
 * {@link IntFunction11} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class IntComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> implements
   ...
   *                as input
   */
  IntComposedFunction11(Function11<A, B, C, D, E, F, G, H, I, J, K, Q> first, IntFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public IntComposedFunction11<A, B, C, D, E, F, G, H, I, J, K, Q> safelySerializable() {
    return new IntComposedFunction11<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(IntComposedFunction11.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof IntComposedFunction11) {
      return this._first.equals(((IntComposedFunction11) obj)._first)
          && this._andThen.equals(((IntComposedFunction11) obj)._andThen);
    }
    return false;
  }
}
