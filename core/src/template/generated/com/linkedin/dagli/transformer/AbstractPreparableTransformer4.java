...
public abstract class AbstractPreparableTransformer4<A, B, C, D, R, N extends PreparedTransformer4<A, B, C, D, R>, S extends AbstractPreparableTransformer4<A, B, C, D, R, N, S>>
    extends AbstractTransformer4<A, B, C, D, R, PreparableTransformer4InternalAPI<A, B, C, D, R, N, S>, S> implements
    PreparableTransformer4<A, B, C, D, R, N> {
  ...
  @Override
  protected PreparableTransformer4InternalAPI<A, B, C, D, R, N, S> createInternalAPI() {
    return new InternalAPI();
  }

  protected class InternalAPI extends
      AbstractTransformer4<A, B, C, D, R, PreparableTransformer4InternalAPI<A, B, C, D, R, N, S>, S>.InternalAPI
      implements PreparableTransformer4InternalAPI<A, B, C, D, R, N, S> {
    @Override
    public Preparer4<A, B, C, D, R, N> getPreparer(PreparerContext context) {
      return AbstractPreparableTransformer4.this.getPreparer(context);
    }

    @Override
    public boolean hasIdempotentPreparer() {
      return AbstractPreparableTransformer4.this.hasIdempotentPreparer();
    }
  }

  protected abstract Preparer4<A, B, C, D, R, N> getPreparer(PreparerContext context);

  public AbstractPreparableTransformer4() {
    super();
  }

  public AbstractPreparableTransformer4(Producer<? extends A> input1, Producer<? extends B> input2,
