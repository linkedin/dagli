 ...
 * {@link PreparerMode#STREAM} modes, it should derive from {@link AbstractBatchPreparer4} or
 * {@link AbstractStreamPreparer4} instead.
 *
 ...
 */
public abstract class AbstractPreparer4<A, B, C, D, R, N extends PreparedTransformer4<A, B, C, D, R>> extends
    AbstractPreparer<R, N> implements Preparer4<A, B, C, D, R, N> {

  @Override
  public final void processUnsafe(Object[] values) {
    Preparer4.super.processUnsafe(values);
  }

  @Override
  public final PreparerResultMixed<? extends PreparedTransformer4<? super A, ? super B, ? super C, ? super D, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return Preparer4.super.finishUnsafe(inputs);
  }
}
