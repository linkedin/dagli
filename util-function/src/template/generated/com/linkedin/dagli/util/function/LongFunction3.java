...
@FunctionalInterface
public interface LongFunction3<A, B, C> extends FunctionBase {
  long apply(A value1, B value2, C value3);
   ...
   */
  default LongFunction3<A, B, C> returnZeroOnNullArgument() {
    return new LongDefaultOnNullArgument3<>(this);
  }

  static <A, B, C> LongFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    long apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement LongFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> LongFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends LongFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new LongMethodReference3<A, B, C>(this);
