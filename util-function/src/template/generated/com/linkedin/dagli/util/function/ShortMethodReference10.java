 ...
 */
class ShortMethodReference10<A, B, C, D, E, F, G, H, I, J> implements
    ShortFunction10.Serializable<A, B, C, D, E, F, G, H, I, J>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction10<A, B, C, D, E, F, G, H, I, J> _cachedFunction = null;

  ShortMethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J> func) {
    if (func instanceof ShortMethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference10) func)._methodReference;
    } else {
  ...
  private ShortFunction10<A, B, C, D, E, F, G, H, I, J> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference11<Object, A, B, C, D, E, F, G, H, I, J> unbound =
          new ShortMethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction10<A, B, C, D, E, F, G, H, I, J>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference10)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference10) obj)._methodReference);
  }
