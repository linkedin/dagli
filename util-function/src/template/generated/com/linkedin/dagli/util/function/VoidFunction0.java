...
public interface VoidFunction0 extends FunctionBase, Runnable {
  ...
  static VoidFunction0 unchecked(Checked<?> checkedFunction) {
    return () -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement VoidFunction0.Serializable should override this method
   ...
   */
  static VoidFunction0.Serializable safelySerializable(Serializable function) {
    return function.safelySerializable();
  }

  interface Serializable extends VoidFunction0, java.io.Serializable {
    /**
