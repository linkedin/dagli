...
import com.linkedin.dagli.preparer.TrivialPreparer4;
 ...
 */
@ValueEquality
public final class ConstantResultTransformation4<A, B, C, D, R>
    extends
    AbstractPreparableTransformer4<A, B, C, D, R, ConstantResultTransformation4.Prepared<A, B, C, D, R>, ConstantResultTransformation4<A, B, C, D, R>>
    implements ConstantResultTransformation<R, ConstantResultTransformation4<A, B, C, D, R>> {
   ...
   */
  public ConstantResultTransformation4() {
  }
   ...
   */
  public ConstantResultTransformation4<A, B, C, D, R> withResult(R result) {
    return clone(c -> {
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation4<A, B, C, D, R> withResultForPreparationData(R result) {
    return clone(c -> {
      c._resultForPreparationData = result;
    });
  }
   ...
   * @return a copy of this transformer that will always have the specified constant result
   */
  public ConstantResultTransformation4<A, B, C, D, R> withResultForNewData(R result) {
    return clone(c -> {
      c._resultForNewData = result;
    });
  }
  ...
  @Override
  protected Preparer4<A, B, C, D, R, ConstantResultTransformation4.Prepared<A, B, C, D, R>> getPreparer(
      PreparerContext context) {
    ConstantResultTransformation4.Prepared<A, B, C, D, R> resultForPrepData =
        new ConstantResultTransformation4.Prepared<A, B, C, D, R>(_resultForPreparationData);
    return _resultForPreparationData == _resultForNewData ? new TrivialPreparer4<>(resultForPrepData)
        : new TrivialPreparer4<>(resultForPrepData, new ConstantResultTransformation4.Prepared<A, B, C, D, R>(
            _resultForNewData));
  }

  @Override
  public ConstantResultTransformation4<A, B, C, D, R> withInput1(Producer<? extends A> inputA) {
    return super.withInput1(inputA);
  }

  @Override
  public ConstantResultTransformation4<A, B, C, D, R> withInput2(Producer<? extends B> inputB) {
    return super.withInput2(inputB);
  }

  @Override
  public ConstantResultTransformation4<A, B, C, D, R> withInput3(Producer<? extends C> inputC) {
    return super.withInput3(inputC);
  }

  @Override
  public ConstantResultTransformation4<A, B, C, D, R> withInput4(Producer<? extends D> inputD) {
    return super.withInput4(inputD);
  }

  @Override
  public String getName() {
    return "ConstantResultTransformation4("
  ...
  * @param <D> the type of the fourth input
   ...
   */
  @ValueEquality
  public static final class Prepared<A, B, C, D, R> extends
      AbstractPreparedTransformer4<A, B, C, D, R, ConstantResultTransformation4.Prepared<A, B, C, D, R>> implements
      ConstantResultTransformation.Prepared<R, ConstantResultTransformation4.Prepared<A, B, C, D, R>> {
    private static final long serialVersionUID = 1;
     ...
     * @return a copy of this transformer that will always have the specified constant result
     */
    public ConstantResultTransformation4.Prepared<A, B, C, D, R> withResult(R result) {
    ...
    @Override
    public ConstantResultTransformation4.Prepared<A, B, C, D, R> withInput1(Producer<? extends A> inputA) {
      return super.withInput1(inputA);
    }

    @Override
    public ConstantResultTransformation4.Prepared<A, B, C, D, R> withInput2(Producer<? extends B> inputB) {
      return super.withInput2(inputB);
    }

    @Override
    public ConstantResultTransformation4.Prepared<A, B, C, D, R> withInput3(Producer<? extends C> inputC) {
      return super.withInput3(inputC);
    }

    @Override
    public ConstantResultTransformation4.Prepared<A, B, C, D, R> withInput4(Producer<? extends D> inputD) {
      return super.withInput4(inputD);
    }

    @Override
    public String getName() {
      return "ConstantResultTransformation4.Prepared(" + _result + ")";
    }
  }
}
