...
@FunctionalInterface
public interface FloatFunction0 extends FunctionBase {
  float apply();

  static FloatFunction0 unchecked(Checked<?> checkedFunction) {
    return () -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement FloatFunction0.Serializable should override this method
   ...
   */
  static FloatFunction0.Serializable safelySerializable(Serializable function) {
    return function.safelySerializable();
  }

  interface Serializable extends FloatFunction0, java.io.Serializable {
    /**
    ...
    default Serializable safelySerializable() {
      try {
        return new FloatMethodReference0(this);
