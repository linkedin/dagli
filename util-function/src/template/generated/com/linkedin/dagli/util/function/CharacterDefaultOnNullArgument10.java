...
/**
 * A function class implementing CharacterFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> that returns '\0' if any of
 * the function's inputs are null.
 */
class CharacterDefaultOnNullArgument10<A, B, C, D, E, F, G, H, I, J> implements
  ...
  CharacterDefaultOnNullArgument10(CharacterFunction10<A, B, C, D, E, F, G, H, I, J> wrapped) {
    // stacking this wrapper multiple times should be idempotent:
    if (wrapped instanceof CharacterDefaultOnNullArgument10) {
      _wrapped = ((CharacterDefaultOnNullArgument10) wrapped)._wrapped;
    } else {
  ...
  public CharacterDefaultOnNullArgument10<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
    return new CharacterDefaultOnNullArgument10<>(
        ((CharacterFunction10.Serializable<A, B, C, D, E, F, G, H, I, J>) _wrapped).safelySerializable());
  }
