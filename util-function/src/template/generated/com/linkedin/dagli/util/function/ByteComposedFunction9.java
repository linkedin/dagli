...
/**
 * A function class implementing {@link ByteFunction9.Serializable} that composes
 * {@link ByteFunction9} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ByteComposedFunction9<A, B, C, D, E, F, G, H, I, Q> implements
   ...
   *                as input
   */
  ByteComposedFunction9(Function9<A, B, C, D, E, F, G, H, I, Q> first, ByteFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ByteComposedFunction9<A, B, C, D, E, F, G, H, I, Q> safelySerializable() {
    return new ByteComposedFunction9<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ByteComposedFunction9.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ByteComposedFunction9) {
      return this._first.equals(((ByteComposedFunction9) obj)._first)
          && this._andThen.equals(((ByteComposedFunction9) obj)._andThen);
    }
    return false;
  }
