...
@FunctionalInterface
public interface CharacterFunction1<A> extends FunctionBase {
  char apply(A value1);
   ...
   */
  default CharacterFunction1<A> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument1<>(this);
  }

  static <A> CharacterFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction1.Serializable should override this method
   ...
   */
  static <A> CharacterFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends CharacterFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new CharacterMethodReference1<A>(this);
