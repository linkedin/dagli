 ...
 */
class ShortMethodReference9<A, B, C, D, E, F, G, H, I> implements
  ...
  private static final int CLASS_HASH = ShortMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  ShortMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof ShortMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference9) func)._methodReference;
    } else {
  ...
  private ShortFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new ShortMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference9) obj)._methodReference);
  }
