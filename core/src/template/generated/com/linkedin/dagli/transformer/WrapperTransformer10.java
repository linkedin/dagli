 ...
 */
@ValueEquality
public class WrapperTransformer10<A, B, C, D, E, F, G, H, I, J, R, S extends WrapperTransformer10<A, B, C, D, E, F, G, H, I, J, R, S>>
    extends
    AbstractPreparableTransformer10<A, B, C, D, E, F, G, H, I, J, R, PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>, S> {

  private static final long serialVersionUID = 1;

  protected PreparableTransformer10<A, B, C, D, E, F, G, H, I, J, R, ?> _wrappedTransformer = null;
   ...
   */
  public WrapperTransformer10(
      PreparableTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R, ?> wrappedTransformer) {
   ...
   * class' constructor using {@link #setWrappedTransformer(PreparableTransformer10)}
   */
  public WrapperTransformer10() {
  }
   ...
   */
  protected WrapperTransformer10<A, B, C, D, E, F, G, H, I, J, R, S> withWrappedTransformer(
      PreparableTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R, ?> wrapped) {
  ...
  protected void setWrappedTransformer(
      PreparableTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R, ?> wrapped) {
    _wrappedTransformer = PreparableTransformer10.castWithGenericPrepared(wrapped);
    ...
    _input8 = _wrappedTransformer.internalAPI().getInput8();
    _input9 = _wrappedTransformer.internalAPI().getInput9();
    _input10 = _wrappedTransformer.internalAPI().getInput10();
  ...
  @Override
  protected Preparer10<A, B, C, D, E, F, G, H, I, J, R, PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>> getPreparer(
      PreparerContext context) {
    return Preparer10.cast(_wrappedTransformer.internalAPI().getPreparer(context));
  }
  ...
  * @param <R> the type of result produced by the transformer
   ...
   */
  @ValueEquality
  public static abstract class Prepared<A, B, C, D, E, F, G, H, I, J, R, S extends WrapperTransformer10.Prepared<A, B, C, D, E, F, G, H, I, J, R, S>>
      extends AbstractPreparedStatefulTransformer10<A, B, C, D, E, F, G, H, I, J, R, Object, S> {

    private static final long serialVersionUID = 1;

    protected PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R> _wrappedTransformer = null;
     ...
     */
    public Prepared(
        PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R> wrappedTransformer) {
      setWrappedTransformer(wrappedTransformer);
    }

    /**
     * Constructs a new instance that will initially lack a wrapped transformer (this should be set during the derived
     * class' constructor using {@link #setWrappedTransformer(PreparedTransformer10)}
     */
    public Prepared() {
    }
     ...
     * @param wrapped the transformer to wrap
     */
    protected WrapperTransformer10.Prepared<A, B, C, D, E, F, G, H, I, J, R, S> withWrappedTransformer(
        PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R> wrapped) {
      return clone(c -> c.setWrappedTransformer(wrapped));
    }
    ...
    protected void setWrappedTransformer(
        PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R> wrapped) {
      _wrappedTransformer = PreparedTransformer10.cast(wrapped);
      _input1 = _wrappedTransformer.internalAPI().getInput1();
      _input2 = _wrappedTransformer.internalAPI().getInput2();
      _input3 = _wrappedTransformer.internalAPI().getInput3();
      _input4 = _wrappedTransformer.internalAPI().getInput4();
    ...
    public R apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10) {
      return _wrappedTransformer.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10);
    }
    ...
    public ObjectReader<R> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
      ...
      return _wrappedTransformer.applyAll(values1, values2, values3, values4, values5, values6, values7, values8,
          values9, values10);
    }
    ...
    protected void applyAll(Object executionCache, List<? extends A> values1, List<? extends B> values2,
        ...
        List<? extends G> values7, List<? extends H> values8, List<? extends I> values9, List<? extends J> values10,
        List<? super R> results) {
      _wrappedTransformer.internalAPI().applyAllUnsafe(executionCache, values1.size(),
          Arrays.asList(values1, values2, values3, values4, values5, values6, values7, values8, values9, values10),
          results);
    }
