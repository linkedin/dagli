...
class DoubleMethodReference9<A, B, C, D, E, F, G, H, I> implements
  ...
  private static final int CLASS_HASH = DoubleMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient DoubleFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  DoubleMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public DoubleMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof DoubleMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((DoubleMethodReference9) func)._methodReference;
    } else {
  ...
  private DoubleFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      DoubleMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new DoubleMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (DoubleFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(DoubleFunction9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof DoubleMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((DoubleMethodReference9) obj)._methodReference);
  }
