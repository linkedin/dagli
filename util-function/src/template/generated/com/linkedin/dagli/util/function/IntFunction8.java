...
@FunctionalInterface
public interface IntFunction8<A, B, C, D, E, F, G, H> extends FunctionBase {
  int apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8);
   ...
   */
  default IntFunction8<A, B, C, D, E, F, G, H> returnZeroOnNullArgument() {
    return new IntDefaultOnNullArgument8<>(this);
  }

  static <A, B, C, D, E, F, G, H> IntFunction8<A, B, C, D, E, F, G, H> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, H, X extends Throwable> extends FunctionBase {
    int apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement IntFunction8.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H> IntFunction8.Serializable<A, B, C, D, E, F, G, H> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H> extends IntFunction8<A, B, C, D, E, F, G, H>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F, G, H> safelySerializable() {
      try {
        return new IntMethodReference8<A, B, C, D, E, F, G, H>(this);
