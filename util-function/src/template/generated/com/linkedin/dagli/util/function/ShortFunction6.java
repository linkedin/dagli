...
@FunctionalInterface
public interface ShortFunction6<A, B, C, D, E, F> extends FunctionBase {
  short apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default ShortFunction6<A, B, C, D, E, F> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument6<>(this);
  }

  static <A, B, C, D, E, F> ShortFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    short apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ShortFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> ShortFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends ShortFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new ShortMethodReference6<A, B, C, D, E, F>(this);
