...
@FunctionalInterface
public interface VoidFunction1<A> extends FunctionBase, Consumer<A> {
  void apply(A value1);
   ...
   */
  default VoidFunction1<A> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument1<>(this);
  }

  @Override
  default void accept(A value1) {
    apply(value1);
  }

  static <A> VoidFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
        checkedFunction.apply(value1);
      } catch (Throwable e) {
   ...
   *
   * Function objects that wrap functions and implement VoidFunction1.Serializable should override this method
   ...
   */
  static <A> VoidFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends VoidFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new VoidMethodReference1<A>(this);
    ...
    @Override
    default Serializable<A> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument1<>(this);
    }
