...
/**
 * A function class implementing {@link DoubleFunction8.Serializable} that composes
 * {@link DoubleFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class DoubleComposedFunction8<A, B, C, D, E, F, G, H, Q> implements
   ...
   *                as input
   */
  DoubleComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, DoubleFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public DoubleComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new DoubleComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(DoubleComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof DoubleComposedFunction8) {
      return this._first.equals(((DoubleComposedFunction8) obj)._first)
          && this._andThen.equals(((DoubleComposedFunction8) obj)._andThen);
    }
    return false;
  }
