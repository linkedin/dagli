 ...
 *
 * DAG3x8 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x8 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>
    implements
    PreparableDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> {
   ...
   */
  DAG3x8(DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> {
    @Override
    ...
    @Override
    public DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
      return DAG3x8.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
   ...
   */
  public DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3) {
   ...
   */
  public DAG2x8<B, C, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG2x8<A, C, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG2x8<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag =
   ...
   * @param <RH> the type of the eighth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractBatchPreparer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> {
    // the DAG being prepared
    private final DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> _dag;
     ...
     */
    Preparer(DAG3x8<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> res =
    ...
    return new Result<>((DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>) res.getPreparerResult()
   ...
   */
  public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RH> the type of the eighth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> extends
      AbstractDAGResult8<RA, RB, RC, RD, RE, RF, RG, RH> {
    // the prepared DAG
    private final DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RH> the type of the eighth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractPreparedTransformer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>
      implements
      PreparedDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>> {
      @Override
      public DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
        return DAG3x8.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x8.Prepared<B, C, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x8.Prepared<A, C, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag =
          this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x8.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x8.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH> dag =
          this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    public Result<RA, RB, RC, RD, RE, RF, RG, RH> applyAll(Iterable<? extends A> values1,
        Iterable<? extends B> values2, Iterable<? extends C> values3) {
      return new Result<RA, RB, RC, RD, RE, RF, RG, RH>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) }));
    }

    @Override
    public Tuple8<RA, RB, RC, RD, RE, RF, RG, RH> apply(A value1, B value2, C value3) {
      try (
