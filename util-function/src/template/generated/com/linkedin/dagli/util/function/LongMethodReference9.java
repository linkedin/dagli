 ...
 */
class LongMethodReference9<A, B, C, D, E, F, G, H, I> implements LongFunction9.Serializable<A, B, C, D, E, F, G, H, I>,
    Named {
  ...
  private static final int CLASS_HASH = LongMethodReference9.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction9<A, B, C, D, E, F, G, H, I> _cachedFunction = null;

  LongMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof LongMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference9) func)._methodReference;
    } else {
  ...
  private LongFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new LongMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction9.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference9)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference9) obj)._methodReference);
  }
