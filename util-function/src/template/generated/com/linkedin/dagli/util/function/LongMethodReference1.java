 ...
 */
class LongMethodReference1<A> implements LongFunction1.Serializable<A>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference1.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction1<A> _cachedFunction = null;

  LongMethodReference1(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference1(Serializable<A> func) {
    if (func instanceof LongMethodReference1) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference1) func)._methodReference;
    } else {
  ...
  private LongFunction1<A> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference2<Object, A> unbound = new LongMethodReference2<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction1<A>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction1.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference1)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference1) obj)._methodReference);
  }
