 ...
 * {@link PreparerMode#STREAM} modes, it should derive from {@link AbstractBatchPreparer3} or
 * {@link AbstractStreamPreparer3} instead.
 *
 ...
 */
public abstract class AbstractPreparer3<A, B, C, R, N extends PreparedTransformer3<A, B, C, R>> extends
    AbstractPreparer<R, N> implements Preparer3<A, B, C, R, N> {

  @Override
  public final void processUnsafe(Object[] values) {
    Preparer3.super.processUnsafe(values);
  }

  @Override
  public final PreparerResultMixed<? extends PreparedTransformer3<? super A, ? super B, ? super C, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return Preparer3.super.finishUnsafe(inputs);
  }
}
