...
public interface PreparableTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, N extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>, S extends PreparableTransformer8<A, B, C, D, E, F, G, H, R, N>>
    extends Transformer8InternalAPI<A, B, C, D, E, F, G, H, R, S>, PreparableTransformerInternalAPI<R, N, S> {

  @Override
  Preparer8<A, B, C, D, E, F, G, H, R, N> getPreparer(PreparerContext context);

  default PreparerResultMixed<? extends PreparedTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R>, N> prepare(
    ...
    Preparer8<A, B, C, D, E, F, G, H, R, N> preparer = getPreparer(context);
    ...
    return preparer.finishUnsafe(new ConcatenatedReader<>(Object[]::new, ObjectReader.wrap(values1), ObjectReader
        ...
        ObjectReader.wrap(values6), ObjectReader.wrap(values7), ObjectReader.wrap(values8)));
  }
  ...
  default PreparerResultMixed<? extends PreparedTransformer8<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R>, N> prepare(
    ...
    return prepare(PreparerContext.builder(values1.size()).setExecutor(executor).build(), values1, values2, values3,
        values4, values5, values6, values7, values8);
  }

  @Override
  default <I> PreparableTransformer9<A, B, C, D, E, F, G, H, I, R, ? extends PreparedTransformer9<A, B, C, D, E, F, G, H, I, R>> withArity9(
      Producer<? extends I> newInput9) {
  ...
  @Override
  default <N> PreparableTransformer9<N, A, B, C, D, E, F, G, H, R, ? extends PreparedTransformer9<N, A, B, C, D, E, F, G, H, R>> withPrependedArity9(
  ...
  @Override
  default PreparableTransformer1<Tuple8<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G, ? extends H>, R, ? extends PreparedTransformer1<Tuple8<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G, ? extends H>, R>> withArity1(
