 ...
 */
class CharacterMethodReference5<A, B, C, D, E> implements CharacterFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction5<A, B, C, D, E> _cachedFunction = null;

  CharacterMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof CharacterMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference5) func)._methodReference;
    } else {
  ...
  private CharacterFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference6<Object, A, B, C, D, E> unbound =
          new CharacterMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction5.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference5) obj)._methodReference);
  }
