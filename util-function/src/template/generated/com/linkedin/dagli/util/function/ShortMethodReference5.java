 ...
 */
class ShortMethodReference5<A, B, C, D, E> implements ShortFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = ShortMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient ShortFunction5<A, B, C, D, E> _cachedFunction = null;

  ShortMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public ShortMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof ShortMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((ShortMethodReference5) func)._methodReference;
    } else {
  ...
  private ShortFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      ShortMethodReference6<Object, A, B, C, D, E> unbound = new ShortMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (ShortFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(ShortFunction5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof ShortMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((ShortMethodReference5) obj)._methodReference);
  }
