 ...
 *
 * DAG1x9 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG1x9 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>
    extends
    AbstractPreparableTransformer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
    implements
    PreparableDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
   ...
   */
  DAG1x9(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1) {
    super(input1);
    _dag = dag;
   ...
   */
  @Override
  public DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    @Override
    ...
    @Override
    public DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
      return DAG1x9.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
   ...
   */
  public DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInput(Producer<? extends A> input1) {
   ...
   * @param <RI> the type of the ninth result
   */
  private static class Preparer<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractBatchPreparer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    // the DAG being prepared
    private final DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> _dag;
     ...
     */
    Preparer(DAG1x9<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> finish(
  ...
  @Override
  protected Preparer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepareAndApply(Iterable<? extends A> values1) {
    DAGExecutionResult<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this, new ObjectReader[] { ObjectReader.wrap(values1) });
    return new Result<>((DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>) res.getPreparerResult()
   ...
   */
  public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepare(Iterable<? extends A> values1) {
    return (DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>) _executor.internalAPI()
  ...
  * @param <RI> the type of the ninth result
   */
  public static final class Result<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
      AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
    // the prepared DAG
    private final DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RI> the type of the ninth result
   */
  @ValueEquality
  public static class Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractPreparedTransformer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
      implements
      PreparedDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    ...
    * @param input1 the {@link Producer} providing the first input to the transformer
     ...
     */
    @Override
    public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer1<A, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
      @Override
      public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
        return DAG1x9.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parent
     */
    public DAG1x9.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInput(Producer<? extends A> input1) {
      return super.withAllInputs(input1);
    }
    ...
    @Override
    public Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI> apply(A value1) {
      try (
