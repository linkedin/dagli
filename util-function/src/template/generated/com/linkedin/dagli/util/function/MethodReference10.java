 ...
 */
class MethodReference10<A, B, C, D, E, F, G, H, I, J, R> implements
    Function10.Serializable<A, B, C, D, E, F, G, H, I, J, R>, Named {
  ...
  private static final int CLASS_HASH = MethodReference10.class.hashCode();

  private final MethodReference _methodReference;
  private transient Function10<A, B, C, D, E, F, G, H, I, J, R> _cachedFunction = null;

  MethodReference10(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public MethodReference10(Serializable<A, B, C, D, E, F, G, H, I, J, R> func) {
    if (func instanceof MethodReference10) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((MethodReference10) func)._methodReference;
    } else {
  ...
  private Function10<A, B, C, D, E, F, G, H, I, J, R> fromMethodReference() {
    if (_methodReference.isBound()) {
      MethodReference11<Object, A, B, C, D, E, F, G, H, I, J, R> unbound =
          new MethodReference11<>(_methodReference.unbind());
    ...
    try {
      ...
      return (Function10<A, B, C, D, E, F, G, H, I, J, R>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(Function10.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MethodReference10)) {
      return false;
    }

    return _methodReference.equals(((MethodReference10) obj)._methodReference);
  }
