 ...
 */
class LongMethodReference5<A, B, C, D, E> implements LongFunction5.Serializable<A, B, C, D, E>, Named {
  ...
  private static final int CLASS_HASH = LongMethodReference5.class.hashCode();

  private final MethodReference _methodReference;
  private transient LongFunction5<A, B, C, D, E> _cachedFunction = null;

  LongMethodReference5(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public LongMethodReference5(Serializable<A, B, C, D, E> func) {
    if (func instanceof LongMethodReference5) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((LongMethodReference5) func)._methodReference;
    } else {
  ...
  private LongFunction5<A, B, C, D, E> fromMethodReference() {
    if (_methodReference.isBound()) {
      LongMethodReference6<Object, A, B, C, D, E> unbound = new LongMethodReference6<>(_methodReference.unbind());
    ...
    try {
      ...
      return (LongFunction5<A, B, C, D, E>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(LongFunction5.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof LongMethodReference5)) {
      return false;
    }

    return _methodReference.equals(((LongMethodReference5) obj)._methodReference);
  }
