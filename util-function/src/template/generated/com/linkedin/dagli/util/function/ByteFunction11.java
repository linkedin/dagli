...
@FunctionalInterface
interface ByteFunction11<A, B, C, D, E, F, G, H, I, J, K> extends FunctionBase {
  byte apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10,
      K value11);
   ...
   */
  default ByteFunction11<A, B, C, D, E, F, G, H, I, J, K> returnZeroOnNullArgument() {
    return new ByteDefaultOnNullArgument11<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J, K> ByteFunction11<A, B, C, D, E, F, G, H, I, J, K> unchecked(
   ...
   *
   * Function objects that wrap functions and implement ByteFunction11.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J, K> ByteFunction11.Serializable<A, B, C, D, E, F, G, H, I, J, K> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J, K> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J, K> extends ByteFunction11<A, B, C, D, E, F, G, H, I, J, K>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J, K> safelySerializable() {
      try {
        return new ByteMethodReference11<A, B, C, D, E, F, G, H, I, J, K>(this);
