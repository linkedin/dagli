 ...
 *
 * DAG6x6 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG6x6 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>
    extends
    AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>, DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>
    implements
    PreparableDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>, DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> {
   ...
   */
  DAG6x6(DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>, DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>, DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> {
    @Override
    ...
    @Override
    public DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> getInstance() {
      return DAG6x6.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
   ...
   */
  public DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
   ...
   */
  public DAG5x6<B, C, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG5x6<A, C, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG5x6<A, B, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x6<A, B, C, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput4(Generator<D> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
   ...
   *         the produced by the provided generator
   */
  public DAG5x6<A, B, C, D, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput5(Generator<E> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   *         the produced by the provided generator
   */
  public DAG5x6<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput6(Generator<F> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
   ...
   * @param <RF> the type of the sixth result
   */
  private static class Preparer<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>
      extends
      AbstractBatchPreparer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> {
    // the DAG being prepared
    private final DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> _dag;
     ...
     */
    Preparer(DAG6x6<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> finish(
  ...
  @Override
  protected Preparer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> prepareAndApply(Iterable<? extends A> values1,
    ...
    DAGExecutionResult<Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> res =
        _executor
            .internalAPI()
    ...
    return new Result<>((DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>) res.getPreparerResult()
   ...
   */
  public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3, Iterable<? extends D> values4,
      Iterable<? extends E> values5, Iterable<? extends F> values6) {
    return (DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RF> the type of the sixth result
   */
  public static final class Result<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> extends
      AbstractDAGResult6<RA, RB, RC, RD, RE, RF> {
    // the prepared DAG
    private final DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RF> the type of the sixth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>
      extends
      AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>
      implements
      PreparedDAGTransformer<Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> {
    ...
    * @param input6 the {@link Producer} providing the sixth input to the transformer
     ...
     */
    @Override
    public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer6<A, B, C, D, E, F, Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple6<RA, RB, RC, RD, RE, RF>, DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>> {
      @Override
      public DAGStructure<Tuple6<RA, RB, RC, RD, RE, RF>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> getInstance() {
        return DAG6x6.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5, Producer<? extends F> input6) {
      return super.withAllInputs(input1, input2, input3, input4, input5, input6);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<B, C, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
      Placeholder<F> nestedPlaceholder6 = new Placeholder<>("Original Input 6");
      DAG6x6.Prepared<A, B, C, D, E, F, RA, RB, RC, RD, RE, RF> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6);
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<A, C, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<A, B, D, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<A, B, C, E, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput4(Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<E> nestedPlaceholder5 = new Placeholder<>("Original Input 5");
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<A, B, C, D, F, RA, RB, RC, RD, RE, RF> withGeneratorAsInput5(Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG5x6.Prepared<A, B, C, D, E, RA, RB, RC, RD, RE, RF> withGeneratorAsInput6(Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
    ...
    @Override
    public Tuple6<RA, RB, RC, RD, RE, RF> apply(A value1, B value2, C value3, D value4, E value5, F value6) {
      try (
