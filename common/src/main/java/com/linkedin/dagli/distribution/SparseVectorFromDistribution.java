 ...
 */
@ValueEquality
public class SparseVectorFromDistribution extends
    AbstractPreparedTransformer1WithInput<DiscreteDistribution<?>, SparseFloatArrayVector, SparseVectorFromDistribution> {
   ...
   */
  public SparseVectorFromDistribution() {
    super();
  }
   ...
   */
  public SparseVectorFromDistribution(Producer<? extends DiscreteDistribution<?>> input) {
    super(input);
  }
  ...
  public <T> SparseVectorFromDistribution withInputAndHasher(
