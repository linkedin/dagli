 ...
 */
class FloatMethodReference2<A, B> implements FloatFunction2.Serializable<A, B>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference2.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction2<A, B> _cachedFunction = null;

  FloatMethodReference2(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference2(Serializable<A, B> func) {
    if (func instanceof FloatMethodReference2) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference2) func)._methodReference;
    } else {
  ...
  private FloatFunction2<A, B> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference3<Object, A, B> unbound = new FloatMethodReference3<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction2<A, B>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction2.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference2)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference2) obj)._methodReference);
  }
