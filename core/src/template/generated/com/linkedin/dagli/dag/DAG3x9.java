 ...
 *
 * DAG3x9 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x9 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
    implements
    PreparableDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
   ...
   */
  DAG3x9(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    @Override
    ...
    @Override
    public DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
      return DAG3x9.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
   ...
   */
  public DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3) {
   ...
   */
  public DAG2x9<B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
   ...
   *         the produced by the provided generator
   */
  public DAG2x9<A, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
   ...
   *         the produced by the provided generator
   */
  public DAG2x9<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
   ...
   * @param <RI> the type of the ninth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractBatchPreparer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    // the DAG being prepared
    private final DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> _dag;
     ...
     */
    Preparer(DAG3x9<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> res =
    ...
    return new Result<>((DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>) res.getPreparerResult()
   ...
   */
  public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RI> the type of the ninth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
      AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
    // the prepared DAG
    private final DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RI> the type of the ninth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractPreparedTransformer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
      implements
      PreparedDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
      @Override
      public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
        return DAG3x9.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x9.Prepared<B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x9.Prepared<A, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
          this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x9.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x9.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
          this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    @Override
    public Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI> apply(A value1, B value2, C value3) {
      try (
