...
public abstract class AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, R, N extends PreparedTransformer8<A, B, C, D, E, F, G, H, R>, S extends AbstractPreparableTransformer8<A, B, C, D, E, F, G, H, R, N, S>>
    extends
    AbstractTransformer8<A, B, C, D, E, F, G, H, R, PreparableTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, N, S>, S>
    implements PreparableTransformer8<A, B, C, D, E, F, G, H, R, N> {
  ...
  @Override
  protected PreparableTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, N, S> createInternalAPI() {
    return new InternalAPI();
  }

  protected class InternalAPI
      extends
      AbstractTransformer8<A, B, C, D, E, F, G, H, R, PreparableTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, N, S>, S>.InternalAPI
      implements PreparableTransformer8InternalAPI<A, B, C, D, E, F, G, H, R, N, S> {
    @Override
    public Preparer8<A, B, C, D, E, F, G, H, R, N> getPreparer(PreparerContext context) {
      return AbstractPreparableTransformer8.this.getPreparer(context);
    }
  ...
  protected abstract Preparer8<A, B, C, D, E, F, G, H, R, N> getPreparer(PreparerContext context);

  public AbstractPreparableTransformer8() {
    super();
  }

  public AbstractPreparableTransformer8(Producer<? extends A> input1, Producer<? extends B> input2,
