 ...
 */
class CharacterMethodReference6<A, B, C, D, E, F> implements CharacterFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction6<A, B, C, D, E, F> _cachedFunction = null;

  CharacterMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof CharacterMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference6) func)._methodReference;
    } else {
  ...
  private CharacterFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference7<Object, A, B, C, D, E, F> unbound =
          new CharacterMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction6.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference6) obj)._methodReference);
  }
