 ...
 */
class VoidMethodReference9<A, B, C, D, E, F, G, H, I> implements VoidFunction9.Serializable<A, B, C, D, E, F, G, H, I> {
  ...
  VoidMethodReference9(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public VoidMethodReference9(Serializable<A, B, C, D, E, F, G, H, I> func) {
    if (func instanceof VoidMethodReference9) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((VoidMethodReference9) func)._methodReference;
    } else {
  ...
  private VoidFunction9<A, B, C, D, E, F, G, H, I> fromMethodReference() {
    if (_methodReference.isBound()) {
      VoidMethodReference10<Object, A, B, C, D, E, F, G, H, I> unbound =
          new VoidMethodReference10<>(_methodReference.unbind());
    ...
    try {
      ...
      return (VoidFunction9<A, B, C, D, E, F, G, H, I>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(VoidFunction9.class), type, mh,
  ...
  public void apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) {
    _cachedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return _methodReference.equals(((VoidMethodReference9) obj)._methodReference);
  }
