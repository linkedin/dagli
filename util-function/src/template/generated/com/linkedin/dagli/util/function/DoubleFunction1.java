...
@FunctionalInterface
public interface DoubleFunction1<A> extends FunctionBase, ToDoubleFunction<A> {
  double apply(A value1);
   ...
   */
  default DoubleFunction1<A> returnZeroOnNullArgument() {
    return new DoubleDefaultOnNullArgument1<>(this);
  }

  @Override
  default double applyAsDouble(A value1) {
    return apply(value1);
  }

  static <A> DoubleFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
  ...
  interface Checked<A, X extends Throwable> extends FunctionBase {
    double apply(A value1) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement DoubleFunction1.Serializable should override this method
   ...
   */
  static <A> DoubleFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends DoubleFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new DoubleMethodReference1<A>(this);
