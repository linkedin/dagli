...
@FunctionalInterface
public interface VoidFunction10<A, B, C, D, E, F, G, H, I, J> extends FunctionBase {
   ...
   */
  default VoidFunction10<A, B, C, D, E, F, G, H, I, J> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument10<>(this);
  }

  static <A, B, C, D, E, F, G, H, I, J> VoidFunction10<A, B, C, D, E, F, G, H, I, J> unchecked(
    ...
    return (A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10);
      } catch (Throwable e) {
   ...
   *
   * Function objects that wrap functions and implement VoidFunction10.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I, J> VoidFunction10.Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I, J> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I, J> extends VoidFunction10<A, B, C, D, E, F, G, H, I, J>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I, J> safelySerializable() {
      try {
        return new VoidMethodReference10<A, B, C, D, E, F, G, H, I, J>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H, I, J> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument10<>(this);
    }
