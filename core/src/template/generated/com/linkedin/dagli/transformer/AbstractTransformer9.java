...
abstract class AbstractTransformer9<A, B, C, D, E, F, G, H, I, R, IF extends Transformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, S>, S extends AbstractTransformer9<A, B, C, D, E, F, G, H, I, R, IF, S>>
    extends AbstractTransformer<R, IF, S> implements Transformer9<A, B, C, D, E, F, G, H, I, R> {
  ...
  public AbstractTransformer9(Producer<? extends A> input1, Producer<? extends B> input2, Producer<? extends C> input3,
  ...
  /**
   * Returns a copy of this instance that will accept the provided {@link Producer} as its ninth
   * input.
   *
  ...
  protected abstract class InternalAPI extends AbstractTransformer<R, IF, S>.InternalAPI implements
      Transformer9InternalAPI<A, B, C, D, E, F, G, H, I, R, S> {
    @Override
    public Producer<? extends A> getInput1() {
      return AbstractTransformer9.this.getInput1();
    }

    @Override
    public Producer<? extends B> getInput2() {
      return AbstractTransformer9.this.getInput2();
    }

    @Override
    public Producer<? extends C> getInput3() {
      return AbstractTransformer9.this.getInput3();
    }

    @Override
    public Producer<? extends D> getInput4() {
      return AbstractTransformer9.this.getInput4();
    }

    @Override
    public Producer<? extends E> getInput5() {
      return AbstractTransformer9.this.getInput5();
    }

    @Override
    public Producer<? extends F> getInput6() {
      return AbstractTransformer9.this.getInput6();
    }

    @Override
    public Producer<? extends G> getInput7() {
      return AbstractTransformer9.this.getInput7();
    }

    @Override
    public Producer<? extends H> getInput8() {
      return AbstractTransformer9.this.getInput8();
    }

    @Override
    public Producer<? extends I> getInput9() {
      return AbstractTransformer9.this.getInput9();
    }
    ...
    public S withInputs(Producer<? extends A> input1, Producer<? extends B> input2, Producer<? extends C> input3,
        Producer<? extends D> input4, Producer<? extends E> input5, Producer<? extends F> input6,
        Producer<? extends G> input7, Producer<? extends H> input8, Producer<? extends I> input9) {
      return AbstractTransformer9.this.withAllInputs(input1, input2, input3, input4, input5, input6, input7, input8,
          input9);
    }

    @Override
    public List<Producer<?>> getInputList() {
      return AbstractTransformer9.this.getInputList();
    }
  }
}
