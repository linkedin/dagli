...
import com.linkedin.dagli.transformer.internal.PreparableTransformer7InternalAPI;
import com.linkedin.dagli.util.collection.Iterables;


public interface PreparableTransformer7<A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>>
    extends Transformer7<A, B, C, D, E, F, G, R>, PreparableTransformer<R, N> {

  @Override
  PreparableTransformer7InternalAPI<A, B, C, D, E, F, G, R, N, ? extends PreparableTransformer7<A, B, C, D, E, F, G, R, N>> internalAPI();
  ...
  static <A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>> PreparableTransformer7<A, B, C, D, E, F, G, R, N> cast(
      PreparableTransformer7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R, ? extends N> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer7<A, B, C, D, E, F, G, R, N>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, R> PreparableTransformer7<A, B, C, D, E, F, G, R, PreparedTransformer7<A, B, C, D, E, F, G, R>> castWithGenericPrepared(
      PreparableTransformer7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R, ?> preparable) {
    // safe due to semantics of preparable transformers:
    return (PreparableTransformer7<A, B, C, D, E, F, G, R, PreparedTransformer7<A, B, C, D, E, F, G, R>>) preparable;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, R, N extends PreparedTransformer7<A, B, C, D, E, F, G, R>> PreparerResultMixed<PreparedTransformer7<A, B, C, D, E, F, G, R>, N> prepare(
      PreparableTransformer7<A, B, C, D, E, F, G, R, N> preparable, Iterable<? extends A> values1,
    ...
    return (PreparerResultMixed<PreparedTransformer7<A, B, C, D, E, F, G, R>, N>) preparable.internalAPI().prepare(
   ...
   */
  @SuppressWarnings("unchecked")
  static <A, B, C, D, E, F, G, R> DAG7x1<A, B, C, D, E, F, G, R> toDAG(
      PreparableTransformer7<A, B, C, D, E, F, G, R, ?> transformer) {
    if (transformer instanceof DAG7x1) {
      return (DAG7x1<A, B, C, D, E, F, G, R>) transformer;
    }
    ...
    return DAG
        ...
        .withAllInputs(transformer.internalAPI().getInput1(), transformer.internalAPI().getInput2(),
            ...
            transformer.internalAPI().getInput7());
  }
}
