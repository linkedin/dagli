...
/**
 * Base class for prepared transformers of arity 10 that extends {@link AbstractPreparedTransformer10} to
 ...
 */
public abstract class AbstractPreparedStatefulTransformer10<A, B, C, D, E, F, G, H, I, J, R, Q, S extends AbstractPreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R, S>>
    extends AbstractPreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R, S> {

  private static final long serialVersionUID = 1;

  public AbstractPreparedStatefulTransformer10() {
    super();
  }

  public AbstractPreparedStatefulTransformer10(Producer<? extends A> input1, Producer<? extends B> input2,
  ...
  public R apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10) {
    return apply(createExecutionCache(1), value1, value2, value3, value4, value5, value6, value7, value8, value9,
        value10);
  }
   ...
   * @param value9 the 9'th input value
   * @param value10 the 10'th input value
   ...
   *                   or stored past the end of the method call
   * @param values9 a parallel list of inputs corresponding to the examples being transformed; must not be modified
   *                   or stored past the end of the method call
   * @param values10 a parallel list of inputs corresponding to the examples being transformed; must not be modified
   *                   or stored past the end of the method call
  ...
  protected void applyAll(Q executionCache, List<? extends A> values1, List<? extends B> values2,
    ...
    for (int i = 0; i < values1.size(); i++) {
      results.add(apply(executionCache, values1.get(i), values2.get(i), values3.get(i), values4.get(i), values5.get(i),
          values6.get(i), values7.get(i), values8.get(i), values9.get(i), values10.get(i)));
    }
  }
  ...
  protected class InternalAPI extends AbstractPreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R, S>.InternalAPI {
    @Override
    public R apply(Object executionCache, A value1, B value2, C value3, D value4, E value5, F value6, G value7,
        H value8, I value9, J value10) {
      return AbstractPreparedStatefulTransformer10.this.apply((Q) executionCache, value1, value2, value3, value4,
          value5, value6, value7, value8, value9, value10);
    }

    @Override
    public Object createExecutionCache(long exampleCountGuess) {
      return AbstractPreparedStatefulTransformer10.this.createExecutionCache(exampleCountGuess);
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, Object[][] values, Object[] results) {
      AbstractPreparedStatefulTransformer10.this.applyAll((Q) executionCache, new UnmodifiableArrayList<>(
          ...
          (G[]) values[6], count), new UnmodifiableArrayList<>((H[]) values[7], count), new UnmodifiableArrayList<>(
          (I[]) values[8], count), new UnmodifiableArrayList<>((J[]) values[9], count), new FixedCapacityArrayList<>(
          results));
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, List<? extends List<?>> values, List<? super R> results) {
      AbstractPreparedStatefulTransformer10.this.applyAll((Q) executionCache,
          ...
          (List<G>) Lists.limit(values.get(6), count), (List<H>) Lists.limit(values.get(7), count),
          (List<I>) Lists.limit(values.get(8), count), (List<J>) Lists.limit(values.get(9), count), results);
    }

    @Override
    public int getPreferredMinibatchSize() {
      return AbstractPreparedStatefulTransformer10.this.getPreferredMinibatchSize();
    }
  }
}
