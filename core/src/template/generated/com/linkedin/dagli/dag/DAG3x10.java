 ...
 *
 * DAG3x10 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x10 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
    implements
    PreparableDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
   ...
   */
  DAG3x10(DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    @Override
    ...
    @Override
    public DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
      return DAG3x10.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
   ...
   */
  public DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInputs(Producer<? extends A> input1,
      Producer<? extends B> input2, Producer<? extends C> input3) {
   ...
   */
  public DAG2x10<B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            ...
            new Value9FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput2(), getInput3());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG2x10<A, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput2(Generator<B> generator) {
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag),
            new Value9FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput3());
  }
   ...
   *         the produced by the provided generator
   */
  public DAG2x10<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
    ...
    return DAG
        ...
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag),
            new Value9FromTuple<>(dag)).withExecutor(_executor).withInputs(getInput1(), getInput2());
  }
   ...
   * @param <RJ> the type of the tenth result
   */
  private static class Preparer<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractBatchPreparer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    // the DAG being prepared
    private final DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _dag;
     ...
     */
    Preparer(DAG3x10<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepareAndApply(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> res =
    ...
    return new Result<>((DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) res.getPreparerResult()
   ...
   */
  public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> prepare(Iterable<? extends A> values1,
      Iterable<? extends B> values2, Iterable<? extends C> values3) {
    return (DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RJ> the type of the tenth result
   */
  public static final class Result<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> extends
      AbstractDAGResult10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> {
    // the prepared DAG
    private final DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RJ> the type of the tenth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>
      extends
      AbstractPreparedTransformer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>
      implements
      PreparedDAGTransformer<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer3<A, B, C, Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>, DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> {
      @Override
      public DAGStructure<Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> getInstance() {
        return DAG3x10.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withInputs(Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x10.Prepared<B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x10.Prepared<A, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
          this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x10.Prepared<A, B, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x10.Prepared<A, B, C, RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> dag =
          this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    @Override
    public Tuple10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> apply(A value1, B value2, C value3) {
      try (
