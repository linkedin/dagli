...
/**
 * A tuple of arity ArrayTuple6<A, B, C, D, E, F> that is backed by an array.
 ...
 */
final class ArrayTuple6<A, B, C, D, E, F> extends AbstractTuple implements Tuple6<A, B, C, D, E, F> {
   ...
   */
  public ArrayTuple6(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(6);
    System.arraycopy(_array, 0, result, 0, 6);
    return result;
  }
}
