...
@FunctionalInterface
public interface CharacterFunction9<A, B, C, D, E, F, G, H, I> extends FunctionBase {
  char apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9);
   ...
   */
  default CharacterFunction9<A, B, C, D, E, F, G, H, I> returnZeroOnNullArgument() {
    return new CharacterDefaultOnNullArgument9<>(this);
  }

  static <A, B, C, D, E, F, G, H, I> CharacterFunction9<A, B, C, D, E, F, G, H, I> unchecked(
      Checked<A, B, C, D, E, F, G, H, I, ?> checkedFunction) {
  ...
  @FunctionalInterface
  interface Checked<A, B, C, D, E, F, G, H, I, X extends Throwable> extends FunctionBase {
    char apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement CharacterFunction9.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I> CharacterFunction9.Serializable<A, B, C, D, E, F, G, H, I> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I> extends CharacterFunction9<A, B, C, D, E, F, G, H, I>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I> safelySerializable() {
      try {
        return new CharacterMethodReference9<A, B, C, D, E, F, G, H, I>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F, G, H, I> returnZeroOnNullArgument() {
      return new CharacterDefaultOnNullArgument9<>(this);
    }
