 ...
 */
class IntMethodReference6<A, B, C, D, E, F> implements IntFunction6.Serializable<A, B, C, D, E, F>, Named {
  ...
  private static final int CLASS_HASH = IntMethodReference6.class.hashCode();

  private final MethodReference _methodReference;
  private transient IntFunction6<A, B, C, D, E, F> _cachedFunction = null;

  IntMethodReference6(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public IntMethodReference6(Serializable<A, B, C, D, E, F> func) {
    if (func instanceof IntMethodReference6) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((IntMethodReference6) func)._methodReference;
    } else {
  ...
  private IntFunction6<A, B, C, D, E, F> fromMethodReference() {
    if (_methodReference.isBound()) {
      IntMethodReference7<Object, A, B, C, D, E, F> unbound = new IntMethodReference7<>(_methodReference.unbind());
    ...
    try {
      ...
      return (IntFunction6<A, B, C, D, E, F>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(IntFunction6.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IntMethodReference6)) {
      return false;
    }

    return _methodReference.equals(((IntMethodReference6) obj)._methodReference);
  }
