 ...
 *
 * DAG10x9 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG10x9 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>
    extends
    AbstractPreparableTransformer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
    implements
    PreparableDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {

  private static final long serialVersionUID = 1;

  // the DAGStructure stores the actual graph
  private DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> _dag;
   ...
   * @param input9 the {@link Producer} providing the ninth input to the transformer
   * @param input10 the {@link Producer} providing the tenth input to the transformer
   */
  DAG10x9(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1,
   ...
   */
  @Override
  public DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    @Override
    public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
      return _dag;
    }
    ...
    @Override
    public DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
      return DAG10x9.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
   ...
   */
  public DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(
    ...
    return super.withAllInputs(input1, input2, input3, input4, input5, input6, input7, input8, input9, input10);
  }

  /**
   * Creates a new DAG that invokes this transformer, except that the first input is replaced by the specified {@link Generator}.
   * The resultant DAG will thus have an arity of 9 (one less than this transformer), and values that were formerly
   ...
   */
  public DAG9x9<B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(
    ...
    Placeholder<J> nestedPlaceholder10 = new Placeholder<>("Original Input 10");
    DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
            nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8, nestedPlaceholder9, nestedPlaceholder10);
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput4(
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput5(
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, E, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput6(
    ...
    DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, generator, nestedPlaceholder7, nestedPlaceholder8, nestedPlaceholder9,
            nestedPlaceholder10);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder7, nestedPlaceholder8, nestedPlaceholder9, nestedPlaceholder10)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
        .withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, E, F, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput7(
    ...
    DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, generator, nestedPlaceholder8, nestedPlaceholder9,
            nestedPlaceholder10);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder8, nestedPlaceholder9, nestedPlaceholder10)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
        .withExecutor(_executor)
   ...
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, E, F, G, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput8(
    ...
    DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder7, generator, nestedPlaceholder9,
            nestedPlaceholder10);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder9, nestedPlaceholder10)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
        .withExecutor(_executor)
  ...
  /**
   * Creates a new DAG that invokes this transformer, except that the ninth input is replaced by the specified {@link Generator}.
   * The resultant DAG will thus have an arity of 9 (one less than this transformer), and values that were formerly
   * provided as the ninth input to the transformer will now instead be generated by the {@link Generator}.
   *
   * This method is useful for eliding inputs to a transformer.  For example, a prepared classifier might have a
   * "vestigial" label input (inherited from a corresponding preparable classifier from which it was obtained) that can
   * be replaced by <code>Constant.nullValue()</code>.  Since the label input isn't used by the
   ...
   * it with a null has no effect and eliminates an unnecessary input.
   *
   * @param generator the generator that will provide a value for the ninth input
   * @return a new DAG that invokes this transformer with the same inputs, except the ninth, whose value is replaced by
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, E, F, G, H, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput9(
    ...
    DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
        this.withInputs(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8, generator,
            nestedPlaceholder10);

    return DAG
        .withPlaceholders(nestedPlaceholder1, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4,
            nestedPlaceholder5, nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8, nestedPlaceholder10)
        .withOutputs(new Value0FromTuple<>(dag), new Value1FromTuple<>(dag), new Value2FromTuple<>(dag),
            new Value3FromTuple<>(dag), new Value4FromTuple<>(dag), new Value5FromTuple<>(dag),
            new Value6FromTuple<>(dag), new Value7FromTuple<>(dag), new Value8FromTuple<>(dag))
        .withExecutor(_executor)
        .withInputs(getInput1(), getInput2(), getInput3(), getInput4(), getInput5(), getInput6(), getInput7(),
            getInput8(), getInput10());
  }

  /**
   * Creates a new DAG that invokes this transformer, except that the tenth input is replaced by the specified {@link Generator}.
   * The resultant DAG will thus have an arity of 9 (one less than this transformer), and values that were formerly
   * provided as the tenth input to the transformer will now instead be generated by the {@link Generator}.
   *
   * This method is useful for eliding inputs to a transformer.  For example, a prepared classifier might have a
   * "vestigial" label input (inherited from a corresponding preparable classifier from which it was obtained) that can
   * be replaced by <code>Constant.nullValue()</code>.  Since the label input isn't used by the
   ...
   * it with a null has no effect and eliminates an unnecessary input.
   *
   * @param generator the generator that will provide a value for the tenth input
   * @return a new DAG that invokes this transformer with the same inputs, except the tenth, whose value is replaced by
   *         the produced by the provided generator
   */
  public DAG9x9<A, B, C, D, E, F, G, H, I, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput10(
   ...
   * @param <RI> the type of the ninth result
   */
  private static class Preparer<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractBatchPreparer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    // the DAG being prepared
    private final DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> _dag;
     ...
     */
    Preparer(DAG10x9<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> finish(
        ObjectReader<Tuple10<A, B, C, D, E, F, G, H, I, J>> inputs) {
      return (PreparerResultMixed) _dag._executor.internalAPI().prepareUnsafe(_dag,
          ObjectReader.split(10, inputs.lazyMap(tuple -> tuple.toArray())));
    }
  ...
  @Override
  protected Preparer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> getPreparer(
   ...
   * {@link com.linkedin.dagli.placeholder.Placeholder} in the DAG.
   * @param values9 the sequence of values for the ninth
   * {@link com.linkedin.dagli.placeholder.Placeholder} in the DAG.
   * @param values10 the sequence of values for the tenth
   * {@link com.linkedin.dagli.placeholder.Placeholder} in the DAG.
   * @return a {@link Result} instance containing both the prepared DAG and the result of applying the DAG on the
   *         preparation data
   */
  public Result<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepareAndApply(
    ...
    DAGExecutionResult<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> res =
        _executor
            .internalAPI()
            .prepareAndApplyUnsafe(
                ...
                new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
                    ...
                    .wrap(values8), ObjectReader.wrap(values9), ObjectReader.wrap(values10) });
    return new Result<>((DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>) res
        .getPreparerResult().getPreparedTransformerForNewData(), res.getOutputs());
  }
   ...
   */
  public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> prepare(
      Iterable<? extends A> values1, Iterable<? extends B> values2, Iterable<? extends C> values3,
      Iterable<? extends D> values4, Iterable<? extends E> values5, Iterable<? extends F> values6,
      Iterable<? extends G> values7, Iterable<? extends H> values8, Iterable<? extends I> values9,
      Iterable<? extends J> values10) {
    return (DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>) _executor
        .internalAPI()
        .prepareUnsafe(
            this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3), ObjectReader
  ...
  * @param <RI> the type of the ninth result
   */
  public static final class Result<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
      AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
    // the prepared DAG
    private final DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> preparedDAG,
        ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RI> the type of the ninth result
   */
  @ValueEquality
  public static class Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>
      extends
      AbstractPreparedTransformer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>
      implements
      PreparedDAGTransformer<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
    ...
    * @param input10 the {@link Producer} providing the tenth input to the transformer
     */
    Prepared(DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> dag, Producer<? extends A> input1,
        Producer<? extends B> input2, Producer<? extends C> input3, Producer<? extends D> input4,
        Producer<? extends E> input5, Producer<? extends F> input6, Producer<? extends G> input7,
        Producer<? extends H> input8, Producer<? extends I> input9, Producer<? extends J> input10) {
      super(input1, input2, input3, input4, input5, input6, input7, input8, input9, input10);
     ...
     */
    @Override
    public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withReduction(
        Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer10<A, B, C, D, E, F, G, H, I, J, Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>, DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>> {
      @Override
      public DAGStructure<Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> getInstance() {
        return DAG10x9.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withExecutor(
        PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withInputs(
        Producer<? extends A> input1, Producer<? extends B> input2, Producer<? extends C> input3,
        Producer<? extends D> input4, Producer<? extends E> input5, Producer<? extends F> input6,
        Producer<? extends G> input7, Producer<? extends H> input8, Producer<? extends I> input9,
        Producer<? extends J> input10) {
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput1(
        Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
      ...
      Placeholder<I> nestedPlaceholder9 = new Placeholder<>("Original Input 9");
      Placeholder<J> nestedPlaceholder10 = new Placeholder<>("Original Input 10");
      DAG10x9.Prepared<A, B, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> dag =
          this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3, nestedPlaceholder4, nestedPlaceholder5,
              nestedPlaceholder6, nestedPlaceholder7, nestedPlaceholder8, nestedPlaceholder9, nestedPlaceholder10);
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, C, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput2(
        Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, D, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput3(
        Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<D> nestedPlaceholder4 = new Placeholder<>("Original Input 4");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, E, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput4(
        Generator<D> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, F, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput5(
        Generator<E> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, E, G, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput6(
        Generator<F> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, E, F, H, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput7(
        Generator<G> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, E, F, G, I, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput8(
        Generator<H> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, E, F, G, H, J, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput9(
        Generator<I> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     *         the produced by the provided generator
     */
    public DAG9x9.Prepared<A, B, C, D, E, F, G, H, I, RA, RB, RC, RD, RE, RF, RG, RH, RI> withGeneratorAsInput10(
        Generator<J> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
     ...
     */
    public Result<RA, RB, RC, RD, RE, RF, RG, RH, RI> applyAll(Iterable<? extends A> values1,
      ...
      return new Result<RA, RB, RC, RD, RE, RF, RG, RH, RI>(
          _executor.internalAPI()
              .applyUnsafe(
                  ...
                  new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader
                      ...
                      .wrap(values6), ObjectReader.wrap(values7), ObjectReader.wrap(values8), ObjectReader
                      .wrap(values9), ObjectReader.wrap(values10) }));
    }

    @Override
    public Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI> apply(A value1, B value2, C value3, D value4, E value5, F value6,
      ...
      try (
          AutoCloseableArray<ObjectReader<?>> res =
              new AutoCloseableArray<>(_executor.internalAPI().applyUnsafe(
                  ...
                  new ObjectReader[] { ObjectReader.singleton(value1), ObjectReader.singleton(value2), ObjectReader
                      ...
                      .singleton(value6), ObjectReader.singleton(value7), ObjectReader.singleton(value8), ObjectReader
                      .singleton(value9), ObjectReader.singleton(value10) }));
        ...
        return (Tuple9<RA, RB, RC, RD, RE, RF, RG, RH, RI>) Tuple9.of(resultIterator0.next(), resultIterator1.next(),
            resultIterator2.next(), resultIterator3.next(), resultIterator4.next(), resultIterator5.next(),
            resultIterator6.next(), resultIterator7.next(), resultIterator8.next());
      }
    }
     ...
     * @param <RI> the type of the ninth result
     */
    public static final class Result<RA, RB, RC, RD, RE, RF, RG, RH, RI> extends
        AbstractDAGResult9<RA, RB, RC, RD, RE, RF, RG, RH, RI> {
      /**
       * Creates a new instance.
       *
