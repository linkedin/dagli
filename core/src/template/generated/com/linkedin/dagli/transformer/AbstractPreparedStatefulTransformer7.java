...
/**
 * Base class for prepared transformers of arity 7 that extends {@link AbstractPreparedTransformer7} to
 ...
 */
public abstract class AbstractPreparedStatefulTransformer7<A, B, C, D, E, F, G, R, Q, S extends AbstractPreparedTransformer7<A, B, C, D, E, F, G, R, S>>
    extends AbstractPreparedTransformer7<A, B, C, D, E, F, G, R, S> {

  private static final long serialVersionUID = 1;

  public AbstractPreparedStatefulTransformer7() {
    super();
  }

  public AbstractPreparedStatefulTransformer7(Producer<? extends A> input1, Producer<? extends B> input2,
  ...
  public R apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7) {
    return apply(createExecutionCache(1), value1, value2, value3, value4, value5, value6, value7);
  }
  ...
  protected class InternalAPI extends AbstractPreparedTransformer7<A, B, C, D, E, F, G, R, S>.InternalAPI {
    @Override
    public R apply(Object executionCache, A value1, B value2, C value3, D value4, E value5, F value6, G value7) {
      return AbstractPreparedStatefulTransformer7.this.apply((Q) executionCache, value1, value2, value3, value4,
          value5, value6, value7);
    }

    @Override
    public Object createExecutionCache(long exampleCountGuess) {
      return AbstractPreparedStatefulTransformer7.this.createExecutionCache(exampleCountGuess);
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, Object[][] values, Object[] results) {
      AbstractPreparedStatefulTransformer7.this.applyAll((Q) executionCache, new UnmodifiableArrayList<>(
          ...
          (G[]) values[6], count), new FixedCapacityArrayList<>(results));
    }
    ...
    public void applyAllUnsafe(Object executionCache, int count, List<? extends List<?>> values, List<? super R> results) {
      AbstractPreparedStatefulTransformer7.this.applyAll((Q) executionCache,
          ...
          (List<G>) Lists.limit(values.get(6), count), results);
    }

    @Override
    public int getPreferredMinibatchSize() {
      return AbstractPreparedStatefulTransformer7.this.getPreferredMinibatchSize();
    }
  }
}
