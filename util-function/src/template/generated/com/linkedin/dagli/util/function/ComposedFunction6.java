...
/**
 * A function class implementing {@link Function6.Serializable} that composes
 * {@link Function6} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class ComposedFunction6<A, B, C, D, E, F, R, Q> implements Function6.Serializable<A, B, C, D, E, F, R>, Named {
   ...
   *                as input
   */
  ComposedFunction6(Function6<A, B, C, D, E, F, Q> first, Function1<? super Q, ? extends R> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public ComposedFunction6<A, B, C, D, E, F, R, Q> safelySerializable() {
    return new ComposedFunction6<>(((Function6.Serializable<A, B, C, D, E, F, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ComposedFunction6.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof ComposedFunction6) {
      return this._first.equals(((ComposedFunction6) obj)._first)
          && this._andThen.equals(((ComposedFunction6) obj)._andThen);
    }
    return false;
  }
