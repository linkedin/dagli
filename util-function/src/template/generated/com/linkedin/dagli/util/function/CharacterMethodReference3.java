 ...
 */
class CharacterMethodReference3<A, B, C> implements CharacterFunction3.Serializable<A, B, C>, Named {
  ...
  private static final int CLASS_HASH = CharacterMethodReference3.class.hashCode();

  private final MethodReference _methodReference;
  private transient CharacterFunction3<A, B, C> _cachedFunction = null;

  CharacterMethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public CharacterMethodReference3(Serializable<A, B, C> func) {
    if (func instanceof CharacterMethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((CharacterMethodReference3) func)._methodReference;
    } else {
  ...
  private CharacterFunction3<A, B, C> fromMethodReference() {
    if (_methodReference.isBound()) {
      CharacterMethodReference4<Object, A, B, C> unbound = new CharacterMethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (CharacterFunction3<A, B, C>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(CharacterFunction3.class), type,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof CharacterMethodReference3)) {
      return false;
    }

    return _methodReference.equals(((CharacterMethodReference3) obj)._methodReference);
  }
