...
/**
 * A tuple of arity ArrayTuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> that is backed by an array.
 ...
 */
final class ArrayTuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> extends AbstractTuple implements
   ...
   */
  public ArrayTuple17(Object[] array) {
    assert array.length == 17;
    _array = array;
  }
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(17);
    System.arraycopy(_array, 0, result, 0, 17);
    return result;
  }
}
