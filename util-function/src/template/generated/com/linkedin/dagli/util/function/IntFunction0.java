...
public interface IntFunction0 extends FunctionBase, IntSupplier {
  ...
  static IntFunction0 unchecked(Checked<?> checkedFunction) {
    return () -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement IntFunction0.Serializable should override this method
   ...
   */
  static IntFunction0.Serializable safelySerializable(Serializable function) {
    return function.safelySerializable();
  }

  interface Serializable extends IntFunction0, java.io.Serializable {
    /**
