...
@FunctionalInterface
public interface VoidFunction6<A, B, C, D, E, F> extends FunctionBase {
  void apply(A value1, B value2, C value3, D value4, E value5, F value6);
   ...
   */
  default VoidFunction6<A, B, C, D, E, F> skipOnNullArgument() {
    return new VoidDefaultOnNullArgument6<>(this);
  }

  static <A, B, C, D, E, F> VoidFunction6<A, B, C, D, E, F> unchecked(Checked<A, B, C, D, E, F, ?> checkedFunction) {
    return (A value1, B value2, C value3, D value4, E value5, F value6) -> {
      try {
        checkedFunction.apply(value1, value2, value3, value4, value5, value6);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, D, E, F, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3, D value4, E value5, F value6) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction6.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F> VoidFunction6.Serializable<A, B, C, D, E, F> safelySerializable(
      Serializable<A, B, C, D, E, F> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F> extends VoidFunction6<A, B, C, D, E, F>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C, D, E, F> safelySerializable() {
      try {
        return new VoidMethodReference6<A, B, C, D, E, F>(this);
    ...
    @Override
    default Serializable<A, B, C, D, E, F> skipOnNullArgument() {
      return new VoidDefaultOnNullArgument6<>(this);
    }
