...
public interface Preparer10<A, B, C, D, E, F, G, H, I, J, R, N extends PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>>
    extends Preparer<R, N> {
  @Override
  default void processUnsafe(Object[] values) {
    Arguments.check(values.length == 10, "10 arguments must be provided");
    process((A) values[0], (B) values[1], (C) values[2], (D) values[3], (E) values[4], (F) values[5], (G) values[6],
        (H) values[7], (I) values[8], (J) values[9]);
  }
   ...
   * @param value10 the tenth value of the preparation example to be processed
   */
  void process(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9, J value10);

  @Override
  default PreparerResultMixed<? extends PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return finish(inputs == null ? null : inputs.lazyMap(Tuple10::fromArrayUnsafe));
  }
   ...
   */
  PreparerResultMixed<? extends PreparedTransformer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R>, N> finish(
  ...
  static <A, B, C, D, E, F, G, H, I, J, R, N extends PreparedTransformer10<A, B, C, D, E, F, G, H, I, J, R>> Preparer10<A, B, C, D, E, F, G, H, I, J, R, N> cast(
      Preparer10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R, ? extends N> preparer) {
    // safe due to semantics of preparers:
    return (Preparer10<A, B, C, D, E, F, G, H, I, J, R, N>) preparer;
  }
}
