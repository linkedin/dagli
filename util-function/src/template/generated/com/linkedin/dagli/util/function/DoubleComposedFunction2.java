...
/**
 * A function class implementing {@link DoubleFunction2.Serializable} that composes
 * {@link DoubleFunction2} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class DoubleComposedFunction2<A, B, Q> implements DoubleFunction2.Serializable<A, B>, Named {
   ...
   *                as input
   */
  DoubleComposedFunction2(Function2<A, B, Q> first, DoubleFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public DoubleComposedFunction2<A, B, Q> safelySerializable() {
    return new DoubleComposedFunction2<>(((Function2.Serializable<A, B, Q>) _first).safelySerializable(),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(DoubleComposedFunction2.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof DoubleComposedFunction2) {
      return this._first.equals(((DoubleComposedFunction2) obj)._first)
          && this._andThen.equals(((DoubleComposedFunction2) obj)._andThen);
    }
    return false;
  }
