 ...
 */
class FloatMethodReference11<A, B, C, D, E, F, G, H, I, J, K> implements
    FloatFunction11.Serializable<A, B, C, D, E, F, G, H, I, J, K> {
  ...
  private static final int CLASS_HASH = FloatMethodReference11.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction11<A, B, C, D, E, F, G, H, I, J, K> _cachedFunction = null;

  FloatMethodReference11(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference11(Serializable<A, B, C, D, E, F, G, H, I, J, K> func) {
    if (func instanceof FloatMethodReference11) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference11) func)._methodReference;
    } else {
  ...
  private FloatFunction11<A, B, C, D, E, F, G, H, I, J, K> fromMethodReference() {

    MethodHandle mh = _methodReference.getMethodHandle();

    try {
      MethodType type = mh.type().generic().changeReturnType(float.class);
      return (FloatFunction11<A, B, C, D, E, F, G, H, I, J, K>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction11.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference11)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference11) obj)._methodReference);
  }
