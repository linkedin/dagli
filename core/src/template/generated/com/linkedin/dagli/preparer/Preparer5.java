...
public interface Preparer5<A, B, C, D, E, R, N extends PreparedTransformer5<A, B, C, D, E, R>> extends Preparer<R, N> {
  @Override
  default void processUnsafe(Object[] values) {
    Arguments.check(values.length == 5, "5 arguments must be provided");
    process((A) values[0], (B) values[1], (C) values[2], (D) values[3], (E) values[4]);
  }
   ...
   */
  void process(A value1, B value2, C value3, D value4, E value5);

  @Override
  default PreparerResultMixed<? extends PreparedTransformer5<? super A, ? super B, ? super C, ? super D, ? super E, ? extends R>, N> finishUnsafe(
      ObjectReader<Object[]> inputs) {
    return finish(inputs == null ? null : inputs.lazyMap(Tuple5::fromArrayUnsafe));
  }
   ...
   */
  PreparerResultMixed<? extends PreparedTransformer5<? super A, ? super B, ? super C, ? super D, ? super E, ? extends R>, N> finish(
  ...
  static <A, B, C, D, E, R, N extends PreparedTransformer5<A, B, C, D, E, R>> Preparer5<A, B, C, D, E, R, N> cast(
      Preparer5<? super A, ? super B, ? super C, ? super D, ? super E, ? extends R, ? extends N> preparer) {
    // safe due to semantics of preparers:
    return (Preparer5<A, B, C, D, E, R, N>) preparer;
  }
}
