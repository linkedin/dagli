...
public interface VoidFunction3<A, B, C> extends FunctionBase {
  void apply(A value1, B value2, C value3);
  ...
  static <A, B, C> VoidFunction3<A, B, C> unchecked(Checked<A, B, C, ?> checkedFunction) {
    return (A value1, B value2, C value3) -> {
      try {
        checkedFunction.apply(value1, value2, value3);
      } catch (Throwable e) {
  ...
  interface Checked<A, B, C, X extends Throwable> extends FunctionBase {
    void apply(A value1, B value2, C value3) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement VoidFunction3.Serializable should override this method
   ...
   */
  static <A, B, C> VoidFunction3.Serializable<A, B, C> safelySerializable(Serializable<A, B, C> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C> extends VoidFunction3<A, B, C>, java.io.Serializable {
    /**
    ...
    default Serializable<A, B, C> safelySerializable() {
      try {
        return new VoidMethodReference3<A, B, C>(this);
