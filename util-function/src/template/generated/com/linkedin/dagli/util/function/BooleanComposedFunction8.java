...
/**
 * A function class implementing {@link BooleanFunction8.Serializable} that composes
 * {@link BooleanFunction8} with a {@link Function1}.  The function is only <strong>actually</strong> serializable
 * if its constituent composed functions are serializable, of course.
 */
class BooleanComposedFunction8<A, B, C, D, E, F, G, H, Q> implements
   ...
   *                as input
   */
  BooleanComposedFunction8(Function8<A, B, C, D, E, F, G, H, Q> first, BooleanFunction1<? super Q> andThen) {
    _first = first;
    _andThen = andThen;
  }
  ...
  public BooleanComposedFunction8<A, B, C, D, E, F, G, H, Q> safelySerializable() {
    return new BooleanComposedFunction8<>(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(BooleanComposedFunction8.class, _first, _andThen);
  }

  @Override
  public boolean equals(Object obj) {
    if (obj instanceof BooleanComposedFunction8) {
      return this._first.equals(((BooleanComposedFunction8) obj)._first)
          && this._andThen.equals(((BooleanComposedFunction8) obj)._andThen);
    }
    return false;
  }
