 ...
 */
@ValueEquality
public class FunctionResult2<A, B, R> extends AbstractPreparedTransformer2<A, B, R, FunctionResult2<A, B, R>> {
  private static final long serialVersionUID = 1;

  private Function2.Serializable<A, B, R> _originalFunction = null;
  @IgnoredByValueEquality
  private Function2.Serializable<A, B, R> _function = null;
   ...
   *        withFunctionUnsafe(...).
   */
  public FunctionResult2(Function2.Serializable<A, B, R> func) {
    this();
   ...
   */
  private void setFunction(Function2.Serializable<A, B, R> func) {
   ...
   */
  public FunctionResult2<A, B, R> withNullResultOnNullInput() {
    return clone(c -> {
  ...
  public FunctionResult2<A, B, R> withInputs(Producer<? extends A> input1, Producer<? extends B> input2) {
   ...
   *        withFunctionUnsafe(...).
   */
  public FunctionResult2<A, B, R> withFunction(Function2.Serializable<A, B, R> func) {
   ...
   */
  public FunctionResult2<A, B, R> withFunctionUnsafe(Function2.Serializable<A, B, R> func) {
    return clone(c -> {
      try {
  ...
  @Override
  public R apply(A input1, B input2) {
    return _function.apply(input1, input2);
  }

  /**
   * Returns a new {@link FunctionResult2} that composes this instance's function with another "mapper" function such
   ...
   * @return a new {@link FunctionResult2} that composes this instance's function with another "mapper" function
   */
  @SuppressWarnings("unchecked")
  public <Q> FunctionResult2<A, B, Q> andThen(Function1.Serializable<? super R, ? extends Q> mapper) {
    return (FunctionResult2<A, B, Q>) clone(c -> ((FunctionResult2<A, B, Q>) c).setFunction(_originalFunction
        .andThen(mapper.safelySerializable())));
  }
}
