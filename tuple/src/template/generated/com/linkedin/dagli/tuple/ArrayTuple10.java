...
/**
 * A tuple of arity ArrayTuple10<A, B, C, D, E, F, G, H, I, J> that is backed by an array.
 ...
 */
final class ArrayTuple10<A, B, C, D, E, F, G, H, I, J> extends AbstractTuple implements
   ...
   */
  public ArrayTuple10(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(10);
    System.arraycopy(_array, 0, result, 0, 10);
    return result;
  }
}
