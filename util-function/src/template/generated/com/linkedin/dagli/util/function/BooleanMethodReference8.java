 ...
 */
class BooleanMethodReference8<A, B, C, D, E, F, G, H> implements BooleanFunction8.Serializable<A, B, C, D, E, F, G, H>,
    Named {
  ...
  private static final int CLASS_HASH = BooleanMethodReference8.class.hashCode();

  private final MethodReference _methodReference;
  private transient BooleanFunction8<A, B, C, D, E, F, G, H> _cachedFunction = null;

  BooleanMethodReference8(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public BooleanMethodReference8(Serializable<A, B, C, D, E, F, G, H> func) {
    if (func instanceof BooleanMethodReference8) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((BooleanMethodReference8) func)._methodReference;
    } else {
  ...
  private BooleanFunction8<A, B, C, D, E, F, G, H> fromMethodReference() {
    if (_methodReference.isBound()) {
      BooleanMethodReference9<Object, A, B, C, D, E, F, G, H> unbound =
          new BooleanMethodReference9<>(_methodReference.unbind());
    ...
    try {
      ...
      return (BooleanFunction8<A, B, C, D, E, F, G, H>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(BooleanFunction8.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof BooleanMethodReference8)) {
      return false;
    }

    return _methodReference.equals(((BooleanMethodReference8) obj)._methodReference);
  }
