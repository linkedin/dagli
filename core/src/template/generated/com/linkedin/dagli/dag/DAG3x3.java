 ...
 *
 * DAG3x3 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG3x3 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG3x3<A, B, C, RA, RB, RC>
    extends
    AbstractPreparableTransformer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>, DAG3x3<A, B, C, RA, RB, RC>>
    implements
    PreparableDAGTransformer<Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>, DAG3x3<A, B, C, RA, RB, RC>> {
   ...
   */
  DAG3x3(DAGStructure<Tuple3<RA, RB, RC>> dag, Producer<? extends A> input1, Producer<? extends B> input2,
   ...
   */
  @Override
  public DAG3x3<A, B, C, RA, RB, RC> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>, DAG3x3<A, B, C, RA, RB, RC>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>, DAG3x3<A, B, C, RA, RB, RC>> {
    @Override
    ...
    @Override
    public DAG3x3<A, B, C, RA, RB, RC> getInstance() {
      return DAG3x3.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG3x3<A, B, C, RA, RB, RC>>> getGraphReducers() {
   ...
   */
  public DAG3x3<A, B, C, RA, RB, RC> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG3x3<A, B, C, RA, RB, RC> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
      Producer<? extends C> input3) {
   ...
   */
  public DAG2x3<B, C, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
    ...
    DAG3x3<A, B, C, RA, RB, RC> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x3<A, C, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
    DAG3x3<A, B, C, RA, RB, RC> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
   ...
   *         the produced by the provided generator
   */
  public DAG2x3<A, B, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
    Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
    Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
    DAG3x3<A, B, C, RA, RB, RC> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
   ...
   * @param <RC> the type of the third result
   */
  private static class Preparer<A, B, C, RA, RB, RC> extends
      AbstractBatchPreparer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> {
    // the DAG being prepared
    private final DAG3x3<A, B, C, RA, RB, RC> _dag;
     ...
     */
    Preparer(DAG3x3<A, B, C, RA, RB, RC> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer3<A, B, C, Tuple3<RA, RB, RC>>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> finish(
  ...
  @Override
  protected Preparer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, B, C, RA, RB, RC> prepareAndApply(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3) {
    DAGExecutionResult<Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> res =
    ...
    return new Result<>((DAG3x3.Prepared<A, B, C, RA, RB, RC>) res.getPreparerResult()
   ...
   */
  public DAG3x3.Prepared<A, B, C, RA, RB, RC> prepare(Iterable<? extends A> values1, Iterable<? extends B> values2,
      Iterable<? extends C> values3) {
    return (DAG3x3.Prepared<A, B, C, RA, RB, RC>) _executor
        .internalAPI()
        .prepareUnsafe(this,
            new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) })
  ...
  * @param <RC> the type of the third result
   */
  public static final class Result<A, B, C, RA, RB, RC> extends AbstractDAGResult3<RA, RB, RC> {
    // the prepared DAG
    private final DAG3x3.Prepared<A, B, C, RA, RB, RC> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG3x3.Prepared<A, B, C, RA, RB, RC> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG3x3.Prepared<A, B, C, RA, RB, RC> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RC> the type of the third result
   */
  @ValueEquality
  public static class Prepared<A, B, C, RA, RB, RC> extends
      AbstractPreparedTransformer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> implements
      PreparedDAGTransformer<Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> {
    ...
    * @param input3 the {@link Producer} providing the third input to the transformer
     ...
     */
    @Override
    public DAG3x3.Prepared<A, B, C, RA, RB, RC> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI extends
        AbstractPreparedTransformer3<A, B, C, Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>>.InternalAPI
        implements PreparedDAGTransformer.InternalAPI<Tuple3<RA, RB, RC>, DAG3x3.Prepared<A, B, C, RA, RB, RC>> {
      @Override
      public DAGStructure<Tuple3<RA, RB, RC>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG3x3.Prepared<A, B, C, RA, RB, RC> getInstance() {
        return DAG3x3.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG3x3.Prepared<A, B, C, RA, RB, RC>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG3x3.Prepared<A, B, C, RA, RB, RC> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parents
     */
    public DAG3x3.Prepared<A, B, C, RA, RB, RC> withInputs(Producer<? extends A> input1, Producer<? extends B> input2,
        Producer<? extends C> input3) {
      return super.withAllInputs(input1, input2, input3);
    }
     ...
     *         the produced by the provided generator
     */
    public DAG2x3.Prepared<B, C, RA, RB, RC> withGeneratorAsInput1(Generator<A> generator) {
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x3.Prepared<A, B, C, RA, RB, RC> dag = this.withInputs(generator, nestedPlaceholder2, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x3.Prepared<A, C, RA, RB, RC> withGeneratorAsInput2(Generator<B> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<C> nestedPlaceholder3 = new Placeholder<>("Original Input 3");
      DAG3x3.Prepared<A, B, C, RA, RB, RC> dag = this.withInputs(nestedPlaceholder1, generator, nestedPlaceholder3);
     ...
     *         the produced by the provided generator
     */
    public DAG2x3.Prepared<A, B, RA, RB, RC> withGeneratorAsInput3(Generator<C> generator) {
      Placeholder<A> nestedPlaceholder1 = new Placeholder<>("Original Input 1");
      Placeholder<B> nestedPlaceholder2 = new Placeholder<>("Original Input 2");
      DAG3x3.Prepared<A, B, C, RA, RB, RC> dag = this.withInputs(nestedPlaceholder1, nestedPlaceholder2, generator);
    ...
    public Result<RA, RB, RC> applyAll(Iterable<? extends A> values1, Iterable<? extends B> values2,
        Iterable<? extends C> values3) {
      return new Result<RA, RB, RC>(_executor.internalAPI().applyUnsafe(this,
          new ObjectReader[] { ObjectReader.wrap(values1), ObjectReader.wrap(values2), ObjectReader.wrap(values3) }));
    }

    @Override
    public Tuple3<RA, RB, RC> apply(A value1, B value2, C value3) {
      try (
