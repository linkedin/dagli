...
@FunctionalInterface
public interface ShortFunction1<A> extends FunctionBase {
  short apply(A value1);
   ...
   */
  default ShortFunction1<A> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument1<>(this);
  }

  static <A> ShortFunction1<A> unchecked(Checked<A, ?> checkedFunction) {
    return (A value1) -> {
      try {
   ...
   *
   * Function objects that wrap functions and implement ShortFunction1.Serializable should override this method
   ...
   */
  static <A> ShortFunction1.Serializable<A> safelySerializable(Serializable<A> function) {
    return function.safelySerializable();
  }

  interface Serializable<A> extends ShortFunction1<A>, java.io.Serializable {
    /**
    ...
    default Serializable<A> safelySerializable() {
      try {
        return new ShortMethodReference1<A>(this);
