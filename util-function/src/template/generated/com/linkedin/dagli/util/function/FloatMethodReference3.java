 ...
 */
class FloatMethodReference3<A, B, C> implements FloatFunction3.Serializable<A, B, C>, Named {
  ...
  private static final int CLASS_HASH = FloatMethodReference3.class.hashCode();

  private final MethodReference _methodReference;
  private transient FloatFunction3<A, B, C> _cachedFunction = null;

  FloatMethodReference3(MethodReference mr) {
    _methodReference = mr;
    initCachedFunction();
  }
   ...
   *        will be thrown.
   */
  public FloatMethodReference3(Serializable<A, B, C> func) {
    if (func instanceof FloatMethodReference3) {
      // multiple applications of this constructor are idempotent:
      _methodReference = ((FloatMethodReference3) func)._methodReference;
    } else {
  ...
  private FloatFunction3<A, B, C> fromMethodReference() {
    if (_methodReference.isBound()) {
      FloatMethodReference4<Object, A, B, C> unbound = new FloatMethodReference4<>(_methodReference.unbind());
    ...
    try {
      ...
      return (FloatFunction3<A, B, C>) LambdaMetafactory
          .metafactory(_methodReference.getLookup(), "apply", MethodType.methodType(FloatFunction3.class), type, mh,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FloatMethodReference3)) {
      return false;
    }

    return _methodReference.equals(((FloatMethodReference3) obj)._methodReference);
  }
