...
/**
 * A tuple of arity ArrayTuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> that is backed by an array.
 ...
 */
final class ArrayTuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> extends AbstractTuple implements
   ...
   */
  public ArrayTuple18(Object[] array) {
  ...
  public <TT> TT[] toArray(IntFunction<TT[]> arrayGenerator) {
    TT[] result = arrayGenerator.apply(18);
    System.arraycopy(_array, 0, result, 0, 18);
    return result;
  }
}
