...
@FunctionalInterface
public interface ShortFunction9<A, B, C, D, E, F, G, H, I> extends FunctionBase {
  short apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9);
   ...
   */
  default ShortFunction9<A, B, C, D, E, F, G, H, I> returnZeroOnNullArgument() {
    return new ShortDefaultOnNullArgument9<>(this);
  }

  static <A, B, C, D, E, F, G, H, I> ShortFunction9<A, B, C, D, E, F, G, H, I> unchecked(
  ...
  interface Checked<A, B, C, D, E, F, G, H, I, X extends Throwable> extends FunctionBase {
    short apply(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9) throws X;
  }
   ...
   *
   * Function objects that wrap functions and implement ShortFunction9.Serializable should override this method
   ...
   */
  static <A, B, C, D, E, F, G, H, I> ShortFunction9.Serializable<A, B, C, D, E, F, G, H, I> safelySerializable(
      Serializable<A, B, C, D, E, F, G, H, I> function) {
    return function.safelySerializable();
  }

  interface Serializable<A, B, C, D, E, F, G, H, I> extends ShortFunction9<A, B, C, D, E, F, G, H, I>,
    ...
    default Serializable<A, B, C, D, E, F, G, H, I> safelySerializable() {
      try {
        return new ShortMethodReference9<A, B, C, D, E, F, G, H, I>(this);
