 ...
 *
 * DAG1x8 is a <i>preparable</i> DAG.
 *
 ...
 *
 * DAG1x8 is also a {@link com.linkedin.dagli.transformer.PreparableTransformer} and can be used as
 ...
 */
@ValueEquality
public class DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>
    extends
    AbstractPreparableTransformer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>>
    implements
    PreparableDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>> {
   ...
   */
  DAG1x8(DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> dag, Producer<? extends A> input1) {
    super(input1);
    _dag = dag;
   ...
   */
  @Override
  public DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
  ...
  public class InternalAPI
      extends
      AbstractPreparableTransformer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
      implements
      PreparableDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>> {
    @Override
    ...
    @Override
    public DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
      return DAG1x8.this;
    }
  }

  @Override
  protected Collection<? extends Reducer<? super DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
   ...
   */
  public DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(DAGExecutor executor) {
   ...
   */
  public DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> withInput(Producer<? extends A> input1) {
   ...
   * @param <RH> the type of the eighth result
   */
  private static class Preparer<A, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractBatchPreparer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> {
    // the DAG being prepared
    private final DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> _dag;
     ...
     */
    Preparer(DAG1x8<A, RA, RB, RC, RD, RE, RF, RG, RH> dag) {
      _dag = dag;
    }
    ...
    public PreparerResultMixed<PreparedTransformer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> finish(
  ...
  @Override
  protected Preparer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> getPreparer(
   ...
   *         preparation data
   */
  public Result<A, RA, RB, RC, RD, RE, RF, RG, RH> prepareAndApply(Iterable<? extends A> values1) {
    DAGExecutionResult<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> res =
        _executor.internalAPI().prepareAndApplyUnsafe(this, new ObjectReader[] { ObjectReader.wrap(values1) });
    return new Result<>((DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>) res.getPreparerResult()
   ...
   */
  public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> prepare(Iterable<? extends A> values1) {
    return (DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>) _executor.internalAPI()
  ...
  * @param <RH> the type of the eighth result
   */
  public static final class Result<A, RA, RB, RC, RD, RE, RF, RG, RH> extends
      AbstractDAGResult8<RA, RB, RC, RD, RE, RF, RG, RH> {
    // the prepared DAG
    private final DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> _preparedDAG;

    /**
     * @return the {@link Prepared} DAG that was prepared (trained) on the provided preparation (training) data.
     */
    public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> getPreparedDAG() {
      return _preparedDAG;
    }
     ...
     */
    Result(DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> preparedDAG, ObjectReader<?>[] results) {
      super(results);
  ...
  * @param <RH> the type of the eighth result
   */
  @ValueEquality
  public static class Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>
      extends
      AbstractPreparedTransformer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>>
      implements
      PreparedDAGTransformer<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> {
    ...
    * @param input1 the {@link Producer} providing the first input to the transformer
     ...
     */
    @Override
    public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> withReduction(Reducer.Level level) {
      if (Reducer.Level.compare(level, _reductionLevel) >= 0) {
        return this;
      }
    ...
    public class InternalAPI
        extends
        AbstractPreparedTransformer1<A, Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>>.InternalAPI
        implements
        PreparedDAGTransformer.InternalAPI<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>, DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>> {
      @Override
      public DAGStructure<Tuple8<RA, RB, RC, RD, RE, RF, RG, RH>> getDAGStructure() {
        return _dag;
      }
      ...
      @Override
      public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> getInstance() {
        return DAG1x8.Prepared.this;
      }
    }

    @Override
    protected Collection<? extends Reducer<? super DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH>>> getGraphReducers() {
      return Collections.singletonList(DAGTransformerReducer.INSTANCE);
    }
     ...
     * @return a copy of this instance that will use the provided executor
     */
    public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> withExecutor(PreparedDAGExecutor executor) {
      return clone(r -> r._executor = executor);
    }
     ...
     * @return a copy of this instance that will have the specified parent
     */
    public DAG1x8.Prepared<A, RA, RB, RC, RD, RE, RF, RG, RH> withInput(Producer<? extends A> input1) {
      return super.withAllInputs(input1);
    }
    ...
    @Override
    public Tuple8<RA, RB, RC, RD, RE, RF, RG, RH> apply(A value1) {
      try (
